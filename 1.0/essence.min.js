...
return rand(s,r,i)}function lenRand(t,e){return e?Math.floor(Math.random()*(t+1)):Math.floor(Math.random()*t)}function random16(){return(65280*Math.random()+255*Math.random())/65535}function randFloatSpread(t){return t*(.5-Math.random())}function genNearlySortedArr(t,e,i){var r,s=range(t,e,i),n=[]
r=s.getIncrement(0)
...
return r.toNDec(i||20)}function log(t,e){return Math.log(t)/Math.log(e||10)}function ln(t){return log(t,Math.E)}function Bin(t,e,i){return C(t,i)*Math.pow(e,i)*Math.pow(1-e,t-i)}function BinCumul(t,e,i){}function Norm(t){var e=1/(1+.2316419*Math.abs(t)),i=.3989423*Math.exp(-t*t/2),r=i*e*(.3193815+e*(-.3565638+e*(1.781478+e*(-1.821256+1.330274*e))))
...
return.9956973041*o[a.lookFor(getClosest(t,a))]}function simpleInterest(t,e,i){return t*(1+e*(i||1))}function compoundInterest(t,e,i,r){return r>1?t*Math.pow(1+e/r,(i||1)*r):t*Math.pow(1+e,i||1)}function non0(t){return 0===t?Essence.eps:t}function toFrac(t,e,i){var r=String(t),s=r.indexOf(".")
if(-1==s)return r
...
isNon(t)&&(t=63.75)
for(var s=0;257>s;s+=t)for(var n=0;257>n;n+=t)for(var o=0;257>o;o+=t)i&&Essence.sayClr(e?[Math.round(s),Math.round(n),Math.round(o)]:[s,n,o]),r.push("rgb("+(e?[Math.round(s),Math.round(n),Math.round(o)].join(", "):[s,n,o].join(", "))+")")
...
return isType(t,"String")?e.join(""):e}function abcClamp(t){return 32===t?32:revClamp(clamp(t,65,122),90,97)}function modRange(t,e,i){var r=t%(i+1)
return r+(e>r)?e+r:0}function abcModulus(t){var e=t%123
return e>90&&97>e?e+abcModulus(Math.abs(getClosest(e,[90,97])-e)):e+(65>e&&32!=e?65+e:0)}function addFav(t,e,i){var r=i?"#"+i:"body"
...
r++}}return e.trimAll("r")}function occurrenceSort(t){for(var e=rmDuplicates(t),i=[],r=[],s=0;s<e.length;s++)r[s]=t.count(e[s])
for(;e.length>0;)for(s=0;s<e.length;s++)r[s]===r.max()&&(i.push(e[s]),r=r.remove(r[s]),e=e.remove(e[s]))
return i}function timeUp(t,e,i){var r=new Date,s=0
...
for(i=rmDuplicates(i),t=new Array(i.length),r=[],s=0;s<i.length;s++)t[s]=e.count(i[s]),r[s]=i[s]+t[s]
this.dictionnary=occurrenceSort(this.data)
for(var s=0;s<this.dictionnary.length;s++)this.result[s]=conv(s,10,2)},this.getResult=function(){this.updateDict()
for(var t="",e=0;e<this.data.length;e++)t+=this.data.replace(RegExpify(this.dictionnary[this.dictionnary.indexOf(this.data[e])]),this.result[e])
return this.result+"\n"+t},this}function Machine(t,e,i,r){switch(this.capacity=i||1024,this.version=e||5,this.name=t||"Machine_"+this.version,this.version){case 1:this.base=2
break
case 2:this.base=3
break
case 3:this.base=8
...
return e},Array.prototype.first=function(t){return t?this[0]=t:this[0]},Array.prototype.last=function(t){return t?this[this.length-1]=t:this[this.length-1]},Array.prototype.lastIndex=function(){return this.length-1},Array.prototype.midIndex=function(t){return t?Math.floor(this.length/2)-1:Math.floor(this.length/2)},Array.prototype.even=function(){for(var t=[],e=0;e<this.length;e+=2)t.push(this[e])
