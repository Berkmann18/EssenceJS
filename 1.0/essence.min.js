"use strict"
function Element(t){if(/^([#\.\* _-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as its invalid.")
...
case 32:break
case 64:break
default:throw new Error("Invalid binary number!")}return r*Math.pow(2,e)*i}function min2dec(t){return 50*t/30}function dec2min(t){return 30*t/50}function toS(t){if(t==parseFloat(t))return parseFloat(t)
var e=2===t.count(":")
...
for(var r=0;r<i;r++)primeCheck(e[r],e[i])&&(e[i]="x")}return e.remove("x")}function primeCheck(t,e){return t>1&&e>1&&e%t===0&&e!=t}function getClosestRoot(t,e){e||(e=2)
var i=0,r=0
...
return t.next=this,t.prev=null,this.prev=t,this.next=null,t},this.toString=function(){return"Node(payload = "+this.payload+", previous = "+this.prev+", next = "+this.next+")"},this.equals=function(t){return this.payload===t.payload&&this.next.equals(t.next)&&this.prev.equals(t.prev)},this.find=function(t,e){return e||(e=0),this.payload===t?e:this.next?this.next.find(t,e+1):[-1,e]},this}function Vertex(t,e){return this.f=t+e||1,this.parent=null,this}function NTreeNode(t,e){return this.payload=t||0,this.childs=e||[],this.add=function(t){this.childs.push(t)},this.traverse=function(){for(var t in this.childs)this.childs.hasOwnProperty(t)&&t.traverse()
...
for(var n=0;n<this.childs-1;n++)this.childs[n].inOrder(t+e,e,i+1,r),println(t+r+this.payload+e+" (deepth= "+i+")"),this.childs[n].inOrder(t+e,e,i+1,r),Essence.addToPrinter("\r\n")},this.preOrder=function(t,e,i,r){t||(t=""),e||(e="&nbsp;&nbsp;"),i||(i=0),r||(r="|-")
for(var n=0;n<this.childs-1;n++)println(t+r+this.payload+e+" (deepth= "+i+")"),this.childs[n].inOrder(t+e,e,i+1,r),this.childs[n].inOrder(t+e,e,i+1,r),Essence.addToPrinter("\r\n")},this.postOrder=function(t,e,i,r){t||(t=""),e||(e="&nbsp;&nbsp;"),i||(i=0),r||(r="|-")
for(var n=0;n<this.childs-1;n++)this.childs[n].inOrder(t+e,e,i+1,r),this.childs[n].inOrder(t+e,e,i+1,r),println(t+r+this.payload+e+" (deepth = "+i+")"),Essence.addToPrinter("\r\n")},this.getOrder=function(t){return this.childs.join(t||"->")},this.isLeaf=function(){return!isNon(this.childs)},this.find=function(t,e){return"bfs"===e.normal()?this.bfs(t):this.dfs(t)},this.dfs=function(t,e,i){e||(e=0),i||(i=0)
...
return t?e.toString().split(","):e},this}function Set(t){return this.value=(isType(t,"Array")?t:[t])||[],this.size=function(){return this.value.length},this.add=function(t){this.value.indexOf(t)===-1&&(isType(t,"Array")?this.value=this.value.concat(t):this.value.push(t))},this.remove=function(t){if(this.value.indexOf(t)!==-1)if(isType(t,"Array"))for(var e=0;e<t.length;e++)this.remove(t[e])
...
return e=0===t?"No connexion":t>0&&t<=56?"Low debit":t>56&&t<=8e3?"ADSL debit":t>8e3&&t<=2e4?"ADSL2 + ":t>2e4&&t<=5e4?"wire":t>5e4&&t<=1e5?"optical fibre":"Ethernet",e+" ("+t.toNDigits(3)+" kbps)"}function evalUpload(t){var e=""
return e=0===t?"No connexion":t>0&&t<=56?"Low debit":t>56&&t<=1e3?"ADSL + ":t>1e3&&t<=5e3?"wire":"Ethernet",e+" ("+t.toNDigits(3)+" kbps)"}function evalPing(t){var e=""
...
return i.length<20&&(i+=t[randTo(t.length-1)]),i}function genHash(t){for(var e,i,r="",n=(821-t.sum())/t.prod()*t.charCodeAt(0).toNDigits(1),s=0;s<t.length;s++)e=t.charCodeAt(s)+n.toNDigits(1)%255,i=Math.abs(t.charCodeAt(s)+n).toNDigits(1),i<32&&(i+=48),r+=String.fromCharCode(clamp(i%127,32,126))
...
if(e=e.map(function(e){return e===t?void 0:e}),e.indexOf(void 0)!=-1&&e.length>0){var r=[]
...
return e.toNDec(t)},Array.prototype.rand=function(t){if(t>0){for(var e=[],i=0;i<t;i++)e.push(this.rand())
...
for(;this[n]>r;)n--
i<=n&&(swap(this,i,n),i++,n--)}t<i-1&&this.quickSort(t,i-1),i<e&&this.quickSort(i,e)}return this},Array.prototype.revSort=function(t,e){t||e||(t=0,e=this.lastIndex())
var i
if(this.length>1){var r=this[Math.floor((e+t)/2)],n=e
for(i=t;i<=n;){for(;this[i]>r;)i++
for(;this[n]<r;)n--
...
return i.indexOf(void 0)!=-1?e.remove():i}for(var r in t)t.hasOwnProperty(r)&&(e=e.remove(r))},String.prototype.toNDigits=function(t){var e=this
...
if(t=t||2,parseFloat(e)<Math.pow(10,t-1))for(;e.split(".")[0].length<t;)e="0"+e
return e},Number.prototype.sign=function(t){return t?this<0?"-":this>0?" + ":"":this<0?-1:this>0?1:0},Number.prototype.isPrime=function(t){for(var e=2;e<t;e++)if(primeCheck(e,t))return!1
