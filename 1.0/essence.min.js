...
return t},this.equals=function(t){return this.toString()===t.toString()},this.remove=function(t){for(var e=this.front;null!=e;)null==e.payload||e.payload!=t&&!e.payload.equals(t)||(e=null),e=e.next},this.insertAt=function(t,e){this.back.next=new Node(e),0===t?this.front=new Node(e):t===this.len?this.back=new Node(e):t>this.len&&this.enqueue(e)}}function Astar(t,e){for(var i,r,n,s=e,o=[t],a=[];o.length>0;){var l=[],c=o[0].f
...
return isType(t,"String")?e.join(""):e}function RSA(t,e){var i,r,n=t*e;(t-1)(e-1)
...
for(var n=0;n<e.maxLength();n++)for(var n=0;n<e.maxLength();n++){for(var s=0;s<e.length-r;s++)0==n&&e[s].charAt(n)>e[s+1].charAt(n)?(swap(e,s,s+1),i=!0):e[s].charAt(n-1)===e[s+1].charAt(n-1)&&e[s].charAt(n)>e[s+1].charAt(n)&&(swap(e,s,s+1),i=!0)
...
var e=[t]
return e.append(t.length>1?Permutation(t.get(-1)):t),console.log("perm="+e),e}function stup(t){for(alert("You have 10s to type something !"),Sys["in"].recording=!0,Sys["in"].data=[],setTimeout(function(){return Sys["in"].recording=!1,alert("Stop !!"),t&&t(Sys["in"].data.join("")),Sys["in"].data.join("")},1e4);(0===Sys["in"].data.length||$G.las)&&Sys["in"].recording;);return Sys["in"].data.join("")}function loadBar(t,e,r){t||(t="#dlb"),Essence.addCSS(t+" {border: none;background: #0F0;max-width: 200px;text-align: center;font-size: 28px;padding: 2px;}#bar {border: 1px ridge #CCC;text-align: center;width: 201px;});"),r||(r=30),$e(t).setCSS("position","relative"),$e(t).setCSS("width",$e(t).css("width")+$G.i),$e(t).write($G.i+"%"),$G.i++,$G.timer=setTimeout("loadBar("+t+", "+e+", "+r+")",r),$G.i>=100&&(clearTimeout($G.timer),i=0,$e(t).write("Download finished"),e())}function binaryCases(t){var e=parseInt("1".repeat(t)),i=[],r=0
