...
return e.open("GET",t,!1),e.onreadystatechange=function(){return 4!==e.readyState||200!==e.status&&0!=e.status?void 0:($G.fct=e.responseText,e.responseText)},e.send(null),$G.fct}function getKey(t,e){var i=document.all?event.keyCode:t.which,r=e?String.fromCharCode(i).toLowerCase():String.fromCharCode(i)
...
t=t.quickSort(),e=e.quickSort(),i=i?i.quickSort():!1
for(var s in t)t.hasOwnProperty(s)&&(-1===e.indexOf(t[s])&&isNon(i)?n.push(t[s]):-1===e.indexOf(t[s])&&-1===i.indexOf(t[s])&&n.push(t[s]))
...
for(var s in t)t.hasOwnProperty(s)&&(-1===e.indexOf(t[s])&&isNon(i)?n.push(t[s]):-1===e.indexOf(t[s])&&-1===i.indexOf(t[s])&&n.push(t[s]))
for(s in e)e.hasOwnProperty(s)&&(-1===t.indexOf(e[s])&&isNon(i)?n.push(e[s]):-1===t.indexOf(e[s])&&-1===i.indexOf(e[s])&&n.push(e[s]))
if(i)for(s in i)i.hasOwnProperty(s)&&-1===t.indexOf(i[s])&&-1===e.indexOf(i[s])&&n.push(i[s])
...
return t},Object.prototype.compareTo=function(t){return getType(this)!=getType(t)?!1:"Object"===getType(this)&&getCustomType(this)===getCustomType(t)||getType(this)===getType(t)?this.equals(t)?0:this.toString()<t.toString()||this.toLocaleString()<t.toLocaleString()?-1:1:void 0},Array.prototype.first=function(t){return isNon(t)?this[0]:this[0]=t},Array.prototype.last=function(t){return isNon(t)?this[this.length-1]:this[this.length-1]=t},Array.prototype.lastIndex=function(){return this.length-1},Array.prototype.midIndex=function(t){return t?Math.floor(this.length/2)-1:Math.floor(this.length/2)},Array.prototype.line=function(t){return this.map(function(e){return 0>t&&(t=this[e].length-t),e[t||0]})},Array.prototype.block=function(t,e){return this.map(function(i){return i.get(t,e)})},Array.prototype.even=function(){for(var t=[],e=0;e<this.length;e+=2)t.push(this[e])
...
return-1!=i.indexOf(void 0)?e.remove():i}for(var r in t)t.hasOwnProperty(r)&&(e=e.remove(r))},String.prototype.toNDigits=function(t){var e=this
