...
for(var s in t)t.hasOwnProperty(t)&&(e.indexOf(t[s])>-1&&isNon(r)?n.push(t[s]):e.indexOf(t[s])>-1&&r.indexOf(t[s])>-1&&n.push(t[s]))
...
return e.mult(2*this.dot(this.normal)),this.sub(e),this},this.angle=function(t){return Math.acos((this.x*t.x+this.y*t.y)/(this.length()*t.length()))},this}function Polygon(t,e,r){return this.points=t,this.border=e||1,this.vel=r||new Vector,this.norm=this.vel.getNormal(),this.equals=function(t){var e=!0
...
return s}function radialGradient(t,e,r){parseInt(conv(t,16)),parseInt(conv(e,16))
return r=parseInt(r)||10,grad}function parseURL(t,e){var r=location.href.split("?")
...
for(var t=0;t<this.tools.length;t++)this.fn[t]=this["for"][this.tools[t]]},this}function IDE(t,e,r,i,n,s){return this.editor=e||new Editor,this.parser=i||new Parser,this.preview=r||new Preview,this.preview.associatedParser=this.parser,this.editor.previewer=this.preview,this.editor.parser=this.parser,this["debugger"]=n||new Debugger,this.language=t||"none",this.init=function(t,e){"none"!=this.language&&(this.editor.language=this["debugger"].language=this.parser.from=this.language),t&&(this.parser.to=t,this.preview.language=t)},this.toolbar=this.editor.toolbar,this.update=function(t){this.editor.update(t),this.preview.update(),this["debugger"].update()},this}function loadDoc(t,e){var r=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")
