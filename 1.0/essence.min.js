...
for(var o="<table id='"+(i||"")+"' style='"+r+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":""),a=0;a<e.length;a++){if(o+="<tr>",n)for(var h=0;h<e[a].length;h++)o+="<td id='"+(i||"")+(isNon(s)?a+"_"+h:s[a][h])+"'>"+e[a][h]+"</td>"
else o+="<td id='"+(i||"")+(isNon(s)?a:s[a])+"'>"+e[a]+"</td>"
...
for(var a="<table id='"+(r||"")+"' style='"+s+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":""),h=0;h<i.length;h++){if(a+=e?"<tr><th>"+e[h]+"</th>":"<tr>",n)for(var l=0;l<i[h].length;l++)a+="<td id='"+(r||"")+(isNon(o)?h+"_"+l:o[h][l])+"'>"+i[h][l]+"</td>"
else a+="<td id='"+(r||"")+(isNon(o)?h:o[h])+"'>"+i[h]+"</td>"
...
var a="<table id='"+(r||"")+"' style='"+s+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":"")
if(e){a+="<tr>"
for(var h=0;h<e.length;h++)a+="<th>"+e[h]+"</th>"
a+="</tr>"}for(h=0;h<i.length;h++){if(a+="<tr>",n)for(var l=0;l<i[h].length;l++)a+="<td id='"+(r||"")+(isNon(o)?h+"_"+l:o[h][l])+"'>"+i[l][h]+"</td>"
else a+="<td id='"+(r||"")+(isNon(o)?h:o[h])+"'>"+i[h]+"</td>"
...
for(var h="<table id='"+(n||"")+"' style='"+o+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption><tr><td></td>":"<tr><td></td>"),l=0;l<r.length;l++)h+="<th>"+r[l]+"</th>"
for(h+="</tr>",l=0;l<i.length;l++){if(h+=e?"<tr><th>"+e[l]+"</th>":"<tr>",s)for(var c=0;c<i[l].length;c++)h+="<td id='"+(isNon(a)?l+"_"+c:a[l][c])+"'>"+i[l][c]+"</td>"
else h+="<td id='"+(isNon(a)?l:a[l])+"'>"+i[l]+"</td></tr>"
h+="</tr>"}return h+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td{background: #ddd;}tr td:hover{background: #bbb;}</style>"}function colourTable(t,e,i,r,n,s){var o="<table id='"+(r||"")+"' style='"+s+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":"")
if(e){o+="<tr>"
