...
return t?e.split("").join(""):e},String.prototype.replaceAll=function(t,e,i){var r=i?this.split(i).replace(t,e):this.replace(t,e),s=0
if(""===i)return this.replace(RegExpify(t),e)
for(;r.indexOf(t)>-1||s===this.length;)r=this.replace(t,e),s++
