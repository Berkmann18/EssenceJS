...
r?i.httpEquiv=r:i.name=t,i.content=e,document.head.appendChild(i)}function xor(t,e){return t&&!e||!t&&e}function noRightClick(){document.oncontextmenu=new Function("return false")}function reloadPage(t){2===t?location.href=window.location.href:location.reload()}function redirect(t,e,r){e||(e=3e3)
...
case 2:return"twice"
default:return t+" times"}}function arrayLiteral(t,e){return t.length>1?t.get(-1).toStr(!0)+" "+(e||"and")+" "+t.last():t[0]}function escapeHTML(t){var e=document.createElement("span")
...
frame.resizeTo(frame.x,frame.y)}}catch(t){Essence.say("An error occurred when trying to maximise the size Because of %c"+t,"err","text-decoration: underline;")}}function getScreenDim(){return[screen.width,screen.height]}function getWinDim(){return[screen.availWidth,screen.availHeight]}function getCookie(t){for(var e,r,i=document.cookie.split(";"),n=0;n<i.length;n++)if(e=i[n].substr(0,i[n].indexOf("=")),r=i[n].substr(i[n].indexOf("=")+1),e=e.replace(/^\s+|\s+$/g,""),e===t)return decodeURIComponent(r)}function setCookie(t,e,r){r=r?r%99983489:99983488
var i=new Date
i.setDate(i.getDate()+r)
var n=encodeURIComponent(e)+(null===r?"":"; expires = "+i.toUTCString())
...
return[e,r]}function getResources(t){for(var e=$n("*link"),r=$n("*script"),i=$n("*style"),n=[],s=$n("*a"),o=$n("*img"),a=$n("*input image"),h=[$n("*div"),$n("*section"),$n("*td"),$n("*th"),$n("*li")],l=0;l<e.length;l++)isNon(e[l])||(n[l]=e[l].href),Essence.say(e[l].href.split("/")[e[l].href.split("/").length-1]+" has been added to the resources getter.","info")
for(l=0;l<r.length;l++)isNon(r[l])||n.push(r[l].src),Essence.say(r[l].src.split("/")[r[l].src.split("/").length-1]+" has been added to the resources getter.","info")
for(l=0;l<i.length;l++)isNon(i[l])||n.push(i[l].src),Essence.say(i[l].src.split("/")[i[l].src.split("/").length-1]+" has been added to the resources getter.","info")
for(l=0;l<s.length;l++)isNon(s[l])||n.push(s[l].href),Essence.say(s[l].href.split("/")[s[l].href.split("/").length-1]+" has been added to the resources getter.","info")
for(l=0;l<o.length;l++)isNon(o[l])||n.push(o[l].src),Essence.say(o[l].src.split("/")[o[l].src.split("/").length-1]+" has been added to the resources getter.","info")
for(l=0;l<a.length;l++)isNon(a[l])||n.push(a[l].src),Essence.say(a[l].src.split("/")[a[l].src.split("/").length-1]+" has been added to the resources getter.","info")
for(l=0;l<h.length;l++)for(var c=0;c<h[l].length;c++){n.push(h[l][c].style.backgroundImage.slice(4,h[l][c].style.backgroundImage.length-1))
var u=h[l][c].style.backgroundImage.slice(4,h[l][c].style.backgroundImage.length-1)
Essence.say(u.split("/")[u.split("/").length-1]+" has been added to the resources getter.","info")}return Essence.say("Resource list: "+n.clean()),t?n.clean():n}function gatherScripts(t){for(var e=$n("*script"),r=t?[]:{},i=0;i<e.length;i++)t?r.push(e[i].src):r[e[i].src.split("/")[e[i].src.split("/").length-1]]=e[i].src
...
return r&&(keyList(i,!0).indexOf(r+t)>-1||valList(i,!0).indexOf(r+t)>-1)?!1:keyList(i,!0).indexOf(t)>-1||valList(i,!0).indexOf(t)>-1?!1:void include(t,e)}function stripTags(t){return t.replace(/<[\s\S]+ >(.*?)<\/[\s\S]+ >/,"$1")}function stripPath(t){return t.split("/")[t.split("/").length-1]}function getFilename(t){return t?stripPath(location.pathname):stripPath(location.pathname).get(-stripPath(location.pathname).lastIndexOf(".")-1)}function getCurrentPath(t,e){e||(e="file:///")
for(var r=t.split("/"),i=e.split("/"),n=0,s=0;e.indexOf(r[n])>-1;)n++
for(var o=r.get(n).join("/");o.indexOf(i[s])>-1;)console.log("Gone through "+i[s]),s++
if(s>0)for(n=0;s>n;n++)o="../"+o
return o}function filenameList(t){for(var e=[],r=0;r<t.length;r++)e.push(stripPath(t[r]))
...
return r.toNDec(e)}function conv(t,e,r,i){return i?parseFloat(t,e||2).toString(r||10):parseInt(t,e||2).toString(r||10)}function negateBin(t,e){for(var r=[],i=0;i<t.length;i++)r[i]=1-parseInt(t[i])
var n=conv(r.join(""))
return n++,e?conv(n,10,2).split(""):conv(n,10,2)}function floatingPtBin(t){var e,r,i=1===t[0]?-1:1
...
case 32:break
case 64:break
default:throw new Error("Unvalid binary number")}return i*Math.pow(2,e)*r}function min2dec(t){return 50*t/30}function dec2min(t){return 30*t/50}function toS(t){var e=2===t.count(":")
...
return e}function C(t,e){return factorial(t)/(factorial(e)*factorial(t-e))}function Bin2Norm(t,e,r,i){return t*e>5&&t*(1-e)>5?(r+=">="===i?-.5:.5,StdNorm(t*e,Math.sqrt(t*e*(1-e)),r)):!1}function Bin2Po(t,e,r){return t>50&&.1>e?Po(t*e,r):!1}function Po2Norm(t,e){return t>10?StdNorm(e,Math.sqrt(e)):!1}function erf(t){var e,r=1/(1+.5*Math.abs(t))
...
if(formula.search(/\^[0-9]/g)>0){var expr="([(]. * ?[)]|\\d + \\.\\d + |\\d + |[a-z] + )",reg=new RegExp(expr+"\\^"+expr)
formula=formula.replace(reg,"Math.pow($1, $2)")}else formula.search(/e\^/g)>0&&(expr="([(]. * ?[)]|\\d + \\.\\d + |\\d + |[a-z] + )",reg=new RegExp("e\\^"+expr),formula=formula.replace(reg,"Math.exp($1)"))
...
s.Write(e),s.ReadAll(),r&&confirm("Do you really want to close this file ?")&&s.Close(),i&&confirm("Do you really want to delete this file ?")&&n.DeleteFile(t)}function execFile(t,e){var r=new ActiveXObject("WScript.Shell")
...
return t?e.getHours().toNDigits()+":"+e.getMinutes().toNDigits()+":"+e.getSeconds().toNDigits()+"."+e.getMilliseconds().toNDigits():e.getHours().toNDigits()+":"+e.getMinutes().toNDigits()+":"+e.getSeconds().toNDigits()}function getDate(t){var e=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],r=new Date
return t?r.getDate().toNDigits()+e[r.getMonth()]+r.getUTCFullYear():r.getDate().toNDigits()+"/"+(r.getMonth()+1).toNDigits()+"/"+r.getUTCFullYear()}function getTimestamp(t){return t?getDate()+" "+getTime(!0):getDate(!0)+"-"+getTime().replace(/\:/g,"-")}function date2num(t){t||(t=getDate())
var e=t.split("/")
return parseFloat(parseFloat(e[2]+"."+e[1]).toNDec()+"0"+e[0])}function num2date(t){var e=t.toString().split(".")
return e[1].get(3)+"/"+e[1].get(-3)+"/"+e[0]}function asciiTable(t,e){"A-Z"!==t||e?"a-z"!==t||e?"A-z"!==t||e?"printable"!==t||e||(t=32,e=126):(t=65,e=122):(t=97,e=122):(t=65,e=90),t||(t=0),e||(e=255)
...
return n}function letterArray(t,e){for(var r=t.charCodeAt(0)||97,i=e.charCodeAt(0)||122,n=[],s="",o=r;i>=o;o++)for(var a=r;i>=a;a++)o!=a&&(s=String.fromCharCode(o)+String.fromCharCode(a),n.push(s))
...
for(var s=0;t>s;s++)i[n][s]=r}else if(3===e)if(isNon(r))for(i=new Array(t),n=0;t>n;n++)for(i[n]=new Array(t),s=0;t>s;s++)i[n][s]=new Array(t)
else for(n=0;t>n;n++)for(i[n]=new Array(t),s=0;t>s;s++){i[n][s]=new Array(t)
for(var o=0;t>o;o++)i[n][s][o]=r}else{if(4!==e)throw new Error("Unvalid dimension. Only 1D-4D arrays can be made.")
if(isNon(r))for(i=new Array(t),n=0;t>n;n++)for(i[n]=new Array(t),s=0;t>s;s++)for(i[n][s]=new Array(t),o=0;t>o;o++)i[n][s][o]=new Array(t)
else for(n=0;t>n;n++)for(i[n]=new Array(t),s=0;t>s;s++)for(i[n][s]=new Array(t),o=0;t>o;o++){i[n][s][o]=new Array(t)
for(var a=0;t>a;a++)i[n][s][o][a]=r}}return i}function numArr(t,e){for(var r=[],i=e||0,n=0;t>n;n++){r[n]=[]
...
for(var s in t)t.hasOwnProperty(s)&&(e.indexOf(t[s])>-1&&isNon(r)?n.push(t[s]):e.indexOf(t[s])>-1&&r.indexOf(t[s])>-1&&n.push(t[s]))
return i?rmDuplicates(n).quickSort():rmDuplicates(n)}function complement(t,e,r,i){var n=[]
t=t.quickSort(),e=e.quickSort(),r=r?r.quickSort():!1
for(var s in t)t.hasOwnProperty(s)&&(-1===e.indexOf(t[s])&&isNon(r)?n.push(t[s]):-1===e.indexOf(t[s])&&-1===r.indexOf(t[s])&&n.push(t[s]))
...
for(var s in t)t.hasOwnProperty(s)&&(-1===e.indexOf(t[s])&&isNon(r)?n.push(t[s]):-1===e.indexOf(t[s])&&-1===r.indexOf(t[s])&&n.push(t[s]))
for(s in e)e.hasOwnProperty(s)&&(-1===t.indexOf(e[s])&&isNon(r)?n.push(e[s]):-1===t.indexOf(e[s])&&-1===r.indexOf(e[s])&&n.push(e[s]))
if(r)for(s in r)r.hasOwnProperty(s)&&-1===t.indexOf(r[s])&&-1===e.indexOf(r[s])&&n.push(r[s])
return i?rmDuplicates(n).quickSort():rmDuplicates(n)}function bitStr(t,e){var r=[]
for(var i in t)t.hasOwnProperty(i)&&(r[i]=t[i]===e[i]?1:0)
...
for(var s in t)t.hasOwnProperty(s)&&(i?n[s]=t[s]&&e[s]:n=n&&t[s]&&e[s])
...
for(var s in t)t.hasOwnProperty(s)&&(i?n[s]=xor(t[s],e[s]):n=xor(n,xor(t[s],e[s])))
...
return this},this.printInOrder=function(){for(var t=0;t<this.childs-1;t++)this.childs[t].printInOrder(),Essence.addToPrinter(this.payload+"->"),this.childs[t+1].printInOrder(),Essence.addToPrinter("\r\n")},this.printPreOrder=function(){for(var t=0;t<this.childs-1;t++)Essence.addToPrinter(this.payload+"->"),this.childs[t].printInOrder(),this.childs[t+1].printInOrder(),Essence.addToPrinter("\r\n")},this.printPostOrder=function(){for(var t=0;t<this.childs-1;t++)this.childs[t].printInOrder(),this.childs[t+1].printInOrder(),Essence.addToPrinter(this.payload+"->"),Essence.addToPrinter("\r\n")},this.inOrder=function(t,e,r,i){t||(t=""),e||(e="&nbsp;&nbsp;"),r||(r=0),i||(i="|-")
for(var n=0;n<this.childs-1;n++)this.childs[n].inOrder(t+e,e,r+1,i),println(t+i+this.payload+e+" (deepth= "+r+")"),this.childs[n].inOrder(t+e,e,r+1,i),Essence.addToPrinter("\r\n")},this.preOrder=function(t,e,r,i){t||(t=""),e||(e="&nbsp;&nbsp;"),r||(r=0),i||(i="|-")
for(var n=0;n<this.childs-1;n++)println(t+i+this.payload+e+" (deepth= "+r+")"),this.childs[n].inOrder(t+e,e,r+1,i),this.childs[n].inOrder(t+e,e,r+1,i),Essence.addToPrinter("\r\n")},this.postOrder=function(t,e,r,i){t||(t=""),e||(e="&nbsp;&nbsp;"),r||(r=0),i||(i="|-")
for(var n=0;n<this.childs-1;n++)this.childs[n].inOrder(t+e,e,r+1,i),this.childs[n].inOrder(t+e,e,r+1,i),println(t+i+this.payload+e+" (deepth = "+r+")"),Essence.addToPrinter("\r\n")},this.getOrder=function(t){return this.childs.join(t||"->")},this.isLeaf=function(){return!isNon(this.childs)},this.find=function(t,e){return"bfs"===e.normal()?this.bfs(t):this.dfs(t)},this.dfs=function(t,e,r){e||(e=0),r||(r=0)
...
return t},this.avg=function(){return this.sum()/this.nbOfBranches()},this.printBFS=function(t){var e=[],r=t||"-"
for(e.unshift(this);e!=[];){var i=new TreeNode(e.pop())
println(r+">"+i.payload),r+="-"
for(var n in this.childs)this.childs.hasOwnProperty(n)&&e.unshift(n)}},this.toString=function(){var t="TreeNode(payload= "+this.payload+", "
...
e.push(this.payload)
for(var r in this.childs)this.childs.hasOwnProperty(r)&&(t?e.push(r.toArray().toString().split(",")):e.push(r.toArray()))
...
return this.top--,e}for(var r=0;r<t.length;r++)this.pop(t[r])},this.isEmpty=function(){return this.top<=-1},this.isFull=function(){return this.top>=this.value.length},this.size=function(){return this.top+1},this.toString=function(){return"Stack("+this.value.toString()+")"},this.equals=function(t){return this.toString()===t.toString()},this}function StackList(t){return this.top=new Node,this.peek=function(){return this.isEmpty()||null==this.top?null:this.top.next.payload},this.push=function(t){if(isType(t,"array"))for(var e=0;e<t.length;e++)this.push(t[e])
...
return this.top=this.top.next,e}for(var r=0;t>r;r++)this.pop()},this.isEmpty=function(){return null==this.top},this.size=function(t){return null!=this.top?this.size(t+1):t},this}function Queue(t,e){return this.value=isType(e,"Number")?new Array(e):[],this.limit=e||null,t&&this.value.push(t),this.enqueue=function(t){if(this.isFull())throw new Error("Queue overflow !")
...
return t},this.equals=function(t){return this.toString()===t.toString()},this.remove=function(t){for(var e=this.front;null!=e;)null==e.payload||e.payload!=t&&!e.payload.equals(t)||(e=null),e=e.next},this.insertAt=function(t,e){this.back.next=new Node(e),0===t?this.front=new Node(e):t===this.len?this.back=new Node(e):t>this.len&&this.enqueue(e)},this}function Astar(t,e){for(var r,i,n,s=e,o=[t],a=[];o.length>0;){var l=[],c=o[0].f
for(var u in o)o.hasOwnProperty(u)&&(l.push(o[u].f),c=Math.min(c,o[u].f))
if(r=o.filter(function(t){return t.f===c?t:void 0})[0],o=o.filter(function(t){return t.f!=c?t:void 0}),r===s){for(i in r)if(r.hasOwnProperty(nodeSuccessor)){nodeSuccessor.f=r.f+h(nodeSuccessor,r)
var d=lookfor(nodeSuccessor,o)
if(-1!=d){if(d=d[0],r.f<o[d]||-1!=lookfor(nodeSuccessor,a)&&r.f<o[lookfor(nodeSuccessor,a)][0])continue
o=o.remove(nodeSuccessor),a=a.remove(nodeSuccessor),nodeSuccessor.parent=r,n=h(nodeSuccessor,s),o.push(nodeSuccessor)}a.push(r)}throw"Solution found !"}}}function A(t,e,r){for(var i=[],n=[t],s=[],o=[0],a=[euclidianDist(t,e)];n.length>0;){var h=n[a.indexOf(a.min())]
...
else if(u>=o[c])continue}s[c]=h,o[c]=u,a[c]=o[c]+euclidianDist(l[c],e)}}function reconPath(t,e,r){for(var i=[e];e in keyList(t);)e=t[r.lookFor(e)],i.append(e)
...
return r?println(simpleTable("Comparison",i)):console.table(i),i}function database(t,e,r,i,n,s){this.name=t||"Database",this.headerRow=isNon(e)?range(100):e,this.content=isNon(r)?[].fill("..."):r,this.headerCol=i||["Index","Value"],this.admin=n||"Anonymous",this.version=s||1,this.val=new Array(this.headRow.length)
...
if(isType(t,"string")||isType(t,"array")){for(var r in t)if(t.hasOwnProperty(r))switch(t[r].toLowerCase()){case" ":e[r]="00"
break
case"a":e[r]="01"
break
case"b":e[r]="02"
...
return isType(t,"String")?e.join(""):e}function RSA(t,e){var r,i,n=t*e
...
"Mic"===navigator.appName.substring(0,3)&&navigator.appVersion.substring(0,1)>=4?$e(i).write('<a href="#" onClick="window.external.AddFavorite('+t+", "+e+');return false;">Bookmark this webpage</a><br />',!0):$e(i).write("Press CTRL + D to add this webpage to your bookmarks!",!0)}function checkBrowser(){return this.ver=navigator.appVersion,this.dom=document.getElementById?1:0,this.ie5=this.ver.indexOf("MSIE 5")>-1&&this.dom?1:0,this.ie4=document.all&&!this.dom?1:0,this.ns5=this.dom&&parseInt(this.ver)>=5?1:0,this.ns4=document.layers&&!this.dom?1:0,this.bw=this.ie5||this.ie4||this.ns4||this.ns5,this}function writeMsg(t,e,r){for(var i,n=0;n<t.length+10;)i=t.substring(n,0),isCustomType(e,"element")?e.write(i,r):$e(e).write(i,r),n++}function writeMsg2(t,e,r,i,n,s){n||(n=""),s||(s=0),s<t.length+10&&(n=t.substring(s,0),r?$n(e).innerHTML=n:$n(e).innerText=n,s++,setTimeout("writeMsg2('"+t+"', '"+e+"', "+r+", "+i+", '"+n+"', "+s+")",i||150))}function dateTime(t){var e,r,i=new Date,n=i.getFullYear(),s=i.getMonth(),o=["January","February","March","April","May","June","July","August","September","October","November","December"],a=i.getDate(),h=i.getDay(),l=i.getHours(),c=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saterday"],u="",d=i.getTimezoneOffset()
...
$e("#"+t).write(f,!0),setTimeout('dateTime("'+t+'");',1e3)}function viewHide(t,e){e||(e=0),""===$e("#"+t).css("visibility")&&1>e&&viewHide(t,e+1),"visible"===$e("#"+t).css("visibility")?($e("#"+t).setCSS("visibility","hidden"),$e("#btn_"+t).write("Hide")):($e("#"+t).setCSS("visibility","visible"),$e("#btn_"+t).write("View"))}function process(t,e,r,i){return this.name=t,this.author=e||"Anonymous",this.bitsize=0,this.description=r||"",this.content=i||"",this.sig=this.name[0]+this.name[this.name.length-1]+this.name.prod()+this.author.slice(0,2)+"-"+getType(this.content)[0],this.update=function(){this.author!=e||"Anonymous"===this.author||isNon(this.author)?this.sig=this.name[0]+this.name[this.name.length-1]+"-"+this.name.prod()+this.author.slice(0,2)+"-"+getType(this.content)[0]:this.sig=this.name[0]+this.name[this.name.length-1]+this.name.prod()+this.author.slice(0,2)+"-"+getType(this.content)[0],"N"===this.sig[this.sig.length-1]?this.bitsize=8*conv(this.content,10,2).sum():"B"===this.sig[this.sig.length-1]?this.bitsize=8:"A"===this.sig[this.sig.length-1]?this.bitsize=is2dArray(this.content)?8*this.content.numElm():8*this.content.length:"O"===this.sig[this.sig.length-1]?this.bitsize=0:"S"===this.sig[this.sig.length-1]?this.bitsize=8*this.content.length:this.bitsize=null},this.update(),this.askPermission=function(t){this.update(),t.add(this)},this.destroy=function(){Essence.say("The process named "+this.name+" (created by "+this.author+") has been destroyed !","info"),this["delete"]()},Essence.addProcess(this),this}function server(t,e,r,i,n){if(this.name=t,this.admin=e,this.version=i||1,this.maxsize=n||Math.pow(2,14),this.nb_slots=Math.pow(2,6),this.slots=mkArray(this.nb_slots,1,"empty"),this.type=r||"data",this.type=this.type.toLowerCase(),"data"===this.type)this.data=new database(this.name,range(1,1,this.maxsize),this.slots,["Index","Value"],this.admin,this.version)
...
return e=t>0&&30>=t?"Excellent":t>30&&60>=t?"Really good":t>60&&100>=t?"Good":t>100&&200>=t?"Okay":t>200&&300>=t?"Poor":t>300&&400>=t?"Bad":"Really bad",e+" ("+t+" ms)"}function msgBox(t,e,r,i,n,s){t=t.normal()
...
return s}function radialGradient(t,e,r){var i
parseInt(conv(t,16)),parseInt(conv(e,16))
return r=parseInt(r)||10,i}function parseURL(t,e){var r=location.href.split("?")
...
for(this.dictionnary=occurrenceSort(this.data),n=0;n<this.dictionnary.length;n++)this.result[n]=conv(n,10,2)},this.getResult=function(){this.updateDict()
...
for(var t=0;t<this.slots.length;t++)try{Essence.say(t+": "+JSON.parse(this.slots[t]))}catch(e){Essence.say(t+": ")}},this.pop=function(){"local"===this.type?localStorage.removeItem(this.getLocation(this.slots.last())):sessionStorage.removeItem(this.getLocation(this.slots.last())),this.free--,this.slots.pop()},this.toString=function(){return this.type.capitalize()+" memory "+this.name+": "+this.slots.toStr(!0)},this}function EvtShow(t){alert("	Name: "+t.name+"\nsource: "+t.source+"\ndata: "+t.data+"\ntarget: "+t.target+"\ntime stamp: "+t.timeStamp)}function evtLog(t){for(var e in t)t.hasOwnProperty(e)&&Essence.say(e+": "+t[e])}function InvalidParamError(t,e,r){return this.name="Invalid parameter error",this.fileName=e||getFilename(!0),this.lineNumber=r,this.message=t||"The parameter used at "+this.lineNumber+" is invalid !",this.stack=(new Error).stack,this}function testErr(t){try{throw t}catch(e){Essence.say("%cTested error%c:\n"+e.stack,"erro","text-decoration: underline; color: #000;","text-decoration: none; color: #000;")}}function noobTest(t,e){try{t(e)}catch(r){location.href="http://Stackoverflow.com/search?q=[js]+"+r.message}}function chTab(t){$e("#tab_"+$G.oldTab).rmClass("tabOn"),$e("#tab_"+$G.oldTab).addClass("tabOff"),$e("#tab_"+t).rmClass("tabOff"),$e("#tab_"+t).addClass("tabOn"),$e("#contentTab_"+$G.oldTab).setCSS("display","none"),$e("#contentTab_"+t).setCSS("display","block"),$G.oldTab=t}function moveHTMLRange(t,e){$e("#"+t).write(parseFloat($e("#"+t).val())+(e||1)),$e("#"+t+"_val").write($e("#"+t).val())}function htmlRange(t,e,r,i){if(!t)throw new Error("htmlRange needs to know the id of the element implementing the range")
return Essence.addCSS(".arrow{cursor: pointer;font-size: 20px;vertical-align: middle}"),'<b class="arrow" onClick="moveHTMLRange(\''+t+'\', -1)">&triangleleft;</b><input type="range" value='+(r||0)+" max="+(i||100)+" min="+(e||0)+' id="'+t+'" onChange="$e(\'#'+t+'_val\').write(this.value);" /><b class="arrow" onClick="moveHTMLRange(\''+t+'\', 1)">&triangleright;</b><span id="'+t+'_val">'+(r||"")+"</span>"}function labelFieldSwap(t,e){$e("#lbl_"+t).isEmpty()&&$e("#lbl_"+t).write("&ensp;",!0),$e("#"+t).isEmpty()||"\b"===$e("#"+t).val()||$e("#"+t).val()!=e&&$e("#"+t).size()<2?($e("#"+t).write($e("#lbl_"+t).val()),$e("#lbl_"+t).write("&ensp;",!0)):($e("#lbl_"+t).write(e||$e("#"+t).val()),$e("#"+t).val()!==e&&""!==$e("#"+t).val()||$e("#"+t).write("\b"))}function labelPwSwap(t,e){$e("#lbl_"+t).isEmpty()&&$e("#lbl_"+t).write("&ensp;",!0),$e("#"+t).isEmpty()||"\b"===$e("#"+t).val()||$e("#"+t).val()!=e&&$e("#"+t).size()<2?($e("#"+t).type="text",$e("#"+t).write($e("#lbl_"+t).val()),$e("#lbl_"+t).write("&ensp;",!0)):($e("#"+t).type="password",$e("#lbl_"+t).write(e||$e("#"+t).val()),$e("#"+t).val()!==e&&""!==$e("#"+t).val()||$e("#"+t).write("\b"))}function htmlInput(t,e,r){if(!t)throw new Error("htmlInput needs to know the id of the element implementing the input")
return r||(r=e||t),"<label for='"+t+"' id='lbl_"+t+"'>&ensp;</label><br /><input type='"+(e||"text")+"' id='"+t+"' value='"+r+"' onFocus='labelFieldSwap(\""+t+'", "'+r+"\")' onBlur='labelFieldSwap(\""+t+'", "'+r+"\")' />"}function htmlPassword(t,e){if(!t)throw new Error("htmlPassword needs to know the id of the element implementing the input")
return e||(e=t),"<label for='"+t+"' id='lbl_"+t+"'>&ensp;</label><br /><input type='text' id='"+t+"' value='"+e+"' onFocus='labelPwSwap(\""+t+'", "'+e+"\")' onBlur='labelPwSwap(\""+t+'", "'+e+"\")' />"}function WebPage(t,e,r,i,n,s,o,a){return this.title=t||"My web page",this.subtitle=a||"A simple web page",this.type=o.normal()||"html",this.name=e+this.type||"index."+this.type,this.path=r+"/"+this.name||this.name,this.author=i||"Maximilian Berkmann",this.version=n||1,this.structure=s||"header!h-menu!content|aside!footer",this.code="",this.template="",this.page=null,this.word2code=function(t){switch(t.normal()){case"header":return"<header><img src='img/icon.png' /><hgroup><h1>{{title}}</h1><h3>{{subtitle}}</h3></hgroup></header>"
...
return r}function isCloser(t,e,r){return Math.abs(t-e)<Math.abs(t-r)}function getClosest(t,e){for(var r=e[0],i=1;i<e.length;i++)r=isCloser(t,r,e[i])?r:e[i]
...
var e=[t]
return e.append(t.length>1?Permutation(t.get(-1)):t),console.log("perm="+e),e}function stup(t){for(alert("You have 10s to type something !"),Sys["in"].recording=!0,Sys["in"].data=[],setTimeout(function(){return Sys["in"].recording=!1,alert("Stop !!"),t&&t(Sys["in"].data.join("")),Sys["in"].data.join("")},1e4);(0===Sys["in"].data.length||$G.las)&&Sys["in"].recording;);return Sys["in"].data.join("")}function loadBar(t,e,r){t||(t="#dlb"),Essence.addCSS(t+" {border: none;background: #0F0;max-width: 200px;text-align: center;font-size: 28px;padding: 2px;}#bar {border: 1px ridge #CCC;text-align: center;width: 201px;});"),r||(r=30),$e(t).setCSS("position","relative"),$e(t).setCSS("width",$e(t).css("width")+$G.i),$e(t).write($G.i+"%"),$G.i++,$G.timer=setTimeout("loadBar("+t+", "+e+", "+r+")",r),$G.i>=100&&(clearTimeout($G.timer),$G.i=0,$e(t).write("Download finished"),e())}function binaryCases(t){var e=parseInt("1".repeat(t)),r=[],i=0
...
var i=this.sum(e,r)
return Number((i/(this.length-e)).toNDec(t))},Array.prototype.avg=function(t,e,r){e||(e=0),r||(r=this.lastIndex())
var i=this.sum(e,r)-this.slice(e,r+1).max()-this.slice(e,r+1).min()
return Number((i/(this.length-2-e)).toNDec(t))},Array.prototype.variance=function(t){return(sumPow2(this,t)/this.length-Math.pow(this.mean(t),2)).toNDec(t)},Array.prototype.stddev=function(t){var e=Math.sqrt(this.variance(t))
...
return-1!=r.indexOf(void 0)?e.remove():r}for(var i in t)t.hasOwnProperty(i)&&(e=e.remove(i))},String.prototype.toNDigits=function(t){var e=this
...
return r?i.join(r):i},String.prototype.chunk=function(t,e){return this.split(" ").get(t,e).join(" ")},Number.prototype.length=function(){if(String(this).indexOf(".")>-1)return[parseInt(String(this).split(".")[0].length),parseInt(String(this).split(".")[1].length)]
