...
frame.resizeTo(frame.x,frame.y)}}catch(t){}}function getScrenDim(){return[screen.width,screen.height]}function getWinDim(){return[screen.availWidth,screen.availHeight]}function getCookie(t){for(var e,i,r=document.cookie.split(";"),s=0;s<r.length;s++)if(e=r[s].substr(0,r[s].indexOf("=")),i=r[s].substr(r[s].indexOf("=")+1),e=e.replace(/^\s + |\s + $/g,""),e===t)return unescape(i)}function setCookie(t,e,i){i%=99983489
var r=new Date
...
return[t,e]}function And(t,e,i,r){toSameLength(t,e,null|i)
var s=r?new Array(t.length):t[0]&&e[0]
for(var n in t)r?s[n]=t[n]&&e[n]:s=s&&t[n]&&e[n]
return s}function Or(t,e,i,r){toSameLength(t,e,null|i)
var s=r?new Array(t.length):t[0]||e[0]
for(var n in t)r?s[n]=t[n]||e[n]:s=s||t[n]||e[n]
return s}function Xor(t,e,i,r){toSameLength(t,e,null|i)
var s=r?new Array(t.length):xor(t[0],e[0])
for(var n in t)r?s[n]=xor(t[n],e[n]):s=xor(s,xor(t[n],e[n]))
return s}function Imply(t,e,i,r){toSameLength(t,e,null|i)
var s=r?new Array(t.length):!t[0]||e[0]
for(var n in t)r?s[n]=!t[n]||e[n]:s=!s||!t[n]||e[n]
...
return i.length<20&&(i+=t[randTo(t.length-1)]),i}function genHash(t){for(var e,i,r="",s=toNDigits((821-t.sum())/t.prod()*t.charCodeAt(0),1),n=0;n<t.length;n++)e=t.charCodeAt(n)+s.toNDigits(1)%255,i=Math.abs(t.charCodeAt(n)+s).toNDigits(1),32>i&&(i+=48),r+=String.fromCharCode(clamp(i%127,32,126))
...
else for(i in sessionStorage)i.indexOf(this.name)>-1&&sessionStorage.removeItem(i)},this.add=function(t){this.slots[this.free++]=JSON.stringify(t)},this.print=function(){Essence.say(this.name+"'s slots: ","info")
for(var t=0;t<this.slots.length;t++)try{Essence.say(t+": "+JSON.parse(this.slots[t]))}catch(e){Essence.say(t+": ")}},this.pop=function(){"local"===this.type?localStorage.removeItem(this.getLocation(this.slots.last())):sessionStorage.removeItem(this.getLocation(this.slots.last())),this.free--,this.slots.pop()},this.toString=function(){return this.type.capitalize()+" memory "+this.name+": "+toStr(this.slots,!0)}}function EvtShow(t){alert("	Name: "+t.name+"\nsource: "+t.source+"\ndata: "+t.data+"\ntarget: "+t.target+"\ntime stamp: "+t.timeStamp)}function evtLog(t){for(atr in t)Essence.say(atr+": "+t[atr])}function noobTest(t,e){try{t(e)}catch(i){location.href="http://Stackoverflow.com/search?q = [js] + "+i.message}}function chTab(t){$e("#tab_"+oldTab).rmClass("tabOn"),$e("#tab_"+oldTab).addClass("tabOff"),$e("#tab_"+t).rmClass("tabOff"),$e("#tab_"+t).addClass("tabOn"),$e("#contentTab_"+oldTab).style.display="none",$e("#contentTab_"+t).style.display="block",oldTab=t}function animField(t){for(var e in $e(" * label"))$e(" * label").hasOwnProperty(e)&&e.htmlFor==t.id&&(e.write(t.value),t.value="")}function WebPage(t,e,i,r,s,n,o){this.title=t||"My web page",this.type=o.normal()||"html",this.name=e+this.type||"index."+this.type,this.path=i+"/"+this.name||this.name,this.author=r||"Maximilian Berkmann",this.version=s||1,this.structure=n||"header!h-menu!content|aside!footer",this.code="",this.template="",this.word2code=function(t){switch(t.norm()){case"header":return"<header><img src='img/icon.png' /><hgroup><h1>{{title}}</h1><h3>{{subtitle}}</h3></hgroup></header>"
...
i++}return e},Array.prototype.bruteForceSort=function(){for(var t=0;t<this.length;t++){var e=this[t]
pos=t
for(var i=t+1;i<=this.length;i++)e>this[i]&&(e=this[i],pos=i)
var r=this[t]
this[t]=e,this[pos]=r}return this},Array.prototype.maxSort=function(){var t=this.min(),e=this.median(),i=this.max(),r=new Array(this.length),s=this.getIncrement(3),n=this.quartile(1),o=this.quartile(3)
...
return!0},String.prototype.remove=function(t){var e=this
...
var s2t=sec2time,toSec=toS,fct=""
...
BrowserDetect.init()
var pos=0,img,src,size=0,delay=100,nb=-1,maxDelay=2e4,base64={PADCHAR:"=",ALPHA:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 + /",getbyte64:function(t,e){if(e=this.ALPHA.indexOf(t.charAt(e||0)),-1===e)throw"Cannot decode base64"
