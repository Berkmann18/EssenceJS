...
return i+=s,StdNorm(t*e,Math.sqrt(t*e*(1-e)),i)}return!1}function Bin2Po(t,e,i){return t>50&&.1>e?Po(t*e,i):!1}function Po2Norm(t,e){return t>10?StdNorm(e,Math.sqrt(e)):!1}function clamp(t,e,i){return e>t?e:t>i?i:t}function clampBottom(t,e){return e>t?e:t}function clampTop(t,e){return t>e?e:t}function mapLinear(t,e,i,r,s){return r+(t-e)*(s-r)/(i-e)}function degToRad(t){return t*Essence.d2r}function radToDeg(t){return t*Essence.r2d}function celsToFahr(t){return 33.8*t}function fahrToCels(t){return t/33.8}function primeN(t){for(var e=t.quickSort(),i=0;i<t.length;i++){t[i]%2===0&&2!=t[i]&&(e[i]="x")
...
return r}function rangeToBase(t,e,i,r){var s=[],n=0
...
return i[0]=["i","j","k"],i[1]=[t.x,t.y,t.z],i.last([e.x,e.y,e.z]),r[0]=t.y*e.z-t.z*e.y,r[1]=t.x*e.z-t.z*e.x,r.last(t.x*e.y-t.y*e.x),r[0]+"i + "+r[1]+"j + "+r.last()+"k"}function vectorToPoint(t){return new Pt(t.x,t.y,t.z)}function vectorToPointForm(t){return"("+t.split("i")[0].clean()+", "+t.split("i")[1].split("j")[0].slice(1,t.split("i")[1].split("j")[0].length).clean()+", "+t.split("i")[1].split("j")[1].split("k")[0].clean()+")"}function scalarProd(t,e){return t.x*e.x+t.y*e.y+t.z*e.z}function union(t,e,i,r){return r?rmDuplicates(t.concat(e,i)).quickSort():rmDuplicates(t.concat(e,i))}function intersection(t,e,i,r){var s=[]
...
else if(this.indexOf(t)>-1)throw"the object "+t.toString()+"is already present in "+this.toString()},String.prototype.remove=function(t){var e=this
...
return t?e.split("").join(""):e},Number.prototype.length=function(){if(-1!=(this+"").indexOf("."))return[parseInt((this+"").split(".")[0]).length(),parseInt((this+"").split(".")[1]).length()]
