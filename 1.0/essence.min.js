"use strict"
function Element(t){if(/^([#\.\* _-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as it'start invalid.")
...
this.node.className=e.replace(/^\s + |\s + $/g,"")}},this.toggleCSS=function(t,e,i){if(i||(i=0),""===this.css(t)&&i<1&&this.toggleCSS(t,e,i+1),"visibility"===t)"visible"===this.css("visibility")?this.setCSS("visibility","hidden"):this.setCSS("visibility","visible")
...
i?r.httpEquiv=i:r.name=t,r.content=e,document.head.appendChild(r)}function xor(t,e){return t&&!e||!t&&e}function noRightClick(){document.oncontextmenu=new Function("return false")}function reloadPage(t){2===t?location.href=window.location.href:location.reload()}function redirect(t,e,i){e||(e=3e3)
var r=Math.floor(e/1e3)
$e("#"+i).write("<h2>Redirecting to <ins>"+t+"</ins> ...<br />in <span id='timeleft'>"+r+"</span>start</h2>",!0),r--,$e("#timeleft").write(r),setTimeout("location = '"+t+"';",e)}function isValid(t,e){var i,r=!0
...
frame.resizeTo(frame.x,frame.y)}}catch(t){Essence.say("An error occurred when trying to maximise the size Because of %c"+t,"err","text-decoration: underline;")}}function getScreenDim(){return[screen.width,screen.height]}function getWinDim(){return[screen.availWidth,screen.availHeight]}function getCookie(t){for(var e,i,r=document.cookie.split(";"),n=0;n<r.length;n++)if(e=r[n].substr(0,r[n].indexOf("=")),i=r[n].substr(r[n].indexOf("=")+1),e=e.replace(/^\s+|\s+$/g,""),e===t)return decodeURIComponent(i)}function setCookie(t,e,i){i=i?i%99983489:99983488
var r=new Date
...
return[e,i]}function getResources(t){for(var e=$n("*link"),i=$n("*script"),r=$n("*style"),n=[],s=$n("*a"),o=$n("*img"),a=$n("*input image"),h=[$n("*div"),$n("*section"),$n("*td"),$n("*th"),$n("*li")],l=0;l<e.length;l++)isNon(e[l])||(n[l]=e[l].href),Essence.say(e[l].href.split("/")[e[l].href.split("/").length-1]+" has been added to the resources getter.","info")
...
Essence.say(u.split("/")[u.split("/").length-1]+" has been added to the resources getter.","info")}return Essence.say("Resource list: "+n.clean()),t?n.clean():n}function gatherScripts(t){for(var e=$n("*script"),i=t?[]:{},r=0;r<e.length;r++)t?i.push(e[r].src):i[e[r].src.split("/")[e[r].src.split("/").length-1]]=e[r].src
...
return(!i||!(keyList(r,!0).indexOf(i+t)>-1||valList(r,!0).indexOf(i+t)>-1))&&(!(keyList(r,!0).indexOf(t)>-1||valList(r,!0).indexOf(t)>-1)&&void include(t,e))}function stripTags(t){return t.replace(/<[\s\S]+>(.*?)<\/[\s\S]+>/,"$1")}function stripPath(t){return t.split("/")[t.split("/").length-1]}function getFilename(t){return t?stripPath(location.pathname):stripPath(location.pathname).get(-stripPath(location.pathname).lastIndexOf(".")-1)}function getCurrentPath(t,e){e||(e="file:///")
for(var i=t.split("/"),r=e.split("/"),n=0,s=0;e.indexOf(i[n])>-1;)n++
for(var o=i.get(n).join("/");o.indexOf(r[s])>-1;)console.log("Gone through "+r[s]),s++
if(s>0)for(n=0;n<s;n++)o="../"+o
return o}function filenameList(t){for(var e=[],i=0;i<t.length;i++)e.push(stripPath(t[i]))
...
return i.toNDec(e)}function conv(t,e,i,r){return r?parseFloat(t,e||2).toString(i||10):parseInt(t,e||2).toString(i||10)}function negateBin(t,e){for(var i=[],r=0;r<t.length;r++)i[r]=1-parseInt(t[r])
var n=conv(i.join(""))
return n++,e?conv(n,10,2).split(""):conv(n,10,2)}function floatingPtBin(t){var e,i,r=1===t[0]?-1:1
...
case 32:break
case 64:break
default:throw new Error("Unvalid binary number")}return r*Math.pow(2,e)*i}function min2dec(t){return 50*t/30}function dec2min(t){return 30*t/50}function toS(t){if(t==parseFloat(t))return parseFloat(t)
var e=2===t.count(":")
...
return e?(n=(t%60).toNDigits(),i=t>=3600?Math.floor(t/3600):0,r=Math.floor((t-n-3600*i)/60),r=r<=0?"00":r.toNDigits(),i=i<=0?"00":i.toNDigits(),i+":"+r+":"+n.get(0,Math.min(4,n.length-1))):(n=(t%60).toNDigits(),r=Math.floor(t/60).toNDigits(),r<=0?n:r+":"+n.get(0,Math.min(4,n.length-1)))}function markConv(t,e,i,r){return(t/e*(i||100)).toNDec(r||2)}function nthroot(t,e,i){for(var r=t/2,n=0;n<60;n++)r+=(t-Math.pow(r,e))/(Math.pow(r+1,e)-Math.pow(r,e))
return r.toNDec(i||20)}function log(t,e){return Math.log(t)/Math.log(e||10)}function ln(t){return log(t,Math.E)}function gcd(t,e){return e?gcd(e,t%e):Math.abs(t)}function Bin(t,e,i){return C(t,i)*Math.pow(e,i)*Math.pow(1-e,t-i)}function BinCumul(t,e,i){for(var r=[],n=0;n<i;n++)r.push(Bin(t,e,i))
return r.sum()}function BinCumulLT(t,e,i){for(var r=1-e,n=t-i,s=i+1,o=n+s-1,a=0,h=n;h<o+1;h++)a+=factorial(o)/(factorial(h)*factorial(o-h))*Math.pow(r,h)*Math.pow(1-r,o-h)
...
return i.sum()}function factorial(t){for(var e=t,i=1;i<t;i++)e*=i
return e}function C(t,e){return factorial(t)/(factorial(e)*factorial(t-e))}function Bin2Norm(t,e,i,r){return t*e>5&&t*(1-e)>5&&(i+=">="===r?-.5:.5,StdNorm(t*e,Math.sqrt(t*e*(1-e)),i))}function Bin2Po(t,e,i){return t>50&&e<.1&&Po(t*e,i)}function Po2Norm(t,e){return t>10&&StdNorm(e,Math.sqrt(e))}function erf(t){var e,i=1/(1+.5*Math.abs(t))
...
return r=Math.pow(n*(1-e),.5),.5*(1+erf((i-n)/(r*Math.pow(2,.5))))}function clamp(t,e,i){return t<e?e:t>i?i:t}function revClamp(t,e,i){return e<=t&&t<=i?getClosest(t,[e,i]):t}function clampBottom(t,e){return t<e?e:t}function clampTop(t,e){return t>e?e:t}function mapLinear(t,e,i,r,n){return r+(t-e)*(n-r)/(i-e)}function deg2rad(t){return t*Math.PI/180}function rad2deg(t){return 180*t/Math.PI}function cels2fahr(t){return 33.8*t}function fahr2cels(t){return t/33.8}function primeN(t){for(var e=t.quickSort(),i=0;i<t.length;i++){t[i]%2===0&&2!=t[i]&&(e[i]="x")
for(var r=0;r<i;r++)primeCheck(e[r],e[i])&&(e[i]="x")}return e.remove()}function primeCheck(t,e){return t>1&&e>1&&e%t===0&&e!=t}function getClosestRoot(t,e){e||(e=2)
var i=0,r=0
if(i=t/2*t/2/2-2<=t?t/2:t/3*t/3<=t?t/3:t/4,Math.pow(i,e)===t)return i
for(var n=1;n<=e;n++)for(var s=1;s<t;s++)Math.pow(s,n)===t||Math.pow(s,n-1)*s===t?r=s:(Math.pow(s,n)>t||Math.pow(s,n-1)*s>t)&&(r=s-.5)
...
return l/c===1?String(s+h/c):(s&&(s+=" and "),s+String(h/c)+"/"+String(l/c))}function clearNum(t,e,i){for(var r=(Math.floor(t)+"").length/3,n="",s=0;s<r;s++)n=(t-t%Math.pow(1e3,s))%Math.pow(1e3,s+1)/Math.pow(1e3,s)+" "+n
...
return 0===n?(-e/(2*t)).toNDec(r):[((-e-Math.sqrt(Math.abs(n)))/(2*t)+(n<0?"i":0)).toNDec(r),(-e+Math.sqrt(Math.abs(n)))/(2*t)+(n<0?"i":0).toNDec(r)]}function eqSolver(formula,res,a,b){a=a||-100,b=b||200
...
for(var x=a;x<=b;x++)for(var y=a;y<=b;y++)r[x][y]="("+x+","+y+") "+eval(formula)
return r.filter(function(t){if(t.split(") ")[1]==res)return t.split(") ")[0]+")"})}function manuEqSolver(eq,max,dim,r){for(var res=mkArray(max+1,dim,1),p=[],x=0;x<res.length;x++)if(2===dim)for(var y=0;y<res.length;y++)res[x][y]=eval(eq),res[x][y]===r&&p.push("x = "+x+", y = "+y)
...
return e.open("GET",t,!1),e.onreadystatechange=function(){if(4===e.readyState&&(200===e.status||0==e.status))return $G.fct=e.responseText,e.responseText},e.send(null),$G.fct}function getKey(t,e){var i=document.all?event.keyCode:t.which,r=e?String.fromCharCode(i).toLowerCase():String.fromCharCode(i)
...
return t?i.getDate().toNDigits()+e[i.getMonth()]+i.getUTCFullYear():i.getDate().toNDigits()+"/"+(i.getMonth()+1).toNDigits()+"/"+i.getUTCFullYear()}function getTimestamp(t){return t?getDate()+" "+getTime(!0):getDate(!0)+"-"+getTime().replace(/\:/g,"-")}function date2num(t){t||(t=getDate())
var e=t.split("/")
...
for(var i=[],r=t;r<=e;r++)i.push(String.fromCharCode(r))
...
return r}function Person(t,e,i,r,n,s,o,a,h,l,c,u,d,f){return this.firstName=t||"",this.secondName=e||"",this.lastName=i||"",this.title=r||"",this.nickname=n||"",this.phoneNum=s||"none",this.country=o||"",this.city=a||"",this.sex="male"===h.toLowerCase()||"female"===h.toLowerCase()?h:"other",this.birthday=l||"01/01/2000",this.deathday=null,this.jobs=c||"unemployed",this.activities=u||"none",this.websites=d||"none",this.quote=f||"",this.toString=function(){var t="Person("
for(var e in this)this.hasOwnProperty(e)&&"toString"!=e&&(t+=e+"="+this[e]+", ")
return t.substring(0,t.length-2)+")"},this.genID=function(){return(this.lastName.get(0,3)+this.birthday.split("/")[1]+this.firstName.get(0,1)+this.secondName.get(0,1)+this.birthday.split("/")[2]+this.sex[0]).toUpperCase()},this.getAge=function(){return(date2num(getDate())-date2num(this.birthday)).toNDec(2)},this.isMajor=function(){return("UN"===this.country.get(0,1)||"united states"===this.country.toLowerCase())&&this.getAge()>20||("UN"!=this.country.get(0,1)||"united states"!=this.country.toLowerCase())&&this.getAge()>18},this.getFullName=function(){return this.firstName+" "+this.secondName+(""!=this.nickname?' "'+this.nickname+'" ':" ")+this.lastName},this.summary=function(){return"Hello, I'm "+this.title+" "+this.getFullName()+" a "+this.getAge()+" years old "+this.country+"citizen from "+this.city+". I'm "+arrayLiteral(this.jobs)+". I enjoy "+arrayLiteral(this.activities)+". To contact me either go on: "+arrayLiteral(this.websites)+" or call me at "+this.phoneNum+"."},this}function Item(t,e,i,r,n){return this.name=t||"unknown",this.category=e||"unknown",this.price=i||0,this.ageMinRequired=r||.25,this.quantity=n||1,this.firstMade=(new Date).toLocaleString(),this.dublicate=function(t,e){for(var i=0;i<t;i++)e.push(new Item(this.name,this.category,this.price,this.ageMinRequired,this.quantity))},this.remove=function(t){t=t.remove()},this.toString=function(){var t=""
...
if(t||(t=0),e||(e=1),i||(i=100),e>0)for(var o=t;o<=i;o+=e)n[s++]=Number(o).toNDec(r)
else for(o=t;o>=i;o-=e)n[s++]=Number(o).toNDec(r)
return n}function range2base(t,e,i,r){var n=[],s=0
if(e>0)for(var o=t;o<=i;o+=e)n[s++]=conv(o,10,r)
else for(o=t;o>=i;o+=e)n[s++]=conv(o,10,r)
return n}function letterArray(t,e){for(var i=t.charCodeAt(0)||97,r=e.charCodeAt(0)||122,n=[],s="",o=i;o<=r;o++)for(var a=i;a<=r;a++)o!=a&&(s=String.fromCharCode(o)+String.fromCharCode(a),n.push(s))
return n}function mixedRange(t,e,i,r){var n=[],s=range(t,e,i)
if(r)for(;s.length>0;)n.push(s.rand()),s=s.remove()
else for(var o=t;o<=i;o++)n[o]=s.rand()
return n}function mkArray(t,e,i){var r=[]
if(1===e)if(isNon(i))r=new Array(t)
else for(var n=0;n<t;n++)r[n]=i
else if(2===e)if(isNon(i))for(r=new Array(t),n=0;n<t;n++)r[n]=new Array(t)
else for(n=0;n<t;n++){r[n]=new Array(t)
for(var s=0;s<t;s++)r[n][s]=i}else if(3===e)if(isNon(i))for(r=new Array(t),n=0;n<t;n++)for(r[n]=new Array(t),s=0;s<t;s++)r[n][s]=new Array(t)
else for(n=0;n<t;n++)for(r[n]=new Array(t),s=0;s<t;s++){r[n][s]=new Array(t)
for(var o=0;o<t;o++)r[n][s][o]=i}else{if(4!==e)throw new Error("Unvalid dimension. Only 1D-4D arrays can be made.")
if(isNon(i))for(r=new Array(t),n=0;n<t;n++)for(r[n]=new Array(t),s=0;s<t;s++)for(r[n][s]=new Array(t),o=0;o<t;o++)r[n][s][o]=new Array(t)
else for(n=0;n<t;n++)for(r[n]=new Array(t),s=0;s<t;s++)for(r[n][s]=new Array(t),o=0;o<t;o++){r[n][s][o]=new Array(t)
for(var a=0;a<t;a++)r[n][s][o][a]=i}}return r}function numArr(t,e){for(var i=[],r=e||0,n=0;n<t;n++){i[n]=[]
for(var s=0;s<t;s++)i[n][s]=r++}return i}function swap(t,e,i){var r
...
t=t.quickSort(),e=e.quickSort(),i=!!i&&i.quickSort()
for(var s in t)t.hasOwnProperty(s)&&(e.indexOf(t[s])>-1&&isNon(i)?n.push(t[s]):e.indexOf(t[s])>-1&&i.indexOf(t[s])>-1&&n.push(t[s]))
...
t=t.quickSort(),e=e.quickSort(),i=!!i&&i.quickSortort()
for(var s in t)t.hasOwnProperty(s)&&(e.indexOf(t[s])===-1&&isNon(i)?n.push(t[s]):e.indexOf(t[s])===-1&&i.indexOf(t[s])===-1&&n.push(t[s]))
for(s in e)e.hasOwnProperty(s)&&(t.indexOf(e[s])===-1&&isNon(i)?n.push(e[s]):t.indexOf(e[s])===-1&&i.indexOf(e[s])===-1&&n.push(e[s]))
if(i)for(s in i)i.hasOwnProperty(s)&&t.indexOf(i[s])===-1&&e.indexOf(i[s])===-1&&n.push(i[s])
...
var n=r.pop()
try{if(n.payload===t)return[e,i]}catch(t){return[-1,i]}n.left&&r.push(n.left),n.right&&r.push(n.right),e++,i++}},this.bfs=function(t,e,i){e||(e=0),i||(i=0)
var r=[]
for(r.unshift(this);r!=[];){e=0
var n=r.pop()
try{if(n.payload===t)return[e,i]}catch(t){return[-1,i]}n.left&&r.unshift(n.left),n.right&&r.unshift(n.right),e++,i++}},this.sum=function(){var t=this.payload
...
i+=r+t
try{r.left&&e.unshift(r.left),r.right&&e.unshift(r.right)}catch(e){Essence.say(e+" caused "+this+".printBFS("+t+") to go wrong","err")}}return t},this.toString=function(){var t="TreeNode(payload = "+this.payload+", "
...
return t.next=this,t.prev=null,this.prev=t,this.next=null,t},this.toString=function(){return"Node(payload = "+this.payload+", previous = "+this.prev+", next = "+this.next+")"},this.equals=function(t){return this.payload===t.payload&&this.next.equals(t.next)&&this.prev.equals(t.prev)},this.find=function(t,e){return e||(e=0),this.payload===t?e:this.next?this.next.find(t,e+1):[-1,e]},this}function PathNode(t,e){return this.f=t+e||1,this.parent=null,this}function NTreeNode(t,e){return this.payload=t||0,this.child=e||[],this.add=function(t){this.child.push(t)},this.traverse=function(){for(var t in this.child)this.child.hasOwnProperty(t)&&t.traverse()
return this},this.printInOrder=function(){for(var t=0;t<this.child-1;t++)this.child[t].printInOrder(),Essence.addToPrinter(this.payload+"->"),this.child[t+1].printInOrder(),Essence.addToPrinter("\r\n")},this.printPreOrder=function(){for(var t=0;t<this.child-1;t++)Essence.addToPrinter(this.payload+"->"),this.child[t].printInOrder(),this.child[t+1].printInOrder(),Essence.addToPrinter("\r\n")},this.printPostOrder=function(){for(var t=0;t<this.child-1;t++)this.child[t].printInOrder(),this.child[t+1].printInOrder(),Essence.addToPrinter(this.payload+"->"),Essence.addToPrinter("\r\n")},this.inOrder=function(t,e,i,r){t||(t=""),e||(e="&nbsp;&nbsp;"),i||(i=0),r||(r="|-")
for(var n=0;n<this.child-1;n++)this.child[n].inOrder(t+e,e,i+1,r),println(t+r+this.payload+e+" (deepth= "+i+")"),this.child[n].inOrder(t+e,e,i+1,r),Essence.addToPrinter("\r\n")},this.preOrder=function(t,e,i,r){t||(t=""),e||(e="&nbsp;&nbsp;"),i||(i=0),r||(r="|-")
for(var n=0;n<this.child-1;n++)println(t+r+this.payload+e+" (deepth= "+i+")"),this.child[n].inOrder(t+e,e,i+1,r),this.child[n].inOrder(t+e,e,i+1,r),Essence.addToPrinter("\r\n")},this.postOrder=function(t,e,i,r){t||(t=""),e||(e="&nbsp;&nbsp;"),i||(i=0),r||(r="|-")
for(var n=0;n<this.child-1;n++)this.child[n].inOrder(t+e,e,i+1,r),this.child[n].inOrder(t+e,e,i+1,r),println(t+r+this.payload+e+" (deepth = "+i+")"),Essence.addToPrinter("\r\n")},this.getOrder=function(t){return this.child.join(t||"->")},this.isLeaf=function(){return!isNon(this.child)},this.find=function(t,e){return"bfs"===e.normal()?this.bfs(t):this.dfs(t)},this.dfs=function(t,e,i){e||(e=0),i||(i=0)
for(var r in this.child)this.child.hasOwnProperty(r)&&r.dfs(t,e+1,i++)
...
for(var e in this.child)this.child.hasOwnProperty(e)&&(t+=e.payload)
return t},this.min=function(){var t=this.payload
for(var e in this.child)this.child.hasOwnProperty(e)&&(t=Math.min(t,e.payload))
return t},this.max=function(){var t=this.payload
for(var e in this.child)this.child.hasOwnProperty(e)&&(t=Math.max(t,e.payload))
return t},this.nbOfBranches=function(t){t||(t=0)
for(var e in this.child)this.child.hasOwnProperty(e)&&(t=e.nbOfBranches(t+1))
...
println(i+">"+r.payload),i+="-"
for(var n in this.child)this.child.hasOwnProperty(n)&&e.unshift(n)}},this.toString=function(){var t="TreeNode(payload= "+this.payload+", "
for(var e in this.child)this.child.hasOwnProperty(e)&&(t+=e.toString())
return t.substring(0,t.length)+")"},this.toArray=function(t){var e=[]
e.push(this.payload)
for(var i in this.child)this.child.hasOwnProperty(i)&&(t?e.push(i.toArray().toString().split(",")):e.push(i.toArray()))
return t?e.toString().split(","):e},this}function Set(t){return this.value=(isType(t,"arr")?t:[t])||[],this.size=function(){return this.value.length},this.add=function(t){this.value.indexOf(t)===-1&&(isType(t,"array")?this.value=this.value.concat(t):this.value.push(t))},this.remove=function(t){if(this.value.indexOf(t)!==-1)if(isType(t,"array"))for(var e=0;e<t.length;e++)this.remove()
else this.value=this.value.remove()},this.clear=function(){this.value=[]},this.isEmpty=function(){return this.value===[]},this.contains=function(t){if(isType(t,"array")){for(var e=!0,i=0;i<t.length;i++){if(!e)return!1
e=e&&this.contains(t[i])}return e}return this.value.indexOf(t)!=-1},this.equals=function(t){return this.value.toString()===t.value.toString()},this.isSame=function(t){if(this.equals(t))return!0
for(var e=!0,i=0;i<t.size();i++){if(!e)return!1
e=e&&this.contains(t.value[i])}return e},this.toString=function(){return"Set("+this.value.toString()+")"},this.subset=function(t,e){return this.value.slice(t,e+1)},this.get=function(t){return this.value[t]},this.first=function(){return this.value[0]},this.last=function(){return this.value[this.value.lastIndex()]},this.min=function(t,e){return this.value.min(t,e)},this.max=function(t,e){return this.value.max(t,e)},this.median=function(t,e){return this.value.max(t,e)},this}function SortedSet(t){return this.value=t||[],this.add=function(t){this.value.indexOf(t)===-1&&(isType(t,"array")?this.value=this.value.concat(t):this.value.push(t)),this.value.quickSort()},this}function Stack(t,e){return this.value=isType(e,"Number")?new Array(e):[],this.limit=e||null,t&&this.value.push(t),this.peek=function(){return this.value.last()},this.ground=function(){return this.value[0]},this.push=function(t){if(this.isFull())throw new Error("Stack overflow !")
isType(t,"array")?this.value.append(t):this.value.push(t)},this.pop=function(){if(this.isEmpty())throw new Error("Stack underflow !")
var t=this.peek()
return this.value.pop(t),t},this.isEmpty=function(){return 0===this.value.length},this.isFull=function(){return null!=this.lim&&this.value.length>=this.limit},this.size=function(){return this.value.length},this.toString=function(){return"Stack("+this.value.toString()+")"},this.equals=function(t){return this.toString()===t.toString()},this}function StackArray(t){return this.value=new Array(t),this.top=-1,this.peek=function(){return this.value[this.top]},this.push=function(t){if(this.isFull())throw new Error("Stack overflow !")
...
return this.top=this.top.next,e}for(var i=0;i<t;i++)this.pop()},this.isEmpty=function(){return null==this.top},this.size=function(t){return null!=this.top?this.size(t+1):t},this}function Queue(t,e){return this.value=isType(e,"Number")?new Array(e):[],this.limit=e||null,t&&this.value.push(t),this.enqueue=function(t){if(this.isFull())throw new Error("Queue overflow !")
...
return this.front===this.back?(t=this.value[this.front],this.front=this.back=-1):(t=this.value[this.front],this.front=(this.front+1)%this.value.length),t},this.isEmpty=function(){return this.front===-1&&this.back===-1},this.isFull=function(){return this.back>(this.front+1)%this.value.length},this.size=function(){return this.value.length},this.toString=function(){return"Queue(front = "+this.front+", back = "+this.back+", value = "+this.value.toString()+")"},this.equals=function(t){return this.toString()===t.toString()},this}function QueueList(){return this.front=null,this.back=null,this.len=0,this.enqueue=function(t){if(isType(t,"array"))for(var e=0;e<t.length;e++)this.enqueue(t[e])
...
if(i=o.filter(function(t){if(t.f===c)return t})[0],o=o.filter(function(t){if(t.f!=c)return t}),i===s){for(r in i)if(i.hasOwnProperty(nodeSuccessor)){nodeSuccessor.f=i.f+h(nodeSuccessor,i)
var d=lookfor(nodeSuccessor,o)
if(d!=-1){if(d=d[0],i.f<o[d]||lookfor(nodeSuccessor,a)!=-1&&i.f<o[lookfor(nodeSuccessor,a)][0])continue
o=o.remove(),a=a.remove(),nodeSuccessor.parent=i,n=h(nodeSuccessor,s),o.push(nodeSuccessor)}a.push(i)}throw"Solution found !"}}}function A(t,e,i){for(var r=[],n=[t],s=[],o=[0],a=[euclidianDist(t,e)];n.length>0;){var h=n[a.indexOf(a.min())]
if(h===e)return reconPath(s,h,i)
n=n.remove(),r.push(h)
var l=i.neighbour(h[0],h[1])
Essence.say("neighbour of "+h+":\n"+l.toStr(!0),"info")
for(var c=0;c<l;c++)if(!(r.indexOf(l[c])>-1)){var u=o[r.indexOf(h)]+1
if(r.indexOf(l[c])===-1)n.push(l[c])
else if(u>=o[c])break}s[c]=h,o[c]=u,a[c]=o[c]+euclidianDist(l[c],e)}}function reconPath(t,e,i){for(var r=[e];e in keyList(t);)e=t[i.lookFor(e)],r.append(e)
...
return e.remove()}function Shape(t,e,i,r){return this.x=t||0,this.y=e||0,this.border=i||1,this.vel=r||new Vector,this.norm=this.vel.getNormal(),this.update=function(){this.x+=this.vel.x,this.y+=this.vel.y,this.norm=this.vel.getNormal()},this.stop=function(){this.vel=this.norm=new Vector},this.toString=function(){return"Shape(x = "+this.x+", y = "+this.y+", border = "+this.border+", velocity = "+this.vel+")"},this.offset=function(t){return"l"===t?this.x-1-this.border:"rad"===t?this.x+1+this.border:"u"===t?this.y-1-this.border:this.y+1+border},this.bounce=function(t){this.vel.reflect(t)},this.copy=function(){},this.mult=function(t){return this.x*=t,this.y*=t,this},this.div=function(t){return this.x/=t,this.y/=t,this},this.add=function(t){return this.x+=t.x,this.y+=t.y,this},this.sub=function(t){return this.x-=t.x,this.y-=t.y,this},this.draw=function(){},this.getSpeed=function(){return Math.sqrt(Math.pow(this.vel.x,2)+Math.pow(this.vel.y,2))},this}function Box(t, e, i, r, n, s, o, a, h, l){return this.x=t||0,this.y=e||0,this.z=i||0,this.width=r||10,this.height=n||10,this.deepth=s||.1,this.borderSize=o||1,this.borderColor=a||"#000",this.borderRadius=l||0,this.backgroundColor=h||"#fff",this.ratio=(this.height/this.width).toNDigits(),this.ratio3d=[this.ratio,this.height/non0(this.deepth),this.width/non0(this.deepth)].mean(4),this.draw=function(){},this.erase=function(){},this.rot=function(t,e,i){},this.translate=function(t,e,i){},this.toString=function(){return"Box(x = "+this.x+", y = "+this.y+", z = "+this.z+", width = "+this.width+", height = "+this.height+", deepth = "+this.deepth+", borderSize = "+this.borderSize+", borderColor = "+this.borderColor+", borderRadius = "+this.borderRadius+", backgroundColor = "+this.backgroundColor+")"},this}function AABB(t,e,i,r,n,s){return this.x=t||0,this.y=e||this.y,this.w=i||10,this.height=r||this.w,this.border=n||1,this.vel=s||new Vector,this.ratio=this.height/this.w,this.norm=this.vel.getNormal(),this.getPoints=function(){return[new Pt(this.x,this.y),new Pt(this.x+this.w,this.y),new Pt(this.x+this.w,this.y+this.height),new Pt(this.x,this.y+this.height)]},this.equals=function(t){return this.x==t.x&&this.y==t.y&&this.w==t.w&&this.height==t.height&&this.border==t.border&&this.vel.equals(t.vel)},this.toString=function(){return"AABB(x = "+this.x+", y = "+this.y+", width = "+this.w+", height = "+this.height+", velocity = "+this.vel.toString()+", border = "+this.border+")"},this.hit=function(t, e){return"l"===e?t.offset("l")<=this.offset("rad"):"rad"===e?t.offset("rad")>=this.offset("l"):"u"===e?t.offset("u")<=this.offset("d"):"d"===e?t.offset("d")>=this.offset("u"):this.hit(t,"l")||this.hit(t,"rad")||this.hit(t,"u")||this.hit(t,"d")},this.copy=function(){return new AABB(this.x,this.y,this.w,this.height,this.b,this.vel)},this.concat=function(t){this.w=t.x-this.x-this.w,this.height=t.y-this.y-this.height},this.deconcat=function(t){this.w=(t.x-this.x)/2,this.height=(t.y-this.y)/2},this.draw=function(){},this.getPerimeter=function(){return 2*this.w+2*this.height},this.getArea=function(){return this.w*this.height},this.getDiag=function(){return Math.sqrt(Math.pow(this.w,2)+Math.pow(this.height,2))},this}function Circ(t, e, i, r, n){return this.x=t||0,this.y=e||0,this.rad=i||10,this.border=r||1,this.vel=n||new Vector,this.norm=this.vel.getNormal(),this.offset=function(t){return"l"===t?this.x-this.rad:"rad"===t?this.x+this.rad:"u"===t?this.y-this.rad:this.y+this.rad},this.equals=function(t){return this.x===t.x&&this.y===t.y&&this.rad===t.rad&&this.border===t.border&&this.vel.equals(t.vel)},this.toString=function(){return"Circ(x = "+this.x+", y = "+this.y+", radius = "+this.rad+", velocity = "+this.vel.toString()+")"},this.hit=function(t, e){return!!t.hit(this,"")&&(this.bounce(t.norm),this.update(),!0)},this.draw=function(){},this.getCircumference=function(){return 2*this.rad*Math.PI},this}function Pt(t, e){return this.prototype=Shape.prototype,this.x=t||0,this.y=e||0,this.vel=new Vector,this.equals=function(t){return this.x==t.x&&this.y==t.y},this.toString=function(){return"Pt(x = "+this.x+", y = "+this.y+")"},this}function Line(t, e){return this.start=t,this.e=e,this.equals=function(t){return this.start.equals(t.start)&&this.e.equals(t.e)},this.toString=function(){return"Line(start = "+this.start.toString()+", end = "+this.e.toString()+")"},this}function Vector(t, e){return this.prototype=Shape.prototype,this.x=t||0,this.y=e||0,this.toString=function(){return"Vector(x = "+this.x+", y = "+this.y+")"},this.equals=function(t){return this.x==t.x&&this.y==t.y},this.copy=function(){return new Vector(this.x,this.y)},this.normalise=function(){var t=Math.sqrt(Math.pow(this.x,2)+Math.pow(this.y,2))
...
return e.mult(2*this.dot(t||this.normal)),this.sub(e),this},this.angle=function(t){return Math.acos((this.x*t.x+this.y*t.y)/(this.length()*t.length()))},this}function Polygon(t,e,i){return this.points=t,this.border=e||1,this.vel=i||new Vector,this.norm=this.vel.getNormal(),this.equals=function(t){var e=!0
...
return t+="]","Polygon(points = "+t+", velocity = "+this.vel.toString()+", border = "+this.border+")"},this.hit=function(t,e){return"l"===e?t.offset("l")<=this.offset("rad"):"rad"===e?t.offset("rad")>=this.offset("l"):"u"===e?t.offset("u")<=this.offset("d"):"d"===e?t.offset("d")>=this.offset("u"):this.hit(t,"l")||this.hit(t,"rad")||this.hit(t,"u")||this.hit(t,"d")},this.copy=function(){return new Polygon(this.points,this.b,this.vel)},this.draw=function(){},this}function simpleTable(t, e, i, r, n, s){isNon(r)&&(r="")
for(var o="<table id='"+(i||"t")+"' style='"+r+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":""),a=0;a<e.length;a++){if(o+="<tr>",n)for(var h=0;h<e[a].length;h++)o+="<td id='"+(i||"t")+(isNon(s)?a+"_"+h:s[a][h])+"'>"+e[a][h]+"</td>"
else o+="<td id='"+(i||"t")+(isNon(s)?a:s[a])+"'>"+e[a]+"</td>"
o+="</tr>"}return o+="</table><style>table{background: #000;}table, td {border: 1px solid #000; color: #000; background: #fff;} tr:nth-child(even) td{background: #ddd;} tr td:hover{background: #bbb;}</style>"}function rowTable(t,e,i,r,n,s,o){isNon(s)&&(s="")
for(var a="<table id='"+(r||"t")+"' style='"+s+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":""),h=0;h<i.length;h++){if(a+=e?"<tr><th>"+e[h]+"</th>":"<tr>",n)for(var l=0;l<i[h].length;l++)a+="<td id='"+(r||"t")+(isNon(o)?h+"_"+l:o[h][l])+"'>"+i[h][l]+"</td>"
else a+="<td id='"+(r||"t")+(isNon(o)?h:o[h])+"'>"+i[h]+"</td>"
a+="</tr>"}return a+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td, tr:nth-child(even) th{background: #ddd;}tr td:hover, tr th:hover{background: #bbb;}</style>"}function colTable(t,e,i,r,n,s,o){isNon(s)&&(s="")
var a="<table id='"+(r||"t")+"' style='"+s+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":"")
if(e){a+="<tr>"
for(var h=0;h<e.length;h++)a+="<th>"+e[h]+"</th>"
a+="</tr>"}for(h=0;h<i.length;h++){if(a+="<tr>",n)for(var l=0;l<i[h].length;l++)a+="<td id='"+(r||"t")+(isNon(o)?h+"_"+l:o[h][l])+"'>"+i[l][h]+"</td>"
else a+="<td id='"+(r||"t")+(isNon(o)?h:o[h])+"'>"+i[h]+"</td>"
a+="</tr>"}return a+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td{background: #ddd;}tr td:hover{background: #bbb;}</style>"}function complexTable(t,e,i,r,n,s,o,a){isNon(o)&&(o="")
for(var h="<table id='"+(n||"t")+"' style='"+o+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption><tr><td></td>":"<tr><td></td>"),l=0;l<r.length;l++)h+="<th>"+r[l]+"</th>"
for(h+="</tr>",l=0;l<i.length;l++){if(h+=e?"<tr><th>"+e[l]+"</th>":"<tr>",s)for(var c=0;c<i[l].length;c++)h+="<td id='"+(n||"t")+(isNon(a)?l+"_"+c:a[l][c])+"'>"+i[l][c]+"</td>"
else h+="<td id='"+(n||"t")+(isNon(a)?l:a[l])+"'>"+i[l]+"</td></tr>"
h+="</tr>"}return h+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td{background: #ddd;}tr td:hover{background: #bbb;}</style>"}function colourTable(t,e,i,r,n,s){var o="<table id='"+(r||"c")+"' style='"+s+"' cellspacing=0 cellpadding=2>"+(t?"<caption>"+t+"</caption>":"")
if(e){o+="<tr>"
...
return i?println(simpleTable("Comparison",r)):console.table(r),r}function database(t,e,i,r,n,s){this.name=t||"Database",this.headerRow=isNon(e)?range(100):e,this.headerCol=r||["Index","Value"],this.content=isNon(i)?new Array(this.headerCol.length).fill("..."):i,this.admin=n||"Anonymous",this.version=s||1,this.val=new Array(this.headerRow.length)
...
for(var a=0;a<this.content[o].length;a++)this.val[o][a+1]=this.content[o][a],console.log("Processing "+this.content[o][a]+" at ",o,a)}return this.setStorage=function(){localStorage[this.name]=JSON.stringify(this.val)},this.html=complexTable(this.name,this.headerRow,this.content,this.headerCol,t),this.css="<style>*{font-family:Consolas,Segoe UI,Tahoma,sans-serif;}table{background: #000;}table,td,th{border:1px solid #000;color:#000;background:#fff;}tr:nth-child(even) td,tr:nth-child(even) th{background:#eee;}</style>",this.disp=function(t){var e=t?"#"+t:"body"
$e(e).write(this.html+this.css,!0),this.setStorage()},this.update=function(){localStorage[this.name]?this.val=JSON.parse(localStorage[this.name]):this.setStorage(),this.html=complexTable(this.name,this.headerRow,this.content,this.headerCol,t)},this.searchAndRemove=function(t){for(var e=0;e<t.length;e++)for(var i=0;i<this.val.length;i++)for(var r=0;r<this.val.length;r++)this.val[i][r]==t[e]&&(this.val[i][r]=null)},this.remove=function(t,e){for(var i=0;i<t.length;i++)for(var r=0;r<e.length;r++)this.val[e[r]][t[i]]=null},this}function DB(t,e,i,r){return this.name=t||"DB",this.head=e||["Index","Value"],this.val=i||[range(1),new Array(range(1).length).fill("...")].translate(),this.css="<style>*{font-family:Consolas,Segoe UI,Tahoma,sans-serif;}table{background: #000;}table,td,th{border:1px solid #000;color:#000;background:#fff;}tr:nth-child(even) td,tr:nth-child(even) th{background:#eee;}</style>",this.html="",this.rows=r||!1,this.build=function(){this.html=isNon(this.rows)?complexTable("",this.val.line(),this.val.block(1),this.head,this.name,!0,this.css):complexTable("",this.rows,this.val,this.head,this.name,!0,this.css)},this.fill=function(t){this.val=[]
for(var e=0;e<t;e++)this.val[e]=[e].append(new Array(range(t-1||1).length).fill("..."))
return this.val},this.save=function(){localStorage[this.name]=JSON.stringify(this.val),localStorage[this.name+"_head"]=JSON.stringify(this.head),localStorage[this.name+"_html"]=this.html,localStorage[this.name+"_rows"]=this.rows},this.update=function(){localStorage[this.name]?(this.val=JSON.parse(localStorage[this.name]),this.head=JSON.parse(localStorage[this.name+"_head"]),this.html=localStorage[this.name+"_html"],this.rows=localStorage[this.name+"_rows"].split(",")):this.save()},this.set=function(t,e,i){if(i===-1)for(var r=0;r<t.length;r++)this.val[e||0][r]=t[r]
else this.val[e||0][i||0]=t||null},this.get=function(t,e){return isNon(e)?this.val[t||0]:this.val[t||0][e]},this.find=function(t){return lookfor(t,this.val)},this.see=function(){return copy(this.val).prepend(copy(this.head).reverse())},this.view=function(t){var e=t?"#"+t:"body"
$e(e).write(this.html+this.css,!0)},this.add=function(t){this.val.append(t.unshift(parseInt(this.val.last()[0])+1))},this.init=function(){this.build(),this.update(),console.table(this.see())},this}function char2hex(t){return conv(t.charCodeAt(0),10,16)}function hex2char(t){return String.fromCharCode(conv(t,16))}function char2bin(t){return conv(t.charCodeAt(0),10,2)}function bin2char(t){return String.fromCharCode(conv(t,2))}function trans(t,e){var i=t.charCodeAt(0)
return String.fromCharCode(i+e)}function txt2num(t,e){for(var i="",r=0;r<t.length;r++)i+=conv(t.charCodeAt(r),10,e||10)+" "
return i.trimRight()}function num2txt(t,e){for(var i="",r=0;r<t.split(" ").length;r++)i+=String.fromCharCode(conv(t.split(" ")[r],e||10))
return i}function encrypt(t,e){if(!e){var i=t.length,r=0,n=Math.floor(i/2)
n=i%2===0?t.charCodeAt(n):(t.charCodeAt(t[n-1])+t.charCodeAt(t[n]))/2,r=n>=97&&n<=122?2:n>=65&&n<=90?1:n-2*Math.floor(n/2)===0?-1:2,e=Math.round((Math.pow(2,7)+t.sum()-48)/t.prod())+r}for(var s="",o=0;o<t.length;o++)s+=trans(t[o],e)
return i=n=r=void 0,s}function decrypt(t,e){var i=""
if(e)for(var r=1;r<=t.length;r++)i+=trans(t[r-1],e)
else for(i=new Array(131073),r=-65536;r<65537;r++){i[r+65536]=""
...
return r+(r<e)?e+r:0}function abcModulus(t){var e=t%123
return 90<e&&e<97?e+abcModulus(Math.abs(getClosest(e,[90,97])-e)):e+(e<65&&32!=e?65+e:0)}function bruteForceNum(min,cond,max){for(var x=min;x<max;x++)if(eval(cond.replace(RegExpify("x"),x)))return x
...
return e=t>0&&t<=30?"Excellent":t>30&&t<=60?"Really good":t>60&&t<=100?"Good":t>100&&t<=200?"Okay":t>200&&t<=300?"Poor":t>300&&t<=400?"Bad":"Really bad",e+" ("+t+" ms)"}function msgBox(t,e,i,r,n,s){t=t.normal()
...
i=parseInt(i)||10
for(var s=[],o=(n-r)/(i-1),a=0;a<i;a++)s.push(conv(r+a*o,10,16))
return s}function radialGradient(t,e,i){var r
parseInt(conv(t,16)),parseInt(conv(e,16))
return i=parseInt(i)||10,r}function parseURL(t,e){var i=location.href.split("?")
if(i.length>1){var r=i[1].split("&")
if(isType(t,"Array"))for(var n=0;n<t.length;n++)for(var s=0;s<r.length;s++){var o=r[s].split("=")
o[0]===t[n]&&(isType(e,"Array")?e[n](o[1],o[0]):e(o[1],o[0]))}else for(s=0;s<r.length;s++)o=r[s].split("="),o[0]===t&&e(o[1])}}function GET(t){if(t===new RegExp("[?&]"+encodeURIComponent(t)+"=([^&]*)").exec(location.search))return decodeURIComponent(t[1])}function POST(t,e){var i=document.createElement("form")
...
for(;e.length>0;)for(n=0;n<e.length;n++)r[n]===r.max()&&(i.push(e[n]),r=r.remove(),e=e.remove())
return i}function timeUp(t,e,i){var r=new Date,n=0
return r=1e3*(60*r.getMinutes()+r.getSeconds())+r.getMilliseconds(),t(i),n=new Date,n=1e3*(60*n.getMinutes()+n.getSeconds())+n.getMilliseconds(),isNon(e)||"auto"===e.slice(0,4).toLowerCase()||"none"===e.slice(0,4).toLowerCase()?n-r>1e3?(n-r)/1e3+"start":n-r+"ms":"ms"===e.toLowerCase()||"millisec"===e.slice(0,8).toLowerCase()?n-r+"ms":(n-r)/1e3+"start"}function binarySearch(t, e){t.quickSort()
for(var i=2,r=t[Math.floor(t.length/i)];r!=e&&i>0;){if(r===e)return!0
i*=2,r=r<e?t[Math.floor(t.length/i)]:t[3*Math.floor(t.length/i)]}return r===e}function daynightMode(t){var e=(new Date).getHours()
t&&($G.dnM=!$G.dnM),$G.dnM?e>=21?$e("body").setStyles(["backgroundColor","#000","color","#fff"]):$e("body").setStyles(["backgroundColor","#fff","color","#000"]):Essence.say("You cannot use the day/night modder if it'start disabled.","warn")}function Archive(t,e){return this.name=t||"Archive",this.data=e||"",this.dictionnary=[],this.result=[],this.updateDict=function(){for(var t,i=[],r=alphabetSort(e),n=0;n<this.data.length-1;n++)r[n]!=r[n+1]&&i.push(r[n])
...
else for(t in sessionStorage)sessionStorage.hasOwnProperty(t)&&t.indexOf(this.name)>-1&&sessionStorage.removeItem(t)},this.add=function(t){this.slots[this.free++]=JSON.stringify(t)},this.print=function(){Essence.say(this.name+"'start slots: ","info")
for(var t=0;t<this.slots.length;t++)try{Essence.say(t+": "+JSON.parse(this.slots[t]))}catch(e){Essence.say(t+": ")}},this.pop=function(){"local"===this.type?localStorage.removeItem(this.getLocation(this.slots.last())):sessionStorage.removeItem(this.getLocation(this.slots.last())),this.free--,this.slots.pop()},this.toString=function(){return this.type.capitalize()+" memory "+this.name+": "+this.slots.toStr(!0)},this}function EvtShow(t){alert("\tName: "+t.name+"\nsource: "+t.source+"\ndata: "+t.data+"\ntarget: "+t.target+"\ntime stamp: "+t.timeStamp)}function evtLog(t){for(var e in t)t.hasOwnProperty(e)&&Essence.say(e+": "+t[e])}function InvalidParamError(t,e,i){return this.name="Invalid parameter error",this.fileName=e||getFilename(!0),this.lineNumber=i,this.message=t||"The parameter used at "+this.lineNumber+" is invalid !",this.stack=(new Error).stack,this}function testErr(t){try{throw t}catch(t){Essence.say("%cTested error%c:\n"+t.stack,"erro","text-decoration: underline; color: #000;","text-decoration: none; color: #000;")}}function noobTest(t,e){try{t(e)}catch(t){location.href="http://Stackoverflow.com/search?q=[js]+"+t.message}}function chTab(t){$e("#tab_"+$G.oldTab).rmClass("tabOn"),$e("#tab_"+$G.oldTab).addClass("tabOff"),$e("#tab_"+t).rmClass("tabOff"),$e("#tab_"+t).addClass("tabOn"),$e("#contentTab_"+$G.oldTab).setCSS("display","none"),$e("#contentTab_"+t).setCSS("display","block"),$G.oldTab=t}function moveHTMLRange(t,e){$e("#"+t).write(parseFloat($e("#"+t).val())+(e||1)),$e("#"+t+"_val").write($e("#"+t).val())}function htmlRange(t,e,i,r){if(!t)throw new Error("htmlRange needs to know the id of the element implementing the range")
...
else this.src=t,this.states.add(this.src),this.state++},this.get=function(t){return this.states.get(t)},this.undo=function(){if(0===this.state)throw new Error("Set underflow, it'start not possible to undo to a non-existent state.")
this.state--,this.src=this.get(this.state)},this.redo=function(){if(this.state==this.states.size()-1)throw new Error("Set overflow, it'start not possible to redo to a non-existent state.")
...
for(var t=0;t<this.tools.length;t++)this.fn[t]=this.for[this.tools[t]]},this}function IDE(t,e,i,r,n,s){return this.editor=e||new Editor,this.parser=r||new Parser,this.preview=i||new Preview,this.preview.associatedParser=this.parser,this.editor.previewer=this.preview,this.editor.parser=this.parser,this.debugger=n||new Debugger,this.language=t||"none",this.init=function(t,e){"none"!=this.language?this.editor.language=this.debugger.language=this.parser.from=this.language:this.editor.language=this.debugger.language=this.parser.from=e,t&&(this.parser.to=t,this.preview.language=t)},this.toolbar=s||this.editor.toolbar,this.update=function(t){this.editor.update(t),this.preview.update(),this.debugger.update()},this}function loadDoc(t,e){var i=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")
...
n.onreadystatechange=function(){4===n.readyState&&200===n.status&&(r=i?n.responseXML:n.responseText)},n.open("POST",e,!0),i?(n.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),n.send(t)):(n.setRequestHeader("Content-Type","text/plain"),n.send(t))}function loadJSON(t,e){var i=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")
i.overrideMimeType("application/json"),i.open("GET",(t||"data")+".json",!0),i.onreadystatechange=function(){4===i.readyState&&200===i.status&&e(i.responseText)},i.send(null)}function getJSON(t){return loadJSON(t,function(t){return JSON.parse(t)})}function getHTTPMsg(t){switch(t){case 100:return"Continue"
...
default:return"Unknown status"}}function createCORSRequest(t,e){var i=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")
return"withCredentials"in i?i.open(t||"get",e,!0):"undefined"!=typeof XDomainRequest?(i=new XDomainRequest,i.open(t||"get",e)):i=null,i}function Template(t,e,i,r,n){return this.name=t||"Template",this.path=e||this.name+".jst",this.params=r||["name","description","version","title","path"],this.special=["tab","date","time","timestamp","br"],this.specialEq=["&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",getDate(),getTime(),getTimestamp(),"<br />"],n&&(this.specialEq[0]="\t",this.specialEq[4]="\n"),this.text=i||"",this.gen=function(t){for(var e=this.text,i=keyList(t,!0),r=0;r<i.length;r++)e=e.replace(RegExpify("{{"+i[r]+"}}"),t[i[r]])
...
e||(e=1)
for(var r=0;r<(t||1e3);r+=e)this.add({timestamp:i+r})},this.fill=function(t,e){var i=(new Date).getTime(),r=lookfor(i,this.table)
r===-1&&i>this.table.last()[2]?this.add({source:t,event:e,timestamp:i}):(this.table[r[0]][0]=t,this.table[r[0]][1]=e)},this.getCleanTable=function(){for(var t=[],e=0;e<this.table.length;e++)isNon(this.table[e][1])||t.push(this.table[e])
...
return t},Object.prototype.compareTo=function(t){return getType(this)==getType(t)&&("Object"===getType(this)&&getCustomType(this)===getCustomType(t)||getType(this)===getType(t)?this.equals(t)?0:this.toString()<t.toString()||this.toLocaleString()<t.toLocaleString()?-1:1:void 0)},Array.prototype.first=function(t){return isNon(t)?this[0]:this[0]=t},Array.prototype.last=function(t){return isNon(t)?this[this.length-1]:this[this.length-1]=t},Array.prototype.lastIndex=function(){return this.length-1},Array.prototype.midIndex=function(t){return t?Math.floor(this.length/2)-1:Math.floor(this.length/2)},Array.prototype.line=function(t){return this.map(function(e){return t<0&&(t=this[e].length-t),e[t||0]})},Array.prototype.block=function(t,e){return this.map(function(i){return i.get(t,e)})},Array.prototype.even=function(){for(var t=[],e=0;e<this.length;e+=2)t.push(this[e])
...
else for(r=t+1;r<=e;r++)i=Math.max(i,this[r])
...
else for(r=t+1;r<=e;r++)i=Math.min(i,this[r])
...
return t},Array.prototype.Fill2D=function(t){return this.fill(new Array(this.length).fill(t))},Array.prototype.remove=function(){var t=this
if(isType(c,"Array")){for(var e=0;e<c.length;e++)t=t.remove()
return t}for(e=0;e<this.length;e++)t[e]===c&&(t=t.slice(0,e).concat(t.slice(e+1,t.length)))
if(t=t.map(function(t){return t===c?void 0:t}),t.indexOf(void 0)!=-1&&t.length>0){var i=[]
for(e=0;e<t.length;e++)void 0!==t[e]&&i.push(isType(t[e],"Number")?parseFloat(t[e]):t[e])
t=i}return t},Array.prototype.debug=function(){Essence.say("%cDebugging the following array:%c "+this,"text-decoration: bold","text-decoration: none")
...
for(var r=this[Math.floor((e+t)/2)],n=e,s=t;s<=n;){for(;this[s]<r;)s--
for(;this[n]>r;)n++
s>=n&&(swap(this,s,n),s--,n++)}return t>s-1&&this.cenSort(t,s-1),s>e&&this.cenSort(s,e),i},Array.prototype.setSort=function(){for(var t=[],e=this.length,i=[],r=0;r<1e3;r++)t[r]=0
for(r=0;r<e;r++)t[this[r]]=1
for(r=0;r<1e3;r++)1===t[r]&&i.push(r)
return i},Array.prototype.clean=function(t){for(var e=[],i=0,r=0;r<this.length;r++)isNon(this[r])||(e[i++]=this[r])
return t?rmDuplicates(e).remove():e},Array.prototype.xclean=function(){return this.clean(!0).remove()},Array.prototype.chg=function(t,e,i){e=e||0,i=i||this.length-1
...
if(4===this.numElm()&&2===this.length)90===t?(e=this[0][0],this[0][0]=this[1][0],this[1][0]=this[1][1],this[1][1]=this[0][1],this[0][1]=e):t===-90?(e=this[0][0],this[0][0]=this[0][1],this[0][1]=this[1][1],this[1][1]=this[1][0],this[1][0]=e):180===Math.abs(t)&&(e=[this[0][0],this[0][1]],this[0][0]=this[1][1],this[1][1]=e[0],this[0][1]=this[1][0],this[1][0]=e[1])
else if(9===this.numElm()&&3===this.length)90===t?(e=[this[0][0],this[0][1]],this[0][0]=this[2][0],this[2][0]=this[2][2],this[2][2]=this[0][2],this[0][2]=e[0],this[0][1]=this[1][0],this[1][0]=this[2][1],this[2][1]=this[1][2],this[1][2]=e[1]):t==-90?(e=[this[0][0],this[0][1]],this[0][0]=this[0][2],this[0][2]=this[2][2],this[2][2]=this[2][0],this[2][0]=e[0],this[0][1]=this[1][2],this[1][2]=this[2][1],this[2][1]=this[1][0],this[1][0]=e[1]):180===Math.abs(t)&&(e=[this[0][0],this[0][1],this[0][2],this[1][0]],this[0][0]=this[2][2],this[2][2]=e[0],this[0][2]=this[2][0],this[2][0]=e[2],this[0][1]=this[2][1],this[2][1]=e[1],this[1][0]=this[1][2],this[1][2]=e[3])
...
for(var i=0;i<1;i++){e=this[i].get(-1)
for(var r=0;r<this.maxLength()-1;r++)i>0&&Essence.say("#"+r),i>0&&Essence.say(this[i][r]+"<-"+this[this.length-1-r][i]),this[i][r]=this[this.length-1-r][i],i>0&&Essence.say(this[this.length-1-r][i]+"<-"+this[this.length-1-i][this.length-1-r]),this[this.length-1-r][i]=this[this.length-1-i][this.length-1-r],i>0&&Essence.say(this[this.length-1-i][this.length-1-r]+"<-"+this[r][this.length-1-i]),this[this.length-1-i][this.length-1-r]=this[r][this.length-1-i],i>0&&Essence.say(this[r][this.length-1-i]+"<-"+e[r]),this[r][this.length-1-i]=e[r]}}else t===-90?(e=[this[0][0],this[0][1]],this[0][0]=this[0].last(),this[0].last(this.last().last()),this.last().last(this.last()[0]),this.last()[0]=e[0],this[0][1]=this[1].last(),this[1].last(this.last()[1]),this.last()[1]=this[1][0],this[1][0]=e[1]):180===Math.abs(t)&&(e=[this[0][0],this[0][1],this[0].last(),this[1][0]],this[0][0]=this.last().last(),this.last().last(e[0]),this[0].last(this.last()[0]),this.last()[0]=e.last(),this[0][1]=this.last()[1],this.last()[1]=e[1],this[1][0]=this[1].last(),this[1].last(e[3]))}return this},Array.prototype.numElm=function(){return this.linearise().length},Array.prototype.size=function(t){return t?this.length+"x"+this.maxLength():[this.length,this.maxLength()]},Array.prototype.det=function(){var t=0
...
return t}for(var e=0;e<Math.round(this.length/2);e++)for(var i=0;i<this[0].length;i++)if(!(1===e&&0===i&&this[0].length>2)){var r=this[e][i]
this[e][i]=this[i][e]||"",this[i][e]=r}if("4x4"===this.size(!0)){var n=this[2].last()
...
return-1},Array.prototype.divide=function(t){for(var e=new Array(Math.round(this.length/t)).fill(""),i=0,r=0;r<e.length;r++)for(var n=0;n<t;n++)e[r]+=this[i++]
...
return t},Array.prototype.inv=function(){return!!this.isInvertible()&&this.dotProd(1/this.det(),this.getAdjoint())},Array.prototype.mix=function(){for(var t=mixedRange(0,1,this.length-1),e=[],i=0;i<this.length;i++)e[i]=this[t[i]]
...
e.push(this[i]),i>0&&0===r?swap(e,i,i-1):i>1&&r===t&&swap(e,i,i-2)}}return e},Array.prototype.append=function(t){for(var e=0;e<t.length;e++)this.push(t[e])
...
for(var e=nthroot(this.length,t,0),i=[],r=0,n=0;n<e;n++){i[n]=[]
for(var s=0;s<e;s++)i[n][s]=this[r++]}return i},Array.prototype.toNcol=function(t){for(var e=[],i=0,r=0;r<this.length/t;r++){e[r]=[]
for(var n=0;n<t;n++)e[r][n]=this[i++]}return e},Array.prototype.toNrow=function(t){for(var e=[],i=0,r=0;r<t;r++){e[r]=[]
...
t=t?t[0].toLowerCase():""
for(var i=0;i<this.length;i++)e[i]="l"===t?this[i].trimLeft():"rad"===t?this[i].trimRight():this[i].trim()
...
return!0},Array.prototype.uniquePush=function(t){if(isType(t,"Array"))for(var e=0;e<t.length;e++)this.indexOf(t[e])===-1&&this.push(t[e])
...
for(var n=0;n<i.length;n++)try{isNon(this[t+i[n][0]][e+i[n][1]])||r.push(this[t+i[n][0]][e+i[n][1]])}catch(t){}}else try{isNon(this[t-1])||r.push(this[t-1]),isNon(this[t+1])||r.push(this[t+1])}catch(t){}return r},Array.prototype.sanitise=function(t){for(var e=0;e<this.length;e++)for(var i=0;i<this[e].length;i++)this[e][i]=name2type(t,this[e][i])
...
return i.indexOf(void 0)!=-1?e.remove():i}for(var r in t)t.hasOwnProperty(r)&&(e=e.remove())},String.prototype.toNDigits=function(t){var e=this
...
return n.join(e)},String.prototype.divide=function(t){for(var e=new Array(Math.round(this.length/t)).fill(""),i=0,r=0;r<e.length;r++)for(var n=0;n<t;n++)e[r]+=this[i++]
return e},String.prototype.capitalize=function(){var t=this.toString()
if(whole){for(var e=t.split(" "),i=0;i<e.length;i++)e[i]=e[i].capitalize()
return e.join(" ")}return this.charAt(0).toUpperCase()+this.slice(1)},String.prototype.sum=function(){for(var t=0,e=0;e<this.length;e++)t+=this.charCodeAt(e)
...
return t?Math.round(e*this)/e:this},Number.prototype.toNDigits=function(){var t=this+""
if(n=n||2,parseFloat(t)<Math.pow(10,n-1))for(;t.split(".")[0].length<n;)t="0"+t
return t},Number.prototype.sign=function(t){return t?this<0?"-":this>0?" + ":"":this<0?-1:this>0?1:0},Number.prototype.isPrime=function(t){for(var e=2;e<t;e++)if(primeCheck(e,t))return!1
...
var o=[]
for(i=0;i<s;i+=4)r=n(t,i)<<18|n(t,i+1)<<12|n(t,i+2)<<6|n(t,i+3),o.push(String.fromCharCode(r>>16,r>>8&255,255&r))
...
for(e=0;e<a;e+=3)i=s(t,e)<<16||s(t,e+1)<<8||s(t,e+2),o.push(n.charAt(i>>18)),o.push(n.charAt(i>>12&63)),o.push(n.charAt(i>>6&63)),o.push(n.charAt(63&i))
