...
return t+="]","Polygon(points = "+t+", velocity = "+this.vel.toString()+", border = "+this.border+")"},this.hit=function(t,e){return"l"===e?t.offset("l")<=this.offset("r"):"r"===e?t.offset("r")>=this.offset("l"):"u"===e?t.offset("u")<=this.offset("d"):"d"===e?t.offset("d")>=this.offset("u"):this.hit(t,"l")||this.hit(t,"r")||this.hit(t,"u")||this.hit(t,"d")},this.copy=function(){return new Polygon(this.points,this.b,this.vel)},this.draw=function(){},this}function simpleTable(t,e,i,r,n,s){for(var o=t?"<table id="+i+" style="+r+" cellspacing=0 cellpadding=2><caption>"+t+"</caption>":"<table>",a=0;a<e.length;a++){if(o+="<tr>",n)for(var h=0;h<e[a].length;h++)o+="<td id='"+(isNon(s)?a+"_"+h:s[a][h])+"'>"+e[a][h]+"</td>"
else o+="<td id='"+(isNon(s)?a:s[a])+"'>"+e[a]+"</td>"
o+="</tr>"}return o+="</table><style>table{background: #000;}table, td {border: 1px solid #000; color: #000; background: #fff;} tr:nth-child(even) td{background: #ddd;} tr td:hover{background: #bbb;}</style>"}function rowTable(t,e,i,r,n,s,o){for(var a=t?"<table id="+r+" style="+s+" cellspacing=0 cellpadding=2><caption>"+t+"</caption>":"<table>",h=0;h<i.length;h++){if(a+=e?"<tr><th>"+e[h]+"</th>":"<tr>",n)for(var l=0;l<i[h].length;l++)a+="<td id='"+(isNon(o)?h+"_"+l:o[h][l])+"'>"+i[h][l]+"</td>"
else a+="<td id='"+(isNon(o)?h:o[h])+"'>"+i[h]+"</td>"
a+="</tr>"}return a+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td, tr:nth-child(even) th{background: #ddd;}tr td:hover, tr th:hover{background: #bbb;}</style>"}function colTable(t,e,i,r,n,s,o){var a=t?"<table id="+r+" style="+s+" cellspacing=0 cellpadding=2><caption>"+t+"</caption>":"<table>"
if(e){a+="<tr>"
for(var h=0;h<e.length;h++)a+="<th>"+e[h]+"</th>"
a+="</tr>"}for(h=0;h<i.length;h++){if(a+="<tr>",n)for(var l=0;l<i[h].length;l++)a+="<td id='"+(isNon(o)?h+"_"+l:o[h][l])+"'>"+i[l][h]+"</td>"
else a+="<td id='"+(isNon(o)?h:o[h])+"'>"+i[h]+"</td>"
a+="</tr>"}return a+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td{background: #ddd;}tr td:hover{background: #bbb;}"}function complexTable(t,e,i,r,n,s,o,a){isNon(o)&&(o="")
...
h+="</tr>"}return h+="</table><style>table{background: #000;}table, td, th{border: 1px solid #000; color: #000; background: #fff;}tr:nth-child(even) td{background: #ddd;}tr td:hover{background: #bbb;}</style>"}function colourTable(t,e,i,r,n,s){var o=t?"<table id="+r+" style="+s+" cellspacing=0 cellpadding=2><caption>"+t+"</caption>":"<table>"
if(e){o+="<tr>"
...
this[2].last(this.last()[2]),this.last()[2]=n}return this},Array.prototype.lookFor=function(t){for(var e=0;e<this.length;e++)if(this[e]===t)return e
