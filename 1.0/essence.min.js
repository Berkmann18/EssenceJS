...
Essence.say("current exp: "+cexp,"info"),res.push(eval(cexp))}return[vars,rows,res]}function getDNF(t){truthTable(t)}function getCNF(t){truthTable(t)}function EventTable(t,e){return this.name=t||"Event table",this.sources=e||[getFilename(!0)],this.table=[["Source","Event","Timestamp"]],this.add=function(t){this.table.push([t.source||getFilename(!0),t.event,t.timestamp||(new Date).getTime()]),this.sources.uniquePush(t.source||getFilename(!0))},this.make=function(t,e){var i=(new Date).getTime()
e||(e=1)
