...
return t},this.equals=function(t){return this.toString()===t.toString()},this.remove=function(t){for(var e=this.front;null!=e;)null==e.payload||e.payload!=t&&!e.payload.equals(t)||(e=null),e=e.next},this.insertAt=function(t,e){this.back.next=new Node(e),0===t?this.front=new Node(e):t===this.len?this.back=new Node(e):t>this.len&&this.enqueue(e)}}function Astar(t,e){for(var i,r,s,n=e,o=t,a=[o],l=[];a.length>0;){var c=[],u=a[0].f
for(var d in a)a.hasOwnProperty(d)&&(c.push(a[d].f),u=Math.min(u,a[d].f))
if(i=a.filter(function(t){return t.f===u?t:void 0})[0],a=a.filter(function(t){return t.f!=u?t:void 0}),i===n){for(r in i)if(i.hasOwnProperty(nodeSuccessor)){nodeSuccessor.f=i.f+h(nodeSuccessor,i)
var f=lookfor(nodeSuccessor,a)
if(-1!=f){if(f=f[0],i.f<a[f]||-1!=lookfor(nodeSuccessor,l)&&i.f<a[lookfor(nodeSuccessor,l)][0])continue
a=a.remove(nodeSuccessor),l=l.remove(nodeSuccessor),nodeSuccessor.parent=i,s=h(nodeSuccessor,n),a.push(nodeSuccessor)}l.push(i)}throw"Solution found !"}}}function A(t,e,i){for(var r=[],s=[t],n=[],o=[0],a=[euclidianDist(t,e)];s.length>0;){var h=s[a.indexOf(a.min())]
if(h===e)return reconPath(n,h,i)
s=s.remove(h),r.push(h)
for(var l=i.neighbours(h),c=0;l>c;c++)if(!(r.indexOf(l[c])>-1)){var u=o[r.indexOf(h)]+1
if(-1===r.indexOf(l[c]))s.push(l[c])
else if(u>=o[c])continue}n[c]=h,o[c]=u,a[c]=o[c]+euclidianDist(l[c],e)}return!1}function reconPath(t,e,i){for(var r=[e];e in keyList(t);)e=t[i.lookFor(e)],r.append(e)
...
return i},Array.prototype.neighbour=function(t,e){if(is2dArray(this)){var i=[]
try{this[t-1][e]&&i.push(this[t-1][e]),this[t+1][e]&&i.push(this[t+1][e]),this[t][e-1]&&i.push(this[t][e-1]),this[t][e+1]&&i.push(this[t][e+1]),this[t-1][e-1]&&i.push(this[t-1][e-1]),this[t+1][e-1]&&i.push(this[t+1][e-1]),this[t-1][e+1]&&i.push(this[t-1][e+1]),this[t+1][e+1]&&i.push(this[t+1][e+1])}catch(r){}}else try{this[t-1]&&i.push(this[t-1]),this[t+1]&&i.push(this[t+1])}catch(r){}return i},String.prototype.remove=function(t){var e=this
