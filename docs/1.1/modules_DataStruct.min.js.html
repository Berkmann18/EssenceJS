...
return t.next=this,t.prev=null,this.prev=t,this.next=null,t},this.toString=function(){return"Node(payload = "+this.payload+", previous = "+this.prev+", next = "+this.next+")"},this.equals=function(t){return this.payload===t.payload&amp;&amp;this.next.equals(t.next)&amp;&amp;this.prev.equals(t.prev)},this.find=function(t,i){return i||(i=0),this.payload===t?i:this.next?this.next.find(t,i+1):[-1,i]},this}function PathNode(t,i){return this.f=t+i||1,this.parent=null,this.back=function(t){return isNon(t)||t&lt;=1?this.parent:this.parent.back(t-1)},this.isCloser=function(t){return this.f&lt;=t.f},this.toString=function(){return"PathNode(f="+this.f+", parent="+this.parent.toString()+")"},this}function NTreeNode(t,i){return this.payload=t||0,this.child=i||[],this.add=function(t){this.child.push(t)},this.remove=function(t){this.child.remove()},this.traverse=function(){for(var t in this.child)this.child.hasOwnProperty(t)&amp;&amp;t.traverse()
...
s=s.remove(),a=a.remove(),f.parent=r,n=h(f,e),s.push(f)}a.push(r)}throw"Solution found ! With h="+n}}}function A(t,i,r){for(var n=[],e=[t],s=[],h=[0],a=[euclidianDist(t,i)];e.length>0;){var o=e[a.indexOf(a.min())]
if(o===i)return reconPath(s,o,r)
e=e.remove(),n.push(o)
var u=r.neighbour(o[0],o[1])
Essence.say("neighbour of "+o+":\n"+u.toStr(!0),"info")
for(var l=0;l&lt;u;l++)if(!n.has(u[l])){var f=h[n.indexOf(o)]+1
if(n.indexOf(u[l])===-1)e.push(u[l])
else if(f>=h[l])break}s[l]=o,h[l]=f,a[l]=h[l]+euclidianDist(u[l],i)}}function reconPath(t,i,r){for(var n=[i];i in keyList(t);)i=t[r.lookFor(i)],n.append(i)
