...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: modules/Web.min.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: modules/Web.min.js</h1>
...
o[0]===t[n]&amp;&amp;(isType(e,"Array")?e[n](o[1],o[0]):e(o[1],o[0]))}else for(a=0;a&lt;s.length;a++)o=s[a].split("="),o[0]===t&amp;&amp;e(o[1])}}function WebPage(t,e,i,s,n,a,o,h){return this.title=t||"My web page",this.subtitle=h||"A simple web page",this.type=o.normal()||"html",this.name=e+this.type||"index."+this.type,this.path=i+"/"+this.name||this.name,this.author=s||"Maximilian Berkmann",this.version=n||1,this.structure=a||"header!h-menu!content|aside!footer",this.code="",this.template="",this.page=null,this.word2code=function(t){switch(t.normal()){case"header":return"&lt;header>&lt;img src='img/icon.png' />&lt;hgroup>&lt;h1>{{title}}&lt;/h1>&lt;h3>{{subtitle}}&lt;/h3>&lt;/hgroup>&lt;/header>"
