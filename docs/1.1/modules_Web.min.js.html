...
if(isType(t,"Array"))for(var n=0;n&lt;t.length;n++)for(var a=0;a&lt;s.length;a++){var h=s[a].split("=")
h[0]===t[n]&amp;&amp;(isType(e,"Array")?e[n](h[1],h[0]):e(h[1],h[0]))}else for(a=0;a&lt;s.length;a++)h=s[a].split("="),h[0]===t&amp;&amp;e(h[1])}}function WebPage(t,e,i,s,n,a,h,o){return this.title=t||"My web page",this.subtitle=o||"A simple web page",this.type=h.normal()||"html",this.name=e+this.type||"index."+this.type,this.path=i+"/"+this.name||this.name,this.author=s||"Maximilian Berkmann",this.version=n||1,this.structure=a||"header!h-menu!content|aside!footer",this.code="",this.template="",this.page=null,this.word2code=function(t){switch(t.normal()){case"header":return"&lt;header>&lt;img src='img/icon.png' />&lt;hgroup>&lt;h1>{{title}}&lt;/h1>&lt;h3>{{subtitle}}&lt;/h3>&lt;/hgroup>&lt;/header>"
