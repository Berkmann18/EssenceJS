...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: modules/QTest.min.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: modules/QTest.min.js</h1>
 ...
 * @exports File
 */
function EvtShow(t){alert("\tName: "+t.name+"\nsource: "+t.source+"\ndata: "+t.data+"\ntarget: "+t.target+"\ntime stamp: "+t.timeStamp)}function evtLog(t){for(var o in t)t.hasOwnProperty(o)&amp;&amp;Essence.say(o+": "+t[o])}function InvalidParamError(t,o,e){var r=Error.call(this,t||"The parameter is invalid !")
this.name="CustomError",this.message=r.message,this.stack=r.stack,this.fileName=o||location.href,this.lineNumber=e||getLineNum()}function getTrace(){var t=function(){try{throw Error("")}catch(t){return t}},o=stripPath(t().stack.split("\n").last())
...
InvalidParamError.inheritsFrom(Error),InvalidParamError.prototype=Object.create(Error.prototype),InvalidParamError.prototype.constructor=InvalidParamError
var UnitTest={total:0,bad:0,failRate:0,coverage:0,test:function(t,o,e,r){this.total++
var c=t
c.equals(o)?r&amp;&amp;c.equals(o)&amp;&amp;console.log("%c[Unit]%c The expectation on "+o+" was satisfied !","color: #c0c","color: #000"):(this.bad++,console.log("%c[Unit]%c "+(e||"Test #b"+this.bad)+': Expected "%c'+o+'%c" but was "%c'+c+'%c"',"color: #c0c","color: #000","color: #0f0","color: #000","color: #f00","color: #000"))},testFalse:function(t,o,e,r){this.total++
var c=t
c.equals(o)?(this.bad++,console.log("%c[Unit]%c "+(e||"Test #b"+this.bad)+": Didn't expected \"%c"+o+'%c" to be "%c'+c+'%c"',"color: #c0c","color: #000","color: #0f0","color: #000","color: #f00","color: #000")):r&amp;&amp;c.equals(o)&amp;&amp;console.log("%c[Unit]%c The anti-expectation on "+o+" was satisfied !","color: #c0c","color: #000")},reset:function(){this.total=0,this.bad=0,this.failRate=0,this.coverage=0},multiTest:function(t,o){this.reset(),console.time("Unit test")
for(var e=0;e&lt;t.length-1;e++)this.test(t[e][0],t[e][1],3===t[e].length?t[e][2]:"",o)
console.timeEnd("Unit test"),this.report()},report:function(){this.failRate=markConv(this.bad,this.total),console.info("%c[Unit]%c Pass/Fail: %c"+(this.total-this.bad)+"%c/%c"+this.bad+"%c ("+this.failRate+"% fail); on "+BrowserDetect.info()+" at "+getLineNum(),"color: #c0c","color: #000","color: #0f0","color: #000","color: #f00","color: #000")},basicTests:function(){this.reset(),this.multiTest([[eval(3),3],["Hello World".split(" "),[["H","e","l","l","o"].join(""),["W","o","r","l","d"].join("")]],[nthroot(5,2,4),Math.pow(5,.5).toNDec(4)]])},libTests:[]}
</code></pre>
        </article>
    </section>
