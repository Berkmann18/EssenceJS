...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: modules/Misc.min.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: modules/Misc.min.js</h1>
...
this.db.set(e,s[0],s[1]+(isType(t,"Number")?2:1)),r&amp;&amp;this.db.set(r,s[0],s[1]),this.rules=this.db.val},this.addRule=function(t,e){this.db.add([t,e]),this.rules=this.db.val},this.removeRule=function(t){this.db.remove(),this.rules=this.db.val},this.update=function(){this.db.update(),this.db.build(),this.rules=this.db.val},this.save=function(){this.db.save(),this.rules=this.db.val},this.findRule=function(t){return this.db.find(t)},this.verify=function(rule,val){var pos=this.findRule(rule)
