...
return eval(this.rules[pos[0]][pos[1]+1].replace("x",val))},this}var Misc=new Module("Misc","Miscellaneous",["Files"]),base64={PADCHAR:"=",ALPHA:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",getbyte64:function(t,e){if(e=base64.ALPHA.indexOf(t.charAt(e||0)),-1===e)throw"Cannot decode base64"
