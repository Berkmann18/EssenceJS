...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: UI.min.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: UI.min.js</h1>
...
for(var s=0;s&lt;r.length;s++)n&amp;&amp;!isDark(r[s].css("backgroundColor"))&amp;&amp;r[s].invColour()}else Essence.say("You cannot use the day/night mod if it's disabled.","warn")}function chTab(e){$e("#tab_"+$G.oldTab).rmClass("tabOn"),$e("#tab_"+$G.oldTab).addClass("tabOff"),$e("#tab_"+e).rmClass("tabOff"),$e("#tab_"+e).addClass("tabOn"),$e("#contentTab_"+$G.oldTab).setCSS("display","none"),$e("#contentTab_"+e).setCSS("display","block"),$G.oldTab=e}function moveHTMLRange(e,t){$e("#"+e).write(parseFloat($e("#"+e).val())+(t||1)),$e("#"+e+"_val").write($e("#"+e).val())}function htmlRange(e,t,i,r){if(!e)throw new Error("htmlRange needs to know the id of the element implementing the range")
...
for(var t in e)if(e.hasOwnProperty(t)){var i=document.all?t.rules:t.cssRules
console.log("\tRules of %s:\n%s",t,i)}}function addCSSRule(e,t,i,r){e||(e=document.styleSheets[0])
var n=document.all?e.rules:e.cssRules
r||(r=n.length-1)
for(var s=r;s>0;s--)n[s].selectorText===t&amp;&amp;(i=n[s].style.cssText+i,e.deleteRule(s),r=s)
return"insertRule"in e?e.insertRule(t+"{"+i+"}",r):"addRule"in e&amp;&amp;e.addRule(t,i,r),n[r].cssText}function clearCSSRules(e){e||(e=document.styleSheets[0])
for(var t=(document.all?e.rules:e.cssRules).length-1;t>=0;)"deleteRule"in e?e.deleteRule(t):"removeRule"in e&amp;&amp;e.removeRule(t),t--}var UI=new Module("UI","UI stuff",["Maths","DOM"])
...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Modules</h3><ul><li><a href="module-UI.html">UI</a></li></ul>
</nav>

<br class="clear">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.3</a> on Sat Dec 24 2016 14:14:29 GMT+0000 (GMT)
</footer>
