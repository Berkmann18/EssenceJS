...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: Misc.min.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: Misc.min.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>function asciiTable(t,e){"A-Z"!==t||e?"a-z"!==t||e?"A-z"!==t||e?"printable"!==t||e||(t=32,e=126):(t=65,e=122):(t=97,e=122):(t=65,e=90),t||(t=0),e||(e=255)
...
return t.substring(0,t.length-2)+")"},this.genID=function(){return(this.lastName.get(0,3)+this.birthday.split("/")[1]+this.firstName.get(0,1)+this.secondName.get(0,1)+this.birthday.split("/")[2]+this.sex[0]).toUpperCase()},this.getAge=function(){return(date2num(getDate())-date2num(this.birthday)).toNDec(2)},this.isMajor=function(){return("UN"===this.country.get(0,1)||"united states"===this.country.toLowerCase())&amp;&amp;this.getAge()>20||("UN"!=this.country.get(0,1)||"united states"!=this.country.toLowerCase())&amp;&amp;this.getAge()>17},this.getFullName=function(){return this.firstName+" "+this.secondName+(""!=this.nickname?' "'+this.nickname+'" ':" ")+this.lastName},this}function Item(t,e,r,s,i){return this.name=t||"unknown",this.category=e||"unknown",this.price=r||0,this.ageMinRequired=s||.25,this.quantity=i||1,this.firstMade=(new Date).toLocaleString(),this.duplicate=function(t,e){for(var r=0;r&lt;t;r++)e.push(new Item(this.name,this.category,this.price,this.ageMinRequired,this.quantity))},this.remove=function(t){isType(t,"Array")?t=t.remove():t.remove()},this.toString=function(){var t=""
for(var e in this)this.hasOwnProperty(e)&amp;&amp;"toString"!=e&amp;&amp;!isType(e,"Function")&amp;&amp;(t+=e+"="+this[e]+", ")
return t.substring(0,t.length-2)},this}function letterArray(t,e){for(var r=t.charCodeAt(0)||97,s=e.charCodeAt(0)||122,i=[],n="",a=r;a&lt;=s;a++)for(var o=r;o&lt;=s;o++)a!=o&amp;&amp;(n=String.fromCharCode(a)+String.fromCharCode(o),i.push(n))
...
return Essence.say(r),JSON.parse(e)},this.unparse=function(t,e){for(var r=JSON.stringify(t),s="",i=[],n=0;n&lt;r.length;n++)i[n]=r.charCodeAt(n),s+=2===this.base?conv(r.charCodeAt(n).toNDigits(),10,this.base):conv(r.charCodeAt(n),10,this.base)
...
return n?c():(a.map(function(r){h.push(setTimeout(function(){console.clear(),console.log(t+" "+r)},e+o*s)),o++}),e+=2*s,e&lt;=r||!n?void setTimeout(function(){anim(t,e,r,s,i,e>r)},2*s):c())}function AI(rules){return this.rules=rules||[[0,"",null]],this.db=new DB("AI rules",["Index","Rules","Precision"],this.rules),this.db.init(),this.updateRule=function(t,e,r){var s=this.db.find(t)
...
return eval(this.rules[pos[0]][pos[1]+1].replace("x",val))},this}function clearEnv(){$e("body").write(""),console.clear()}var Misc=new Module("Misc","Miscellaneous",["Files","DataStruct","Ajax"]),base64={PADCHAR:"=",ALPHA:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",getbyte64:function(t,e){if(e=base64.ALPHA.indexOf(t.charAt(e||0)),e===-1)throw"Cannot decode base64"
...
var n=[]
for(r=0;r&lt;i;r+=4)s=this.getbyte64(t,r)&lt;&lt;18|this.getbyte64(t,r+1)&lt;&lt;12|this.getbyte64(t,r+2)&lt;&lt;6|this.getbyte64(t,r+3),n.push(String.fromCharCode(s>>16,s>>8&amp;255,255&amp;s))
...
for(e=0;e&lt;i;e+=3)r=this.getbyte(t,e)&lt;&lt;16||this.getbyte(t,e+1)&lt;&lt;8||this.getbyte(t,e+2),s.push(this.ALPHA.charAt(r>>18)),s.push(this.ALPHA.charAt(r>>12&amp;63)),s.push(this.ALPHA.charAt(r>>6&amp;63)),s.push(this.ALPHA.charAt(63&amp;r))
...
e&lt;1e3&amp;&amp;(e+=1900)
var i=this.getMonthName(r),n=this.getDays(r,e),a=new Date(e,r,1),o=a.getDay()
null===this.element&amp;&amp;(print("&lt;div id='calendar'>&lt;/div>",!0),this.element=$e("#calendar")),this.draw(o+1,n,s,i,e)},draw:function(t,e,r,s,i){var n="&lt;table cellspacing=4>&lt;th colspan=7>"+s+" "+i+"&lt;/th>",a=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],o=1,h=1
n+="&lt;tr align='center' valign='center'>"
for(var c=0;c&lt;7;c++)n+="&lt;td>"+a[c]+"&lt;/td>"
n+="&lt;/tr>"
for(var u=1;u&lt;=Math.ceil((t+t-1)/7);u++){n+="&lt;tr align='right' valign='top'>"
for(var l=1;l&lt;=7;l++)h&lt;t?(n+="&lt;td>&lt;/td>",h++):(n+=o===r?"&lt;td>&lt;span style='color: red'>"+o+"&lt;/span>&lt;/td>":"&lt;td>"+o+"&lt;/td>",o++)
n+="&lt;/tr>"}n+="&lt;/table>",this.element.write(n,!0)}}
</code></pre>
        </article>
    </section>
...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Modules</h3><ul><li><a href="module-Misc.html">Misc</a></li></ul>
</nav>

<br class="clear">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.3</a> on Sun Dec 25 2016 14:02:27 GMT+0000 (GMT)
</footer>
