"use strict"
function require(t,e,r){if(isType(t,"Array"))for(var i=0;i<t.length;i++)require(t[i],e)
...
else if(modules.indexOf(t)>-1){var i=function(){try{debugging&&Essence.say("Running "+t+"    "+getTimestamp(!0),"info"),init(window[t].dependency,!1,function(e){debugging&&Essence.say("%c"+e+"%c from %c"+t+"%c's dependency has been initiated !!    "+getTimestamp(!0),"info","color: #c0f","color: #000","color: #f0c","color: #000")},e),window[t].run()}catch(r){Essence.time("The module %c"+t+"%c have problems regarding it's run method.","warn","color: #c0f","color: #000")}},o=function(e){e||(e=0),Essence.say("The module %c"+t+"%c isn't available !    "+getTimestamp(!0),"erro","color: #c0f","color: #000"),debugging&&Essence.say("Retrying to run %c"+t+"%c    "+getTimestamp(!0),"info","color: #c0f","color: #000"),window[t]?i():2>=e?setTimeout(o(e+1),2):Essence.say("It's not possible to run %c"+t+"%c :( !    "+getTimestamp(!0)+"\nModule: "+window[t],"info","color: #c0f","color: #000")}
window[t]?i():o()}else Essence.say("The module %c"+t+"%c isn't in the list !!    "+getTimestamp(!0),"erro","color: #c0f","color: #000")}function init(t,e,r,i,o,n){if(isType(t,"Array"))for(var s=0;s<t.length;s++)init(t[s],e,r,i,t[s],t[s])
else debugging&&Essence.say("Initiating "+t),-1===modules.indexOf(t)?require(t,i):debugging&&Essence.say("The module %c"+t+"%c was already initiated !!","info","color: #c0f","color: #000"),e&&e(o||t),setTimeout(function(){run(t),r&&r(n||t)},2)}function $e(t){return new Element(t)}function $n(t){return $e(t).node}function Element(t){if(/^([#\.\*_-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as it's invalid.")
...
return r&&(keyList(i,!0).indexOf(r+t)>-1||valList(i,!0).indexOf(r+t)>-1)?!1:keyList(i,!0).indexOf(t)>-1||valList(i,!0).indexOf(t)>-1?!1:void include(t,e)}function exclude(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
var r=document.createElement(e)
...
return t?r.getDate().toNDigits()+e[r.getMonth()]+r.getUTCFullYear():r.getDate().toNDigits()+"/"+(r.getMonth()+1).toNDigits()+"/"+r.getUTCFullYear()}function getTimestamp(t){return t?getDate()+" "+getTime(!0):getDate(!0)+"-"+getTime().replace(/\:/g,"-")}function dateTime(t){var e,r,i=new Date,o=i.getFullYear(),n=i.getMonth(),s=["January","February","March","April","May","June","July","August","September","October","November","December"],h=i.getDate(),a=i.getDay(),l=i.getHours(),c=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saterday"],u="",d=i.getTimezoneOffset()
10>l&&(l="0"+l),e=i.getMinutes(),l>12?(l-=12,u="PM"):u="AM",10>e&&(e="0"+e),r=i.getSeconds(),10>r&&(r="0"+r),d=d>=0?"GMT + "+d:"GMT-"+d
var f="We're "+c[a]+" "+h+" "+s[n]+" "+o+" and it's "+l+":"+e+":"+r+" "+u+" "+d
$e("#"+t).write(f,!0),setTimeout('dateTime("'+t+'");',1e3)}function weekDay(t){var e,r=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],i=parseInt(t.split("/")[0]),o=parseInt(t.split("/")[1]),n=parseInt(t.split("/").last())
return e=Math.floor(n/100),n%=100,r[Math.round((1+2.6*o-.2+i+n+n/4+e/4-2*e)%7)-1]}function dayOfWeek(t){var e,r=parseInt(t.split("/")[0]),i=[0,3,3,6,1,4,6,2,5,0,3,5],o=["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],n=parseInt(t.split("/").last())%100+Math.floor(t.split("/").last()/4),s=Math.floor(t.split("/").last()/100%4)
return e=0===s?6:1===s?4:2===s?2:0,o[(r+i[parseInt(t.split("/")[1])-1]+n+e)%7]}function date2num(t){t||(t=getDate())
var e=t.split("/")
return parseFloat(parseFloat(e[2]+"."+e[1]).toNDec()+"0"+e[0])}function num2date(t){var e=t.toString().split(".")
return e[1].get(3)+"/"+e[1].get(-3)+"/"+e[0]}function genStr(t,e){var r,i="",o=asciiTable("a-z"),n=asciiTable("A-Z"),s=range(9),h=["&","~",'"',"#","'","{","[","(","-","|","`","_","\\","^","@",")","]"," + ","=","}"," % "," * ","?",",",";",".","/",":","!"," "]
r=o.concat(n,s,h)
for(var a="",l=0;i.length<t;){if(a=r.rand(),"specificChar"===e.name)for(;a===e.character;)a=r.rand()
else if("noUpperCase"===e.name)a=a.toLowerCase()
else if("noLowerCase"===e.name)a=a.toUpperCase()
else if("cumultativeRepeat"===e.name)for(;a===i[l-1];)a=r.rand()
else if("cumultativeSensitiveRepeat"===e.name)for(;a===i[l-1];)a=r.rand()
else"noRepeat"===e.name&&(r.pop(l>0?i[l-1]:i[0]),a=r.rand())
i+=a,l++}return i.length<t?i+=r.rand():i.length>t&&(i=i.slice(0,t+1)),""===i&&genStr(t,e),i}function mkArray(t,e,r){var i=[]
if(1===e)if(isNon(r))i=new Array(t)
else for(var o=0;t>o;o++)i[o]=r
else if(2===e)if(isNon(r))for(i=new Array(t),o=0;t>o;o++)i[o]=new Array(t)
else for(o=0;t>o;o++){i[o]=new Array(t)
for(var n=0;t>n;n++)i[o][n]=r}else if(3===e)if(isNon(r))for(i=new Array(t),o=0;t>o;o++)for(i[o]=new Array(t),n=0;t>n;n++)i[o][n]=new Array(t)
else for(o=0;t>o;o++)for(i[o]=new Array(t),n=0;t>n;n++){i[o][n]=new Array(t)
for(var s=0;t>s;s++)i[o][n][s]=r}else{if(4!==e)throw new Error("Unvalid dimension. Only 1D-4D arrays can be made.")
if(isNon(r))for(i=new Array(t),o=0;t>o;o++)for(i[o]=new Array(t),n=0;t>n;n++)for(i[o][n]=new Array(t),s=0;t>s;s++)i[o][n][s]=new Array(t)
else for(o=0;t>o;o++)for(i[o]=new Array(t),n=0;t>n;n++)for(i[o][n]=new Array(t),s=0;t>s;s++){i[o][n][s]=new Array(t)
for(var h=0;t>h;h++)i[o][n][s][h]=r}}return i}function numArr(t,e){for(var r=[],i=e||0,o=0;t>o;o++){r[o]=[]
for(var n=0;t>n;n++)r[o][n]=i++}return r}function swap(t,e,r){var i
...
return[t,e]}function lookfor(t,e,r){for(var i=0;i<e.length;i++)for(var o=0;o<e[i].length;o++)if(e[i][o]===t)return r?[o,i]:[i,o]
...
return r}function timeUp(t,e,r){var i=new Date,o=0
return i=1e3*(60*i.getMinutes()+i.getSeconds())+i.getMilliseconds(),t(r),o=new Date,o=1e3*(60*o.getMinutes()+o.getSeconds())+o.getMilliseconds(),isNon(e)||"auto"===e.slice(0,4).toLowerCase()||"none"===e.slice(0,4).toLowerCase()?o-i>1e3?(o-i)/1e3+"s":o-i+"ms":"ms"===e.toLowerCase()||"millisec"===e.slice(0,8).toLowerCase()?o-i+"ms":(o-i)/1e3+"s"}var Essence={version:"1.1b",author:"Maximilian Berkmann",description:"library used for DHTML connexions, maths, database management and cryptography",source:document.URL.indexOf("essence.min.js")>-1?"https://Www.dropbox.com/s/1prjdvv9ku0ga92/essence.min.js?dl=0":"https://Www.dropbox.com/s/n2sz2mxz5zwc05t/essence.js?dl=0",element:$n,handleError:function(t,e,r){isType(t,"Error")?alert("[Essence.js] An error has occurred (line/column "+t.lineNumber+"/"+t.columnNumber+" of "+t.fileName+").\n\nMessage: "+t.stack):alert("[Essence.js] An error has occurred (line "+r+" of "+e+").\n\nMessage: "+t)},say:function(t,e,r,i,o,n){e=isNon(e)?"":e.slice(0,4).toLowerCase(),r&&!i?"info"===e?console.info("%c[EssenceJS]%c "+t,"color: #00f; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r):"erro"===e?console.error("%c[EssenceJS]%c "+t,"color: #f00; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r):"warn"===e?console.warn("%c[EssenceJS]%c "+t,"color: #fc0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r):"succ"===e?console.log("%c[EssenceJS]%c "+t,"color: #0f0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r):console.log("%c[EssenceJS]%c "+t,"color: #808080; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r):r&&i&&!o?"info"===e?console.info("%c[EssenceJS]%c "+t,"color: #00f; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i):"erro"===e?console.error("%c[EssenceJS]%c "+t,"color: #f00; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i):"warn"===e?console.warn("%c[EssenceJS]%c "+t,"color: #fc0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i):"succ"===e?console.log("%c[EssenceJS]%c "+t,"color: #0f0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i):console.log("%c[EssenceJS]%c "+t,"color: #808080; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i):r&&i&&o&&!n?"info"===e?console.info("%c[EssenceJS]%c "+t,"color: #00f; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o):"erro"===e?console.error("%c[EssenceJS]%c "+t,"color: #f00; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o):"warn"===e?console.warn("%c[EssenceJS]%c "+t,"color: #fc0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o):"succ"===e?console.log("%c[EssenceJS]%c "+t,"color: #0f0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o):console.log("%c[EssenceJS]%c "+t,"color: #808080; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o):r&&i&&o&&n?"info"===e?console.info("%c[EssenceJS]%c "+t,"color: #00f; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o,n):"erro"===e?console.error("%c[EssenceJS]%c "+t,"color: #f00; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o,n):"warn"===e?console.warn("%c[EssenceJS]%c "+t,"color: #fc0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o,n):"succ"===e?console.log("%c[EssenceJS]%c "+t,"color: #0f0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o,n):console.log("%c[EssenceJS]%c "+t,"color: #808080; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000",r,i,o,n):"info"===e?console.info("%c[EssenceJS]%c "+t,"color: #00f; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000"):"erro"===e?console.error("%c[EssenceJS]%c "+t,"color: #f00; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000"):"warn"===e?console.warn("%c[EssenceJS]%c "+t,"color: #fc0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000"):"succ"===e?console.log("%c[EssenceJS]%c "+t,"color: #0f0; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000"):console.log("%c[EssenceJS]%c "+t,"color: #808080; text-decoration: bold;-webkit-text-decoration: bold;-moz-text-decoration: bold;","color: #000")},applyCSS:function(){if(include_once("essence.min.css","link"),$e("html").val(!0).indexOf("<body></body>")>-1){var t=$e("html").val(!0).indexOf("<body></body>"),e=$e("html").val(!0).slice(0,t),r=$e("html").val(!0).slice(t+13,$e("html").val(!0).length)
...
return Boolean(t)},loadedModules:[]},modules=[],debugging=!1,getDirectoryPath=function(t){return t||(t=location.href),t.substring(0,t.indexOf(t.split("/")[t.split("/").length-1]))},gatherScripts=function(t){for(var e=$n("*script"),r=t?[]:{},i=0;i<e.length;i++)t?r.push(e[i].src):r[e[i].src.split("/")[e[i].src.split("/").length-1]]=e[i].src
return r},getCurrentPath=function(t,e){e||(e="file:///")
for(var r=t.split("/"),i="",o=e.split("/"),n=0,s=0,h=function(t,e,r){var i=[]
0>e&&!r&&(r=e,e=0),0>r&&(r=t.length+r-1)
for(var o=e||0;o<=(r||t.length-1);o++)i.push(t[o])
return i.remove()};e.indexOf(r[n])>-1;)n++
for(i=h(r,n).join("/");i.indexOf(o[s])>-1;)console.log("Gone through "+o[s]),s++
if(s>0)for(n=0;s>n;n++)i="../"+i
return i},getExtPath=function(t){var e=location.href,r=function(t,e){for(var r="",i=-1;i<=Math.min(t.length,e.length)&&(i++,t[i]===e[i]);)r+=t[i]
return r},i=r(e,t),o=getCurrentPath(t,i),n="../".repeat(o.count("/"))
return n+getCurrentPath(t,i)}
...
if(!t&&!e||t.equals([0,0])&&e>=this.length-1)for(var i=0;i<this.length;i++)for(var o=0;o<this[i].length;o++)r+=this[i][o]
else if(t&&!e)for(i=t[0];i<this.length;i++)for(o=t[1];o<this[i].length;o++)r+=this[i][o]
else for(i=t[0];i<e[0];i++)for(o=t[1];o<e[1];o++)r+=this[i][o]
return r},Array.prototype.mean=function(t,e,r){e||(e=0),r||(r=this.lastIndex())
var i=this.sum(e,r)
return(i/this.get(e,r).length).toNDec(t)+0},Array.prototype.meanOf=function(t,e,r){e||(e=0),r||(r=this.length-e-1)
for(var i=0,o=0;r>o;o++)i+=this[e+o]
return(i/r).toNDec(t)+0},Array.prototype.minMean=function(t,e){if(t||(t=this.length-1),this.length-(t-1)<0)throw new Error("You're expecting a minimum mean with more values than the are.")
for(var r=[],i=0;t>i;i++)r.push(this.meanOf(e,i,t))
...
return(i/(this.get(e,r).length-2)).toNDec(t)+0},Array.prototype.avgOf=function(t,e,r){e||(e=0),r||(r=this.length-e-1)
for(var i=0,o=0;r>o;o++)this[e+o]==this.maxOf(e,r)&&this[e+o]==this.minOf(e,r)||(i+=this[e+o])
return(i/(r-2)).toNDec(t)+0},Array.prototype.minAvg=function(t,e){if(t||(t=this.length-1),this.length-(t-1)<0)throw new Error("You're expecting a minimum average with more values than the are.")
for(var r=[],i=0;t>i;i++)r.push(this.avgOf(e,i,t))
...
var r
if(this.length>1){var i=this[Math.floor((e+t)/2)],o=e
for(r=t;o>=r;){for(;this[r]<i;)r++
for(;this[o]>i;)o--
o>=r&&(swap(this,r,o),r++,o--)}r-1>t&&this.quickSort(t,r-1),e>r&&this.quickSort(r,e)}return this},Array.prototype.revSort=function(t,e){t||e||(t=0,e=this.lastIndex())
var r
if(this.length>1){var i=this[Math.floor((e+t)/2)],o=e
for(r=t;o>=r;){for(;this[r]>i;)r++
for(;this[o]<i;)o--
o>=r&&(swap(this,r,o),r++,o--)}t>r-1&&this.revSort(t,r-1),r>e&&this.revSort(r,e)}return this},Array.prototype.bubbleSort=function(t){var e=this,r=1,i=!0
if(isNon(t)||isType(t,"string")&&"a"===t[0].toLowerCase())for(;i;){i=!1
for(var o=0;o<=e.length-r;o++)e[o]>e[o+1]&&(e=swap(e,o,o+1),i=!0),o<e.length-(r+1)&&(e[o]>e[o+2]&&(e=swap(e,o,o+2)),e[o+1]>e[o+2]&&(e=swap(e,o+1,o+2),i=!0)),o<e.length-(r+2)&&(e[o]>e[o+3]&&(e=swap(e,o,o+3)),e[o+1]>e[o+3]&&(e=swap(e,o+1,o+3)))
r++}else if(1===t||isType(t,"string")&&"d"===t[0].toLowerCase())for(;i;){for(i=!1,o=0;o<=e.length-r;o++)e[o]<e[o+1]&&(e=swap(e,o,o+1),i=!0),o<e.length-(r+1)&&(e[o]<e[o+2]&&(e=swap(e,o,o+2)),e[o+1]<e[o+2]&&(e=swap(e,o+1,o+2),i=!0)),o<e.length-(r+2)&&(e[o]<e[o+3]&&(e=swap(e,o,o+3)),e[o+1]<e[o+3]&&(e=swap(e,o+1,o+3)))
...
var o=this[t]
this[t]=e,this[r]=o}return this},Array.prototype.maxSort=function(){var t=this.min(),e=this.median(),r=this.max(),i=new Array(this.length),o=this.getIncrement(3),n=this.quartile(1),s=this.quartile(3)
i[0]=t,i[i.length-1]=r,parseInt(i.length/2)===i.length/2&&(i[i.length/2]=e),parseInt(i.length/4)===i.length/4&&(i[i.length/4]=n),parseInt(3*i.length/4)===3*i.length/4&&(i[3*i.length/4]=s)
for(var h=1;h<this.length-1;h++)this[h]===Math.floor(i[0]+h*o)?i[h]=this[h]:this[h]===Math.round(i[0]+h*o)?i[h]=this[h]:this[h]==Math.ceil(i[0]+h*o)?i[h]=this[h]:this[h]>=Math.floor(i[0]+h*o)&&this[h]<=Math.ceil(i[0]+h*o)&&(i[h]=this[h])
for(console.log("current result: "+i.toStr(!0)),h=this.length-1;h>1;h--)this[h]===Math.floor(i[i.length-1]-h*o)&&isNon(i[h])?i[h]=this[h]:this[h]===Math.round(i[i.length-1]-h*o)&&isNon(i[h])?i[h]=this[h]:this[h]===Math.ceil(i[i.length-1]+h*o)&&isNon(i[h])?i[h]=this[h]:this[h]>=Math.floor(i[i.length-1]+h*o)&&this[h]<=Math.ceil(i[0]+h*o)&&isNon(i[h])&&(i[h]=this[h])
for(console.log("current result: "+i.toStr(!0)),h=1;h<this.length-1;h++)for(var a=0;a<this.length;a++)this[a]===Math.floor(i[0]+h*o)?i[h]=this[a]:this[a]===Math.round(i[0]+h*o)?i[h]=this[a]:this[a]===Math.ceil(i[0]+h*o)?i[h]=this[a]:this[a]>=Math.floor(i[0]+h*o)&&this[a]<=Math.ceil(i[0]+h*o)&&(i[h]=this[a])
...
for(var i=this[Math.floor((e+t)/2)],o=e,n=t;o>=n;){for(;this[n]<i;)n--
for(;this[o]>i;)o++
n>=o&&(swap(this,n,o),n--,o++)}return t>n-1&&this.cenSort(t,n-1),n>e&&this.cenSort(n,e),r},Array.prototype.setSort=function(){for(var t=[],e=this.length,r=[],i=0;1e3>i;i++)t[i]=0
...
for(var i=this.get(e,r),o=t.get(e,r),n=0;n<i.length;n++)i[n]=o[n]
return i},Array.prototype.exchange=function(t,e,r){e=e||0,r=r||this.length-1
for(var i=this.get(e,r),o=t.get(e,r),n=0;n<i.length;n++){var s=i[n]
i[n]=o[n],o[n]=s}return i},Array.prototype.rot=function(t){var e
...
this[e][r]=this[r][e]||"",this[r][e]=i}if("4x4"===this.size(!0)){var o=this[2].last()
this[2].last(this.last()[2]),this.last()[2]=o}return this},Array.prototype.lookFor=function(t){for(var e=0;e<this.length;e++)if(this[e]===t||this[e].equals(t))return e
return-1},Array.prototype.divide=function(t){for(var e=new Array(Math.round(this.length/t)).fill(""),r=0,i=0;i<e.length;i++)for(var o=0;t>o;o++)e[i]+=this[r++]
...
for(var o=0;o<this[i].length;o++)r[i][o]="a-b"===e?t-this[i][o]:this[i][o]-t}return r},Array.prototype.dotFrac=function(t,e){var r=[]
e=e.toLowerCase().remove(" ")
for(var i=0;i<this.length;i++){r[i]=[]
for(var o=0;o<this[i].length;o++)r[i][o]="a/b"===e?t/this[i][o]:this[i][o]/t}return r},Array.prototype.toStr=function(t){var e=""
...
for(var e=nthroot(this.length,t,0),r=[],i=0,o=0;e>o;o++){r[o]=[]
for(var n=0;e>n;n++)r[o][n]=this[i++]}return r},Array.prototype.toNcol=function(t){for(var e=[],r=0,i=0;i<this.length/t;i++){e[i]=[]
for(var o=0;t>o;o++)e[i][o]=this[r++]}return e},Array.prototype.toNrow=function(t){for(var e=[],r=0,i=0;t>i;i++){e[i]=[]
for(var o=0;o<this.length/t;o++)e[i][o]=this[r++]}return e},Array.prototype.linearise=function(){return this.toString().split(",")},Array.prototype.uniform=function(t){for(var e=this,r=e.maxLength(),i=0;i<e.length;i++)for(;e[i].length<r;)isType(e[i],"Array")?e[i].push(t||" "):e[i]+=t||" "
...
for(var o=0;o<r.length;o++)try{isNon(this[t+r[o][0]][e+r[o][1]])||i.push(this[t+r[o][0]][e+r[o][1]])}catch(n){}}else try{isNon(this[t-1])||i.push(this[t-1]),isNon(this[t+1])||i.push(this[t+1])}catch(n){}return i},Array.prototype.sanitise=function(t){for(var e=0;e<this.length;e++)for(var r=0;r<this[e].length;r++)this[e][r]=name2Type(t,this[e][r])
...
for(var r=mixedRange(0,1,this.length-1),i=this.split(t),o=[],n=0;n<this.length;n++)o[n]=i[r[n]]
return o.join(e)},String.prototype.divide=function(t){for(var e=new Array(Math.round(this.length/t)).fill(""),r=0,i=0;i<e.length;i++)for(var o=0;t>o;o++)e[i]+=this[r++]
...
return t?e.split("").join(""):e},String.prototype.replaceAll=function(t,e,r){var i=r?this.split(r).replace(t,e):this.replace(t,e),o=0
if(""===r)return this.replace(RegExpify(t),e)
for(;i.indexOf(t)>-1||o===this.length;)i=this.replace(t,e),o++
