...
this.write(this.val().split(t).join(e||""))},this.setCSS=function(t,e){if(isType(this.node,"NodeList"))for(var r=0;r<this.node.length;r++)this.node[r].style[t]=isType(e,"Array")?e[r]:e
