...
break
default:r.scroll(0,1),r.node.scrollTop===r.node.scrollHeight-r.node.offsetTop&&clearInterval(i)}},e||50)},this.attr=function(t,e){return isNon(e)?this.node.getAttribute(t):this.node.setAttribute(t,e)},this.rmAttr=function(t){this.node.removeAttribute(t)},this}function include(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
...
Essence.global=$G,Object.prototype.getName=function(){return this.hasOwnProperty("name")||this.hasOwnProperty("title")?void 0!=this.name?this.name:this.title:void 0},Object.prototype.count=function(t){for(var e=0,r=0;r<this.length;r++)this[r]===t&&e++
