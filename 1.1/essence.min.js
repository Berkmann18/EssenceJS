...
else debugging&&Essence.say("Initiating "+t),modules.indexOf(t)===-1?$require(t):debugging&&Essence.say("The module %c"+t+"%c was already initiated !!","info","color: #c0f","color: #000"),e&&e(n||t),setTimeout(function(){run(t),r&&r(o||t)},1)}function $e(t,e){if(!e)return new Element(t)
try{return new Element(t)}catch(e){return debugging&&Essence.say('%c$e("'+t+"\")%c isn't there (yet).","warn","color: #f00","color: #000"),null}}function $n(t,e){return e&&isNon($e(t,e))?null:$e(t).node}function Element(t){if(/^([#.*_-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as it'start invalid.")
...
var p="We're "+c[h]+" "+a+" "+s[o]+" "+n+" and it'start "+l+":"+e+":"+r+" "+u+" "+d
