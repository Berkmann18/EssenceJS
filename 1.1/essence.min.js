...
var p="We're "+c[a]+" "+h+" "+s[n]+" "+o+" and it's "+l+":"+e+":"+r+" "+u+" "+d
$e("#"+t).write(p,!0),setTimeout('dateTime("'+t+'");',1e3)}function weekDay(t){var e,r=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],i=parseInt(t.split("/")[0]),o=parseInt(t.split("/")[1]),n=parseInt(t.split("/").last())
...
return r},getExtPath=function(t){var e=location.href,r=e.sameFirst(t),i=getCurrentPath(t,r),o="../".repeat(i.count("/"))
return o+getCurrentPath(t,r)}
!function(){Essence.say("Initiating the ML"),require(["File","DOM","UI","Web","Maths","Ajax","DataStruct","Security","Misc","QTest"],1.1),setTimeout(function(){Essence.isComplete()?Essence.say("Essence is complete !","succ"):Essence.time("List of loaded modules: "+Essence.loadModules.toStr(!0)),run(modules,1.1)},1e3)}()
