...
else debugging&&Essence.say("Initiating "+t),require(t,i),e&&e(o||t),setTimeout(function(){run(t),r&&r(n||t)},2)}function $e(t){return new Element(t)}function $n(t){return $e(t).node}function Element(t){if(/^([#\.\*_-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as it's invalid.")
...
return r}
!function(){Essence.say("Initiating the ML"),require(["File","DOM","UI","Web","Maths","Ajax","DataStruct","Security","Misc"],1.1),setTimeout(function(){Essence.isComplete()?Essence.say("Essence is complete !","succ"):Essence.time("List of loaded modules: "+Essence.loadModules.toStr(!0))},1e3)}()
...
if(!t&&!e||0===t&&e>=this.length-1)for(var i=0;i<this.length;i++)for(var o=0;o<this[i].length;o++)r+=this[i][o]
