...
this.write(this.val().split(t).join(e||""))},this.setCSS=function(e,r){isType(this.node,"NodeList")?addCSSRule(/\*\S/.test(t)?t.get(1):t,camelCaseTo(e,"hyphen")+": "+r):this.node.style[e]=r},this.setInlineCSS=function(t,e){for(var r=0;r<this.node.length;r++)this.node[r].style[t]=isType(e,"Array")?e[r]:e},this.setStyles=function(t){for(var e=0;e<t.length-1;e+=2)this.setCSS(t[e],t[e+1])},this.css=function(t){if(isType(this.node,"Array")){for(var e=[],r=0;r<this.node.length;r++)e.push(this.node[r].style[t])
