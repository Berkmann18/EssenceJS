...
return r},n=r(e,t)
return"../".repeat(i(getCurrentPath(e,n),"/"))+getCurrentPath(t,n)}
...
return this.filter(function(r,i){return r!=t||i!=e.indexOf(t)})},Array.prototype.removeLast=function(t){var e=this
return this.filter(function(r,i){return r!=t||i!=e.lastIndexOf(t)})},Array.prototype.binaryIndexOf=function(t){for(var e,r,i,n=0,o=this.length-1;o>=n;)if(i=e=n+o>>1,r=this[e],t>r)n=e+1
...
return r.has(void 0)?e.remove():r}for(var i in t)t.hasOwnProperty(i)&&(e=e.remove(i))},String.prototype.toNDec=function(t){return Number(this).toFixed(t||2)},String.prototype.toNDigits=function(t){var e=this
