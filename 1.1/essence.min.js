...
try{return new Element(t)}catch(r){return debugging&&Essence.say('%c$e("'+t+"\")%c isn't there (yet).","warn","color: #f00","color: #000"),null}}function $n(t,e){return e&&isNon($e(t,e))?null:$e(t).node}function Element(t){if(/^([#.*_-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as it'start invalid.")
...
try{r="undefined"!=typeof t||t!==e||t in window}catch(i){r=!1}return r}function Copy(t){if(isType(t,"String")||isType(t,"Number")||isType(t,"Boolean"))return t
var e={}
...
return this},String.prototype.has=Array.prototype.has,String.prototype.last=function(t){return this.split("").last(t)},String.prototype.splice=function(t,e,r){return 0>t&&(t=this.length+t,0>t&&(t=0)),this.slice(0,t)+(r||"")+this.slice(t+e)},String.prototype.remove=function(t){var e=this
