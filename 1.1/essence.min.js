...
=======
<<<<<<< HEAD
function Module(t,e,r,i,n,o){return this.name=t||"Module",this.version=i||1,this.dependency=r||[],this.description=e||"",this.run=n||$f,this.loaded=!1,this.path=(o?o:Essence.version.substr(0,3))+"/modules/"+this.name+".js",this.load=function(){perfMod&&console.timeStamp("Loading module:"+this.name),debugging&&Essence.say("Loading "+this.name),this.dependency.length>0&&(debugging&&Essence.say("Initiating dependencies for %c"+this.name+"%c","info","color: #f0f","color: #000"),init(this.dependency,!1,!1,o)),this.loaded=!0,perfMod&&console.timeStamp("Loaded module:"+this.name)},this.toString=function(){return"Module(name='"+this.name+"', version="+this.version+", dependency=["+this.dependency+"], description='"+this.description+"', loaded="+this.loaded+", run="+this.run+", path='"+this.path+"')"},this.getWeight=function(){for(var t=moduleList(!1,!0).line(3).get(1),e=0,r=moduleList(!1,!0).line().get(1),i=0;i<t.length;i++)t[i].has(this.name)&&r[i]!=this.name&&t[i].count(this.name)<2?e++:r[i]===this.name&&t[i].has(this.name)&&e--
return e},this.update=function(){perfMod&&console.timeStamp("Updated module:"+this.name)
for(var t=$n("*script").toArray(),e=filenameList(t.map(function(t){return t.src})),r=0;r<e.length;r++)stripPath(e[r])===this.name+".js"?t[r].src="http://berkmann18.github.io/rsc/modules/"+this.name+".js":stripPath(e[r])===this.name+".min.js"&&(t[r].src="http://berkmann18.github.io/rsc/modules/"+this.name+".min.js")
Essence.say(this.name.capitalize()+"(.min).js has been updated","succ"),perfMod&&console.timeStamp("Updated module:"+this.name)},this.getUsage=function(){for(var t=moduleList(!1,!0).line(3).get(1),e="",r=moduleList(!1,!0).line().get(1),i=0;i<t.length;i++)t[i].has(this.name)&&r[i]!=this.name&&t[i].count(this.name)<2&&(e+=r[i]+", ")
return e.get(-2)},this}function require(t,e,r){if(perfMod&&console.timeStamp("Start of require("+t+", "+e+")"),isType(t,"Array"))for(var i=0;i<t.length;i++)require(t[i],e)
=======
>>>>>>> Conflict fixed
function Module(t,e,r,i,n,o){return this.name=t||"Module",this.version=i||1,this.dependency=r||[],this.description=e||"",this.run=n||$f,this.loaded=!1,this.path=(o?o:Essence.version.substr(0,3))+"/modules/"+this.name+".js",this.load=function(){perfMod&&console.timeStamp("Loading module:"+this.name),debugging&&Essence.say("Loading "+this.name),this.dependency.length>0&&(debugging&&Essence.say("Initiating dependencies for %c"+this.name+"%c","info","color: #f0f","color: #000"),init(this.dependency,!1,!1,o)),this.loaded=!0,perfMod&&console.timeStamp("Loaded module:"+this.name)},this.toString=function(){return"Module(name='"+this.name+"', version="+this.version+", dependency=["+this.dependency+"], description='"+this.description+"', loaded="+this.loaded+", run="+this.run+", path='"+this.path+"')"},this.getWeight=function(){for(var t=moduleList().line(3).get(1),e=0,r=moduleList().line().get(1),i=0;i<t.length;i++)t[i].has(this.name)&&r[i]!=this.name&&t[i].count(this.name)<2?e++:r[i]===this.name&&t[i].has(this.name)&&e--
return e},this.update=function(){perfMod&&console.timeStamp("Updated module:"+this.name)
for(var t=$n("*script").toArray(),e=filenameList(t.map(function(t){return t.src})),r=0;r<e.length;r++)stripPath(e[r])===this.name+".js"?t[r].src="http://berkmann18.github.io/rsc/modules/"+this.name+".js":stripPath(e[r])===this.name+".min.js"&&(t[r].src="http://berkmann18.github.io/rsc/modules/"+this.name+".min.js")
Essence.say(this.name.capitalize()+"(.min).js has been updated","succ"),perfMod&&console.timeStamp("Updated module:"+this.name)},this}function require(t,e,r){if(perfMod&&console.timeStamp("Start of require("+t+", "+e+")"),isType(t,"Array"))for(var i=0;i<t.length;i++)require(t[i],e)
<<<<<<< master
=======
>>>>>>> develop
>>>>>>> Conflict fixed
else modules.indexOf(t)===-1?(include_once((e?e+"/":"")+"modules/"+t+".js","script",r||getDirectoryPath()),modules.push(t),debugging&&console.log("The module %c%start%c is now included into %c%start\t"+getTimestamp(!0),"color: red; text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",t,"color: #000; text-decoration: none;"," text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",getFilename())):debugging&&console.log("The module %c%start%c is already included into %c%start\t"+getTimestamp(!0),"color: red; text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",t,"color: #000; text-decoration: none;"," text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",getFilename())
perfMod&&console.timeStamp("End of require("+t+", "+version+")")}function $require(t){perfMod&&console.timeStamp("Start of $require("+t+")")
var e=function(t,e){var r=this+""
...
e<0&&!r&&(r=e,e=0),r<0&&(r=t.length+r-1)
...
else modules.indexOf(t)===-1?(gatherScripts()["essence.min.js"]?include_once(getExtPath(getDirectoryPath(gatherScripts()["essence.min.js"]))+"modules/"+t+".min.js","script"):include_once(getExtPath(getDirectoryPath(gatherScripts()["essence.js"]))+"modules/"+t+".js","script"),modules.push(t),debugging&&console.log("The module %c%start%c is now included into %c%start\t"+r(),"color: red; text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",t,"color: #000; text-decoration: none;"," text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",o())):debugging&&console.log("The module %c%start%c is already included into %c%start\t"+r(),"color: red; text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",t,"color: #000; text-decoration: none;"," text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",o())
perfMod&&console.timeStamp("End of $require("+t+")")}function run(t,e){if(perfMod&&console.timeStamp("Start of run("+t+", "+e+")"),isType(t,"Array"))for(var r=0;r<t.length;r++)run(t[r],e)
else if(modules.indexOf(t)>-1){var i=function(){perfMod&&console.timeStamp("Go in run("+t+", "+e+")")
try{debugging&&Essence.say("Running "+t+"\t"+getTimestamp(!0),"info"),window[t].loaded||window[t].load(),window[t].run()}catch(e){Essence.time("The module %c"+t+"%c have problems regarding it's run method.","color: #c0f","color: #000")}},n=function(r){perfMod&&console.timeStamp("Retry in run("+t+", "+e+")"),r||(r=0),Essence.say("The module %c"+t+"%c isn't available !\t"+getTimestamp(!0),"erro","color: #c0f","color: #000"),debugging&&Essence.say("Retrying to run %c"+t+"%c\t"+getTimestamp(!0),"info","color: #c0f","color: #000"),window[t]?i():r<=2?setTimeout(n(r+1),1):Essence.say("It's not possible to run %c"+t+"%c :( !\t"+getTimestamp(!0)+"\nModule: "+window[t],"info","color: #c0f","color: #000"),init(t)}
window[t]?i():n()}else Essence.say("The module %c"+t+"%c isn't in the list !!\t"+getTimestamp(!0),"erro","color: #c0f","color: #000")
perfMod&&console.timeStamp("End of $require("+t+", "+e+")")}function init(t,e,r,i,n,o){if(perfMod&&console.timeStamp("Start of init("+t+")"),isType(t,"Array"))for(var s=0;s<t.length;s++)init(t[s],e,r,i,t[s],t[s])
else debugging&&Essence.say("Initiating "+t),modules.indexOf(t)===-1?$require(t):debugging&&Essence.say("The module %c"+t+"%c was already initiated !!","info","color: #c0f","color: #000"),e&&e(n||t),setTimeout(function(){run(t),r&&r(o||t)},1)
perfMod&&console.timeStamp("End of init("+t+")")}function $e(t,e){if(!e)return new Element(t)
try{return new Element(t)}catch(e){return debugging&&Essence.say('%c$e("'+t+"\")%c isn't there (yet).","warn","color: #f00","color: #000"),null}}function $n(t,e){return e&&isNon($e(t,e))?null:$e(t).node}function Element(t){if(/^([#.*_-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as its invalid.")
...
this.write(this.val().split(t).join(e||""))},this.setCSS=function(e,r){isType(this.node,"NodeList")?console.log("CSS rule added: "+addCSSRule(/\*\S/.test(t)?t.get(1):t,e+": "+r)+" by "+t):this.node.style[e]=r},this.setInlineCSS=function(t,e){for(var r=0;r<this.node.length;r++)this.node[r].style[t]=isType(e,"Array")?e[r]:e},this.setStyles=function(t){for(var e=0;e<t.length-1;e+=2)this.setCSS(t[e],t[e+1])},this.css=function(t){if(isType(this.node,"Array")){for(var e=[],r=0;r<this.node.length;r++)e.push(this.node[r].style[t])
return e}return isType(this.node,"NodeList")?this.node.toArray().map(function(e){return e.style[t]}):this.node.style[t]},this.hasClass=function(t){if(isType(this.node,"Array"))for(var e=[],r=0;r<this.node.length;r++)e.push(new RegExp(" "+t+" ").test(" "+this.node[r].className+" ")||new RegExp(" "+t+" ").test(" "+this.node[r][t]+" ")||this.node[r].style.clasName==t)
...
this.node.className=e.replace(/^\s+|\s+$/g,"")}},this.toggleCSS=function(t,e,r){if(r||(r=0),""===this.css(t)&&r<1&&this.toggleCSS(t,e,r+1),"visibility"===t)"visible"===this.css("visibility")?this.setCSS("visibility","hidden"):this.setCSS("visibility","visible")
else if("enabled"===t)"enabled"===this.css("enabled")?this.setCSS("enabled","disabled"):this.setCSS("enabled","enabled")
else if("display"===t)"block"===this.css("display")||this.css("display")===e?this.setCSS("display","none"):this.setCSS("display",e||"block")
...
break
case"rad":r.scroll(1,0),r.node.scrollLeft===r.node.offsetWidth-r.node.offsetLeft&&clearInterval(i)
break
case"u":r.scroll(0,-1),r.node.scrollTop===r.node.offsetTop&&clearInterval(i)
break
<<<<<<< master
<<<<<<< HEAD
default:r.scroll(0,1),r.node.scrollTop===r.node.scrollHeight-r.node.offsetTop&&clearInterval(i)}},e||50)},this.attr=function(t,e){return isNon(e)?this.node.getAttribute(t):this.node.setAttribute(t,e)},this.rmAttr=function(t){this.node.removeAttribute(t)},this.invColour=function(){isType(this.css("color"),"Array")||isType(this.css("backgroundColor"),"Array")?(this.node.toArray().filter(function(t){return""===t.style.color}).map(function(t){return t.style.color="inherit"}),this.node.toArray().filter(function(t){return""===t.style.backgroundColor}).map(function(t){return t.style.backgroundColor="inherit"})):(""===this.css("color")&&this.setCSS("color","inherit"),""===this.css("backgroundColor")&&this.setCSS("backgroundColor","inherit")),negateColour(t,"color","a"),negateColour(t,"backgroundColor","a")},this.classes=function(){return this.node.className.split(" ")},this.multi=function(t){for(var e=this.node.toArray(),r=0;r<e.length;r++)t(e[r])},this.multiElm=function(t,e){for(var r=this.node.toArray(),i=0;i<r.length;i++)$e(r[i].id)[t](e[0],e[1],e[2])},this}function include(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
=======
default:r.scroll(0,1),r.node.scrollTop===r.node.scrollHeight-r.node.offsetTop&&clearInterval(i)}},e||50)},this.attr=function(t,e){return isNon(e)?this.node.getAttribute(t):this.node.setAttribute(t,e)},this.rmAttr=function(t){this.node.removeAttribute(t)},this.invColour=function(){isType(this.css("color"),"Array")||isType(this.css("backgroundColor"),"Array")?(this.node.toArray().filter(function(t){return""===t.style.color}).map(function(t){return t.style.color="inherit"}),this.node.toArray().filter(function(t){return""===t.style.backgroundColor}).map(function(t){return t.style.backgroundColor="inherit"})):(""===this.css("color")&&this.setCSS("color","inherit"),""===this.css("backgroundColor")&&this.setCSS("backgroundColor","inherit")),negateColour(t,"color","a"),negateColour(t,"backgroundColor","a")},this.classes=function(){return this.node.className.split(" ")},this.multi=function(t){for(var e=this.node.toArray(),r=0;r<e.length;r++)t(e[r])},this.multiElm=function(t,e){for(var r=this.node.toArray(),i=0;i<r.length;i++)$e(r[i].id)[t](e[0],e[1],e[2])},this.delete=function(){this.write("",!1,!0)},this.replace=function(t,e,r,i){this.write(this.val(r,i).replace(t,e),r,i)},this}function include(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
>>>>>>> develop
=======
default:r.scroll(0,1),r.node.scrollTop===r.node.scrollHeight-r.node.offsetTop&&clearInterval(i)}},e||50)},this.attr=function(t,e){if(isType(this.node,"NodeList")){for(var r=[],i=0;i<this.node.length;i++)r+=isNon(e)?this.node[i].getAttribute(t):this.node[i].setAttribute(t,e)
return r}return isNon(e)?this.node.getAttribute(t):this.node.setAttribute(t,e)},this.rmAttr=function(t){if(isType(this.node,"NodeList"))for(var e=0;e<this.node.length;e++)this.node[e].removeAttribute(t)
else this.node.removeAttribute(t)},this.invColour=function(){isType(this.css("color"),"Array")||isType(this.css("backgroundColor"),"Array")?(this.node.toArray().filter(function(t){return""===t.style.color}).map(function(t){return t.style.color="inherit"}),this.node.toArray().filter(function(t){return""===t.style.backgroundColor}).map(function(t){return t.style.backgroundColor="inherit"})):(""===this.css("color")&&this.setCSS("color","inherit"),""===this.css("backgroundColor")&&this.setCSS("backgroundColor","inherit")),negateColour(t,"color","a"),negateColour(t,"backgroundColor","a")},this.classes=function(){return this.node.className.split(" ")},this.multi=function(t){for(var e=this.node.toArray(),r=0;r<e.length;r++)t(e[r])},this.multiElm=function(t,e){for(var r=this.node.toArray(),i=0;i<r.length;i++)$e(r[i].id)[t](e[0],e[1],e[2])},this.delete=function(){this.write("",!1,!0)},this.replace=function(t,e,r,i){this.write(this.val(r,i).replace(t,e),r,i)},this.moveCSS=function(){console.log("moving %s's rules to style",t),addCSSRule(t,this.attr("style")),this.rmAttr("style")},this}function include(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
>>>>>>> Conflict fixed
...
return!(r&&(keyList(i,!0).indexOf(r+t)>-1||valList(i,!0).indexOf(r+t)>-1)||keyList(i,!0).indexOf(t)>-1||valList(i,!0).indexOf(t)>-1)&&void include(t,e)}function exclude(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
var r=document.createElement(e)
"script"===e?r.src=t:r.href=t,r.type="script"===e?"text/javascript":"text/css",console.log("el",r),document.head.removeChild(r)}function isType(t,e){return getType(t,!0)==="[object "+e+"]"}function isCustomType(t,e){return getCustomType(t)===e}function getType(t,e){var r=Object.prototype.toString.call(t)
...
try{r="undefined"!=typeof t||t!==e||t in window}catch(t){r=!1}return r}function Copy(t){if(isType(t,"String")||isType(t,"Number")||isType(t,"Boolean"))return t
var e={}
...
l<10&&(l="0"+l),e=i.getMinutes(),l>12?(l-=12,u="PM"):u="AM",e<10&&(e="0"+e),r=i.getSeconds(),r<10&&(r="0"+r),d=d>=0?"GMT+"+d:"GMT-"+d
var p="We're "+c[h]+" "+a+" "+s[o]+" "+n+" and it'ss"+l+":"+e+":"+r+" "+u+" "+d
...
return i?Math.round((e-t)/n[r||"d"]):(e-t)/n[r]}function date2s(t,e,r,i){return 86400*(t||0)+7*(e||0)*86400+30.417*(r||0)*86400+365*(i||0)*30.417*86400}function s2date(t,e){switch(e||(e="d"),e.toLowerCase()[0]){case"width":return t/604800
...
else"noRepeat"===e.name&&(r=r.remove(),h=r.rand())
...
else for(var n=0;n<t;n++)i[n]=r
else if(2===e)if(isNon(r))for(i=new Array(t),n=0;n<t;n++)i[n]=new Array(t)
else for(n=0;n<t;n++){i[n]=new Array(t)
for(var o=0;o<t;o++)i[n][o]=r}else if(3===e)if(isNon(r))for(i=new Array(t),n=0;n<t;n++)for(i[n]=new Array(t),o=0;o<t;o++)i[n][o]=new Array(t)
else for(n=0;n<t;n++)for(i[n]=new Array(t),o=0;o<t;o++){i[n][o]=new Array(t)
for(var s=0;s<t;s++)i[n][o][s]=r}else{if(4!==e)throw new Error("Unvalid dimension. Only 1D-4D arrays can be made.")
if(isNon(r))for(i=new Array(t),n=0;n<t;n++)for(i[n]=new Array(t),o=0;o<t;o++)for(i[n][o]=new Array(t),s=0;s<t;s++)i[n][o][s]=new Array(t)
else for(n=0;n<t;n++)for(i[n]=new Array(t),o=0;o<t;o++)for(i[n][o]=new Array(t),s=0;s<t;s++){i[n][o][s]=new Array(t)
for(var a=0;a<t;a++)i[n][o][s][a]=r}}return i}function numArr(t,e){for(var r=[],i=e||0,n=0;n<t;n++){r[n]=[]
for(var o=0;o<t;o++)r[n][o]=i++}return r}function swap(t,e,r){var i
...
return[t,e]}function lookfor(t,e,r){for(var i=0;i<e.length;i++)for(var n=0;n<e[i].length;n++)if(e[i][n]===t||e[i][n].equals(t))return r?[n,i]:[i,n]
...
this.txt2print=""},preInit:function(){$G.t1=$G.t1.getTime()},init:function(){$G.t2=new Date,$G.t2=$G.t2.getTime(),$G.t=$G.t2-$G.t1>1e3?($G.t2-$G.t1)/1e3+"s":$G.t2-$G.t1+"ms",debugging&&Essence.say("Page loaded in %c"+$G.t+"%c","succ","font-style: italic","font-style: none")},time:function(t,e,r){console.log("[%c"+getTimestamp(!0)+"%c] "+t,"color: #00f;","color: #000;",e||"",r||"")},sayClr:function(t){4===t.length?console.log("%cr%cg%cb%ca(%c"+t.join(", %c")+"%c)","color: #f00","color: #0f0","color: #00f","color: #00f","color: #000","color: #f00","color: #0f0","color: #00f","color: #00f","color: #000"):console.log("%cr%cg%cb%c(%c"+t.join(", %c")+"%c)","color: #f00","color: #0f0","color: #00f","color: #00f","color: #000","color: #f00","color: #0f0","color: #00f","color: #00f","color: #000")},ask:function(t,e){for(Sys.in.recording=!0,Essence.say((t||"Is there a problem")+" ? (please type in the window and not the console)","quest");96!=$G.lastKeyPair[1]&&10!=$G.lastKeyPair[1];);return alert("OUT !!"),Sys.in.recording=!1,e&&e(Sys.in.data.join("")),Sys.in.data.join("")},isComplete:function(){var complete=!0
this.loadedModules=[]
<<<<<<< master
for(var i=0;i<modules.length;i++){try{eval(window[modules[i]].loaded)}catch(t){Essence.say("The module "+modules[i]+" is not right !","warn"),init(modules[i])}finally{complete&=window[modules[i]].loaded}window[modules[i]].loaded&&this.loadedModules.push(window[modules[i]])}return!!complete},loadedModules:[],updateAll:function(){this.update(),this.isComplete(),this.loadedModules.map(function(t){t.update()})}},modules=[],debugging=!1,$f=function(){},testMode=!1,perfMod=!0,getDirectoryPath=function(t){return t||(t=location.href),t.substring(0,t.indexOf(t.split("/")[t.split("/").length-1]))},gatherScripts=function(t){for(var e=$n("*script"),r=t?[]:{},i=0;i<e.length;i++)t?r.push(e[i].src):r[e[i].src.split("/")[e[i].src.split("/").length-1]]=e[i].src
=======
<<<<<<< HEAD
for(var i=0;i<modules.length;i++){try{eval(window[modules[i]].loaded)}catch(t){Essence.say("The module "+modules[i]+" is not right !","warn"),init(modules[i])}finally{complete&=window[modules[i]].loaded}window[modules[i]].loaded&&this.loadedModules.push(window[modules[i]])}return!!complete},loadedModules:[],updateAll:function(){this.update(),this.isComplete(),this.loadedModules.map(function(t){t.update()})},listModules:function(){var t=moduleList(!0)
t.line(4).get(1)}},modules=[],debugging=!1,$f=function(){},testMode=!1,perfMod=!0,getDirectoryPath=function(t){return t||(t=location.href),t.substring(0,t.indexOf(t.split("/")[t.split("/").length-1]))},gatherScripts=function(t){for(var e=$n("*script"),r=t?[]:{},i=0;i<e.length;i++)t?r.push(e[i].src):r[e[i].src.split("/")[e[i].src.split("/").length-1]]=e[i].src
=======
for(var i=0;i<modules.length;i++){try{eval(window[modules[i]].loaded)}catch(t){Essence.say("The module "+modules[i]+" is not right !","warn"),init(modules[i])}finally{complete&=window[modules[i]].loaded}window[modules[i]].loaded&&this.loadedModules.push(window[modules[i]])}return!!complete},loadedModules:[],updateAll:function(){this.update(),this.isComplete(),this.loadedModules.map(function(t){t.update()})}},modules=[],debugging=!1,$f=function(){},testMode=!1,perfMod=!0,getDirectoryPath=function(t){return t||(t=location.href),t.substring(0,t.indexOf(t.split("/")[t.split("/").length-1]))},gatherScripts=function(t){for(var e=$n("*script"),r=t?[]:{},i=0;i<e.length;i++)t?r.push(e[i].src):r[e[i].src.split("/")[e[i].src.split("/").length-1]]=e[i].src
>>>>>>> develop
>>>>>>> Conflict fixed
...
return e.remove()}
!function(){perfMod&&console.timeStamp("Module Loader init"),debugging&&Essence.say("Initiating the Module Loader"),$require(["Files","DOM","UI","Web","Maths","Ajax","DataStruct","Security","Misc","QTest"]),setTimeout(function(){run(modules,Essence.version.substr(0,3)),perfMod&&console.timeStamp("Modules ran!")},690),setTimeout(function(){if(debugging&&(Essence.isComplete()?Essence.say("Essence is complete !","succ"):Essence.time("List of loaded modules: "+Essence.loadedModules.map(function(t){return t.name}).toStr(!0))),filenameList(gatherExternalScripts(!0)).has("essence.js")||(Essence.source=Essence.source.replace(".js",".min.js")),UnitTest.libTests=[[binarySearch(["hi"," ","dude"]," ","BinarySearch"),!0],[Perm("abc"),["abc","acb","cab","cba","bac","bca"],"Perm"],[unescapeHTML(escapeHTML("<p>Hi</p>")),"<p>Hi</p>","Un(escape)"],[escapeHTML(unescapeHTML("&lt;p&gt;Hi&lt;/p&gt;")),"&lt;p&gt;Hi&lt;/p&gt;","Es(unescape)"],[getDirectoryPath()+stripPath(location.href),location.href,"Path"],[min2dec(dec2min(.56)),.56,"min<->dec"],[toS(s2t(75.23)),75.23,"start<->time"],[isPrime(23),!0,"Prime"],[isPrime(25),!1,"!Prime"],[rmDuplicates("hello world !"),"helo wrd!","NoDuplic"],[unRegExpify(RegExpify("Hi ${name}")),"Hi ${name}","RE<->"],[decrypt(encrypt("Hello",5),-5),"Hello"," de(encrypt)"],[encrypt(decrypt("Hello",-5),5),"Hello","en(decrypt)"],[abcDecode(abcEncode("Lorem")),"Lorem","de(encode)"],[abcEncode(abcDecode("6415180513")),"6415180513","en(decode)"],[ilDecrypt(ilEncrypt("Hello")),"Hello","il-De(En)"],[ilEncrypt(ilDecrypt("Hello")),"Hello","il-En(De)"],[fromFSHA(toFSHA("password")),"password","fromFSHA(to)"],[toFSHA(fromFSHA("password")),"password","toFSHA(from)"]],testMode&&(UnitTest.basicTests(),UnitTest.multiTest(UnitTest.libTests)),debugging&&!Essence.loadedModules.map(function(t){return t.name}).equals(modules)&&Essence.say("The following modules weren't loaded: "+complement(modules,Essence.loadedModules.map(function(t){return t.name}))),Essence.source.has("essence.min"))for(var t=$n("*script").toArray(),e=0;e<t.length;e++)t[e].src.has(".min.js")||t[e].src.replace(".js",".min.js")
perfMod&&console.timeStamp("Module edit")},1e3),perfMod&&console.timeStamp("Module Loading done")}()
...
if(e){if(isType(t,"Array")){for(var i=0;i<t.length;i++)r=r.remove()
...
for(var i=0,n=0;n<r;n++)i+=this[e+n]
...
for(var r=[],i=0;i<t;i++)r.push(this.mean(e,i,i+t-1))
...
for(var r=[],i=0;i<t;i++)r.push(this.mean(e,i,t+i-1))
...
for(var i=0,n=0;n<r;n++)this[e+n]==this.maxOf(e,r)&&this[e+n]==this.minOf(e,r+1)||(i+=this[e+n])
...
for(var r=[],i=0;i<t;i++)r.push(this.avg(e,i,i+t-1))
...
for(var r=[],i=0;i<t;i++)r.push(this.avg(e,i,t+i-1))
...
return e.toNDec(t)},Array.prototype.rand=function(t){if(t&&t>0){for(var e=[],r=0;r<t;r++)e.push(this.rand())
...
for(r=t;r<=n;){for(;this[r]<i;)r++
for(;this[n]>i;)n--
r<=n&&(swap(this,r,n),r++,n--)}t<r-1&&this.quickSort(t,r-1),r<e&&this.quickSort(r,e)}return this},Array.prototype.revSort=function(t,e){t||e||(t=0,e=this.lastIndex())
var r
if(this.length>1){var i=this[Math.floor((e+t)/2)],n=e
for(r=t;r<=n;){for(;this[r]>i;)r++
for(;this[n]<i;)n--
r<=n&&(swap(this,r,n),r++,n--)}t>r-1&&this.revSort(t,r-1),r>e&&this.revSort(r,e)}return this},Array.prototype.bubbleSort=function(t){var e=this,r=1,i=!0
...
for(var i=this[Math.floor((e+t)/2)],n=e,o=t;o<=n;){for(;this[o]<i;)o--
for(;this[n]>i;)n++
o>=n&&(swap(this,o,n),o--,n++)}return t>o-1&&this.cenSort(t,o-1),o>e&&this.cenSort(o,e),r},Array.prototype.setSort=function(){for(var t=[],e=this.length,r=[],i=0;i<1e3;i++)t[i]=0
...
return t?rmDuplicates(e).remove():e},Array.prototype.xclean=function(){return this.clean(!0).remove()},Array.prototype.chg=function(t,e,r){e=e||0,r=r||this.length-1
...
for(var r=0;r<1;r++){e=this[r].get(-1)
for(var i=0;i<this.maxLength()-1;i++)r>0&&Essence.say("#"+i),r>0&&Essence.say(this[r][i]+"<-"+this[this.length-1-i][r]),this[r][i]=this[this.length-1-i][r],r>0&&Essence.say(this[this.length-1-i][r]+"<-"+this[this.length-1-r][this.length-1-i]),this[this.length-1-i][r]=this[this.length-1-r][this.length-1-i],r>0&&Essence.say(this[this.length-1-r][this.length-1-i]+"<-"+this[i][this.length-1-r]),this[this.length-1-r][this.length-1-i]=this[i][this.length-1-r],r>0&&Essence.say(this[i][this.length-1-r]+"<-"+e[i]),this[i][this.length-1-r]=e[i]}}else t===-90?(e=[this[0][0],this[0][1]],this[0][0]=this[0].last(),this[0].last(this.last().last()),this.last().last(this.last()[0]),this.last()[0]=e[0],this[0][1]=this[1].last(),this[1].last(this.last()[1]),this.last()[1]=this[1][0],this[1][0]=e[1]):180===Math.abs(t)&&(e=[this[0][0],this[0][1],this[0].last(),this[1][0]],this[0][0]=this.last().last(),this.last().last(e[0]),this[0].last(this.last()[0]),this.last()[0]=e.last(),this[0][1]=this.last()[1],this.last()[1]=e[1],this[1][0]=this[1].last(),this[1].last(e[3]))}return this},Array.prototype.numElm=function(){return this.linearise().length},Array.prototype.size=function(t){return t?this.length+"x"+this.maxLength():[this.length,this.maxLength()]},Array.prototype.det=function(){var t=0
...
return-1},Array.prototype.divide=function(t){for(var e=new Array(Math.round(this.length/t)).fill(""),r=0,i=0;i<e.length;i++)for(var n=0;n<t;n++)e[i]+=this[r++]
...
for(var e=nthroot(this.length,t,0),r=[],i=0,n=0;n<e;n++){r[n]=[]
for(var o=0;o<e;o++)r[n][o]=this[i++]}return r},Array.prototype.toNcol=function(t){for(var e=[],r=0,i=0;i<this.length/t;i++){e[i]=[]
for(var n=0;n<t;n++)e[i][n]=this[r++]}return e},Array.prototype.toNrow=function(t){for(var e=[],r=0,i=0;i<t;i++){e[i]=[]
...
t=t?t[0].toLowerCase():""
for(var r=0;r<this.length;r++)e[r]="l"===t?this[r].trimLeft():"rad"===t?this[r].trimRight():this[r].trim()
...
for(var n=0;n<r.length;n++)try{isNon(this[t+r[n][0]][e+r[n][1]])||i.push(this[t+r[n][0]][e+r[n][1]])}catch(t){}}else try{isNon(this[t-1])||i.push(this[t-1]),isNon(this[t+1])||i.push(this[t+1])}catch(t){}return i},Array.prototype.sanitise=function(t){for(var e=0;e<this.length;e++)for(var r=0;r<this[e].length;r++)this[e][r]=name2Type(t,this[e][r])
return this},Array.prototype.portion=function(t,e){return this.length%2===0?this.get((e||1)*Math.round(this.length)/(t||2)):this.get(Math.floor((e||1)*Math.floor(this.length)/(t||2)))},Array.prototype.removeFirst=function(t,e){var r=this
...
return e?this.filter(function(e,i){return e!=t||i!=r.lastIndexOf(t)}):this.splice(this.lastIndexOf(t),1)},Array.prototype.binaryIndexOf=function(t){for(var e,r,i,n=0,o=this.length-1;n<=o;)if(i=e=n+o>>1,r=this[e],r<t)n=e+1
...
return this},String.prototype.has=Array.prototype.has,String.prototype.last=function(t){return this.split("").last(t)},String.prototype.splice=function(t,e,r){return t<0&&(t=this.length+t,t<0&&(t=0)),this.slice(0,t)+(r||"")+this.slice(t+e)},String.prototype.remove=function(t){var e=this
if(isType(t,"Array")){for(var r in t)t.hasOwnProperty(r)&&(e=e.remove())
...
return n.join(e)},String.prototype.divide=function(t){for(var e=new Array(Math.round(this.length/t)).fill(""),r=0,i=0;i<e.length;i++)for(var n=0;n<t;n++)e[i]+=this[r++]
...
return e},String.prototype.sameLast=function(t){for(var e="",r=1,i=Math.min(this.length,t.length);r<=i&&this[this.length-r]===t[t.length-r];)e=this[this.length-r]+e,r++
...
return t?r.replace(/(<!--(.*?)-->|\/\*+(.*?)\*+\/)/gm,""):r},String.prototype.portion=function(t,e){return this.split("").portion(t,e).join("")},String.prototype.countWord=function(t,e){return this.split(e||" ").count(t)},Number.prototype.length=function(){if(String(this).has("."))return[parseInt(String(this).split(".")[0].length),parseInt(String(this).split(".")[1].length)]
