...
return t?r.replace(/(<!--(.*?)-->|\/\*+(.*?)\*+\/)/gm,""):r},String.prototype.portion=function(t,e){return this.split("").portion(t,e).join("")},Number.prototype.length=function(){if(String(this).has("."))return[parseInt(String(this).split(".")[0].length),parseInt(String(this).split(".")[1].length)]
