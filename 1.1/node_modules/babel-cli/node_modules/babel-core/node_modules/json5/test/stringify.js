...
exports.stringify.oddities = function test() {
    ...
    assertStringify(Number(7));
    assertStringify(String(7));
    assertStringify(String(""));
    assertStringify(String("abcde"));
    assertStringify(String(String("abcde")));
    assertStringify(Boolean(true));
    assertStringify(Boolean());
};
