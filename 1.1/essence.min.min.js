...
return getDate()+" "+e(t.getHours(),2)+":"+e(t.getMinutes(),2)+":"+e(t.getSeconds(),2)+"."+e(t.getMilliseconds(),2)},i=function(t){return t.split("/")[t.split("/").length-1]},o=function(t,e,r){var i=""
0>e&&!r&&(r=e,e=0),0>r&&(r=t.length+r-1)
for(var o=e||0;o<=(r||t.length-1);o++)i+=t[o]
return i},n=function(){return o(i(location.pathname),-i(location.pathname).lastIndexOf(".")-1)}
if(isType(t,"Array"))for(var s=0;s<t.length;s++)$require(t[s])
else-1===modules.indexOf(t)?(gatherScripts()["essence.min.js"]?include_once(getExtPath(getDirectoryPath(gatherScripts()["essence.min.js"]))+"modules/"+t+".min.js","script"):include_once(getExtPath(getDirectoryPath(gatherScripts()["essence.js"]))+"modules/"+t+".js","script"),modules.push(t),debugging&&console.log("The module %c%s%c is now included into %c%s    "+r(),"color: red; text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",t,"color: #000; text-decoration: none;"," text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",n())):debugging&&console.log("The module %c%s%c is already included into %c%s    "+r(),"color: red; text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",t,"color: #000; text-decoration: none;"," text-decoration: bold; -webkit-text-decoration: bold; -moz-text-decoration: bold;",n())}function run(t,e){if(isType(t,"Array"))for(var r=0;r<t.length;r++)run(t[r],e)
else if(modules.indexOf(t)>-1){var i=function(){try{debugging&&Essence.say("Running "+t+"    "+getTimestamp(!0),"info"),window[t].loaded||window[t].load(),window[t].run()}catch(e){Essence.time("The module %c"+t+"%c have problems regarding it's run method.","color: #c0f","color: #000")}},o=function(e){e||(e=0),Essence.say("The module %c"+t+"%c isn't available !    "+getTimestamp(!0),"erro","color: #c0f","color: #000"),debugging&&Essence.say("Retrying to run %c"+t+"%c    "+getTimestamp(!0),"info","color: #c0f","color: #000"),window[t]?i():2>=e?setTimeout(o(e+1),1):Essence.say("It's not possible to run %c"+t+"%c :( !    "+getTimestamp(!0)+"\nModule: "+window[t],"info","color: #c0f","color: #000"),init(t)}
...
else debugging&&Essence.say("Initiating "+t),-1===modules.indexOf(t)?$require(t):debugging&&Essence.say("The module %c"+t+"%c was already initiated !!","info","color: #c0f","color: #000"),e&&e(o||t),setTimeout(function(){run(t),r&&r(n||t)},1)}function $e(t,e){if(!e)return new Element(t)
try{return new Element(t)}catch(r){return Essence.say('%c$e("'+t+"\")%c isn't there (yet).","warn","color: #f00","color: #000"),null}}function $n(t,e){return e&&isNon($e(t,e))?null:$e(t).node}function Element(t){if(/^([#\.\*_-`~&]\W*|\S|undefined|null|)$/.test(t))throw new InvalidParamError("Element cannot accept the selector '"+t+"' as it's invalid.")
...
break
default:r.scroll(0,1),r.node.scrollTop===r.node.scrollHeight-r.node.offsetTop&&clearInterval(i)}},e||50)},this}function include(t,e){e||(e=t.indexOf(".js")>0?"script":"link")
...
return new Date(e[2],e[1]-1,e[0])}function dateTime(t){var e,r,i=new Date,o=i.getFullYear(),n=i.getMonth(),s=["January","February","March","April","May","June","July","August","September","October","November","December"],a=i.getDate(),h=i.getDay(),l=i.getHours(),c=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],u="",d=i.getTimezoneOffset()
10>l&&(l="0"+l),e=i.getMinutes(),l>12?(l-=12,u="PM"):u="AM",10>e&&(e="0"+e),r=i.getSeconds(),10>r&&(r="0"+r),d=d>=0?"GMT+"+d:"GMT-"+d
var p="We're "+c[h]+" "+a+" "+s[n]+" "+o+" and it's "+l+":"+e+":"+r+" "+u+" "+d
$e("#"+t||"body").write(p),setTimeout('dateTime("'+t+'");',1e3)}function weekDay(t){var e,r=["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],i=parseInt(t.split("/")[0]),o=parseInt(t.split("/")[1]),n=parseInt(t.split("/").last())
...
var o={y:959230512e3,m:2628028800.0000005,w:6048e5,d:864e5,h:36e5,min:6e4,s:1e3,ms:1}
return i?Math.round((e-t)/o[r||"d"]):(e-t)/o[r]}function date2s(t,e,r,i){return 86400*(t||0)+7*(e||0)*86400+30.417*(r||0)*86400+365*(i||0)*30.417*86400}function s2date(t,e){switch(e||(e="d"),e.toLowerCase()[0]){case"w":return t/604800
case"m":return t/(30.417*86400)
case"y":return t/959230512
default:return t/86400}}function genStr(t,e){var r,i="",o=asciiTable("a-z"),n=asciiTable("A-Z"),s=range(9),a=["&","~",'"',"#","'","{","[","(","-","|","`","_","\\","^","@",")","]"," + ","=","}"," % "," * ","?",",",";",".","/",":","!"," "]
r=o.concat(n,s,a)
...
for(var a=0;t>a;a++)i[o][n][s][a]=r}}return i}function numArr(t,e){for(var r=[],i=e||0,o=0;t>o;o++){r[o]=[]
...
this.loadedModules=[]
for(var i=0;i<modules.length;i++){try{eval(window[modules[i]].loaded)}catch(e){Essence.say("The module "+modules[i]+" is not right !","warn"),init(modules[i])}finally{complete&=window[modules[i]].loaded}window[modules[i]].loaded&&this.loadedModules.push(window[modules[i]])}return!!complete},loadedModules:[]},modules=[],debugging=!1,$f=function(){},testMode=!1,getDirectoryPath=function(t){return t||(t=location.href),t.substring(0,t.indexOf(t.split("/")[t.split("/").length-1]))},gatherScripts=function(t){for(var e=$n("*script"),r=t?[]:{},i=0;i<e.length;i++)t?r.push(e[i].src):r[e[i].src.split("/")[e[i].src.split("/").length-1]]=e[i].src
...
for(var r,i=t.split("/"),o=e.split("/"),n=0,s=0,a=function(t,e,r){var i=[]
0>e&&!r&&(r=e,e=0),0>r&&(r=t.length+r-1)
for(var o=e||0;o<=(r||t.length-1);o++)i.push(t[o])
return i.filter(function(t){return void 0!=t})};e.indexOf(i[n])>-1;)n++
for(r=a(i,n).join("/");r.indexOf(o[s])>-1;)console.log("Gone through "+o[s]),s++
...
if(e=e.map(function(e){return e===t?void 0:e}),e.has(void 0)&&e.length>0){var i=[]
...
for(var i=0,o=0;r>o;o++)this[e+o]==this.maxOf(e,r)&&this[e+o]==this.minOf(e,r+1)||(i+=this[e+o])
...
r++}else if(1===t||"d"===t[0].toLowerCase())for(;i;){for(i=!1,o=0;o<=e.length-r;o++)e[o]<e[o+1]&&(e=swap(e,o,o+1),i=!0),o<e.length-(r+1)&&(e[o]<e[o+2]&&(e=swap(e,o,o+2)),e[o+1]<e[o+2]&&(e=swap(e,o+1,o+2),i=!0)),o<e.length-(r+2)&&(e[o]<e[o+3]&&(e=swap(e,o,o+3)),e[o+1]<e[o+3]&&(e=swap(e,o+1,o+3)))
...
var o=this[t]
this[t]=e,this[r]=o}return this},Array.prototype.maxSort=function(){var t=this.median(),e=new Array(this.length),r=this.getIncrement(3),i=this.quartile(1),o=this.quartile(3)
e[0]=this.min(),e.last(this.max()),parseInt(e.length/2)===e.length/2&&(e[e.length/2]=t),parseInt(e.length/4)===e.length/4&&(e[e.length/4]=i),parseInt(3*e.length/4)===3*e.length/4&&(e[3*e.length/4]=o)
...
return this.filter(function(r,i){return r!=t||i!=e.indexOf(t)})},Array.prototype.removeLarst=function(t){var e=this
return this.filter(function(r,i){return r!=t||i!=e.lastIndexOf(t)})},Array.prototype.String.prototype.has=Array.prototype.has,String.prototype.last=function(t){return this.split("").last(t)},String.prototype.remove=function(t){var e=this
if(!isType(t,"Array")){var r=e.split(t).map(function(e){return e===t?void 0:e}).join("")
return r.has(void 0)?e.remove():r}for(var i in t)t.hasOwnProperty(i)&&(e=e.remove(i))},String.prototype.toNDigits=function(t){var e=this
...
for(;i.has(t)||o===this.length;)i=this.replace(t,e),o++
