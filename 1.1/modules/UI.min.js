...
return e?r:"rgb("+r.join(", ")+")"}function rgb2hex(t,e){var i=isType(t,"Array")?t:clrToArr(t),r=function(t){return conv(t,10,16).toNDigits()}
return i=i.map(r),e?i:"#"+i.join("")}function rgb2hsl(t,e){var i,r,n,s=isType(t,"Array")?t:clrToArr(t),o=function(t){return 100*t+.5|0},h=s[0]/255,a=s[1]/255,l=s[2]/255,u=s.max(),d=s.min()
...
case a:i=60*((l-h)/c+2)
break
case l:i=60*((h-a)/c+4)}i/=6}return e?[o(i),100*o(r),100*o(n)]:"hsl("+o(i)+", "+100*o(r)+"%, "+100*o(n)+"%)"}function hsl2rgb(t,e){var i,r,n,s=clrToArr(t),o=function(t){return(t-.5)/100|0},h=o(s[0]),a=o(s[1]),l=o(s[2])
if(0===a)i=r=n=1
else{var u=function(t,e,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?t+6*(e-t)*i:i<.5?e:i<2/3?t+(e-t)*(2/3-i)*6:t},d=l<.5?l*(1+a):l+a-l*a,c=2*l-d
i=u(c,d,h+1/3),r=u(c,d,h),n=u(c,d,h-1/3)}var f=[i,r,n].map(function(t){return Math.min(Math.floor(256*t),255)})
return e?f:"rgb("+f.join(", ")+")"}function rgb2hsv(t,e){var i=isType(t,"Array")?t:clrToArr(t)
...
case g:n=(b-r)/l+2
break
case b:n=(r-g)/l+4}n/=6}return e?[n,s,a]:"hsv("+n+", "+s+"%, "+a+"%)"}function hsv2rgb(t,e){var i,r,n,s=isType(t,"Array")?t:clrToArr(t),o=Math.floor(6*s[0]),h=6*s[0]-o,a=s[2]*(1-s[1]),l=s[2]*(1-h*s[1]),u=s[2]*(1-(1-h)*s[1])
...
break
case 5:i=s[2],r=a,n=l}var d=[i,r,n].map(function(t){return 255*t})
return e?d:"rgb("+d.join(", ")+")"}function getColourType(t){if(!isValid(t,"colour"))throw new InvalidExpressionError(t+" isn't a colour!")
...
var r=0===$e(t).css(e).indexOf("rgb(")?clrToArr($e(t).css(e)):hex2rgb($e(t).css(e),!0),n=new Colour
...
return r+"</select>"+n+"</select>"+s+"</select>"}function initCanvas(t,e){t||(t=500),e||(e=500),null===$n("canvas#essenceCanvas",!0)?print("<canvas id='essenceCanvas' width='"+t+"' height='"+e+"'>Canvas isn't supported by this browser</canvas>",!0):($n("canvas#essenceCanvas").width=t,$n("canvas#essenceCanvas").height=e)}function runCanvas(t,e,i){i||(i=0),t($n("canvas#essenceCanvas").getContext(e||"2d")),i<1&&runCanvas(t,e,i+1)}function clrToArr(t){return"hex"===getColourType(t)?t.get(1).divide((t.length-1)/3):t.get(t.indexOf("(")+1,-1).split(", ")}var UI=new Module("UI","UI stuff",["Maths","DOM"])
