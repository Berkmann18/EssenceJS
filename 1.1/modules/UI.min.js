...
"r"===i?(n.red=255-parseInt(r[0]),n.green=r[1],n.blue=r[2]):"g"===i?(n.red=r[0],n.green=255-parseInt(r[0]),n.blue=r[2]):"b"===i?(n.red=r[0],n.green=r[1],n.blue=255-parseInt(r[2])):"y"===i?(n.red=255-parseInt(r[0]),n.green=255-parseInt(r[1]),n.blue=r[2]):"c"===i?(n.red=r[0],n.green=255-parseInt(r[0]),n.blue=255-parseInt(r[2])):"m"===i?(n.red=255-parseInt(r[0]),n.green=r[1],n.blue=255-parseInt(r[2])):"a"===i||"f"===i||"width"===i?(n.red=255-parseInt(r[0]),n.green=255-parseInt(r[1]),n.blue=255-parseInt(r[2])):(n.red=r[0],n.green=r[1],n.blue=r[2]),n.update(),$e(t).setCSS(e,n.hex)}function colourName2Hex(t){switch(t.normal()){case"aqua":return"#00ffff"
...
return r}function Shape(t,e,i,r){return this.x=t||0,this.y=e||0,this.border=i||1,this.vel=r||new Vector,this.norm=this.vel.getNormal(),this.update=function(){this.x+=this.vel.x,this.y+=this.vel.y,this.norm=this.vel.getNormal()},this.stop=function(){this.vel=this.norm=new Vector},this.toString=function(){return"Shape(x = "+this.x+", y = "+this.y+", border = "+this.border+", velocity = "+this.vel+")"},this.offset=function(t){return"l"===t?this.x-1-this.border:"rad"===t?this.x+1+this.border:"u"===t?this.y-1-this.border:this.y+1+this.border},this.bounce=function(t){this.vel.reflect(t)},this.copy=function(){return new Shape(this.x,this.y,this.b,this.vel)},this.mult=function(t){return this.x*=t,this.y*=t,this},this.div=function(t){return this.x/=t,this.y/=t,this},this.add=function(t){return this.x+=t.x,this.y+=t.y,this},this.sub=function(t){return this.x-=t.x,this.y-=t.y,this},this.draw=function(){},this.getSpeed=function(){return Math.sqrt(Math.pow(this.vel.x,2)+Math.pow(this.vel.y,2))},this}function Box(t,e,i,r,n,s,o,h,a,l){return this.x=t||0,this.y=e||0,this.z=i||0,this.width=r||10,this.height=n||10,this.depth=s||.1,this.borderSize=o||1,this.borderColor=h||"#000",this.borderRadius=l||0,this.color=a||"#fff",this.ratio=(this.height/this.width).toNDigits(),this.ratio3d=[this.ratio,this.height/non0(this.depth),this.width/non0(this.depth)].mean(4),this.draw=function(){},this.erase=function(){},this.rot=function(t,e,i){},this.translate=function(t,e,i){},this.toString=function(){return"Box(x="+this.x+", y="+this.y+", z="+this.z+", width="+this.width+", height="+this.height+", depth="+this.depth+", borderSize="+this.borderSize+", borderColor="+this.borderColor+", borderRadius="+this.borderRadius+", color="+this.color+")"},this}function AABB(t,e,i,r,n,s){return this.x=t||0,this.y=e||this.x,this.width=i||10,this.height=r||this.width,this.border=n||1,this.vel=s||new Vector,this.ratio=this.height/this.width,this.norm=this.vel.getNormal(),this.getPoints=function(){return[new Pt(this.x,this.y),new Pt(this.x+this.width,this.y),new Pt(this.x+this.width,this.y+this.height),new Pt(this.x,this.y+this.height)]},this.equals=function(t){return this.x==t.x&&this.y==t.y&&this.width==t.width&&this.height==t.height&&this.border==t.border&&this.vel.equals(t.vel)},this.toString=function(){return"AABB(x="+this.x+", y="+this.y+", width="+this.width+", height="+this.height+", velocity="+this.vel.toString()+", border="+this.border+")"},this.hit=function(t, e){return"l"===e?t.offset("l")<=this.offset("rad"):"rad"===e?t.offset("rad")>=this.offset("l"):"u"===e?t.offset("u")<=this.offset("d"):"d"===e?t.offset("d")>=this.offset("u"):this.hit(t,"l")||this.hit(t,"rad")||this.hit(t,"u")||this.hit(t,"d")},this.copy=function(){return new AABB(this.x,this.y,this.width,this.height,this.b,this.vel)},this.concat=function(t){this.width=t.x-this.x-this.width,this.height=t.y-this.y-this.height},this.deconcat=function(t){this.width=(t.x-this.x)/2,this.height=(t.y-this.y)/2},this.draw=function(){},this.getPerimeter=function(){return 2*this.width+2*this.height},this.getArea=function(){return this.width*this.height},this.getDiag=function(){return Math.sqrt(Math.pow(this.width,2)+Math.pow(this.height,2))},this}function Circ(t, e, i, r, n){return this.x=t||0,this.y=e||0,this.rad=i||10,this.border=r||1,this.vel=n||new Vector,this.norm=this.vel.getNormal(),this.offset=function(t){return"l"===t?this.x-this.rad:"rad"===t?this.x+this.rad:"u"===t?this.y-this.rad:this.y+this.rad},this.equals=function(t){return this.x===t.x&&this.y===t.y&&this.rad===t.rad&&this.border===t.border&&this.vel.equals(t.vel)},this.toString=function(){return"Circ(x="+this.x+", y="+this.y+", radius="+this.rad+", velocity="+this.vel.toString()+")"},this.hit=function(t, e){return!!t.hit(this,e||"")&&(this.bounce(t.norm),this.update(),!0)},this.draw=function(){},this.getCircumference=function(){return 2*this.rad*Math.PI},this}function Pt(t, e){return this.x=t||0,this.y=e||0,this.vel=new Vector,this.equals=function(t){return this.x===t.x&&this.y===t.y},this.toString=function(){return"Pt(x="+this.x+", y="+this.y+")"},this}function Line(t, e){return this.start=t,this.end=e,this.equals=function(t){return this.start.equals(t.start)&&this.end.equals(t.end)},this.toString=function(){return"Line(start = "+this.start.toString()+", end = "+this.end.toString()+")"},this}function Vector(t, e){return this.prototype=Shape.prototype,this.x=t||0,this.y=e||0,this.toString=function(){return"Vector(x="+this.x+", y="+this.y+")"},this.equals=function(t){return this.x==t.x&&this.y==t.y},this.copy=function(){return new Vector(this.x,this.y)},this.normalise=function(){var t=Math.sqrt(Math.pow(this.x,2)+Math.pow(this.y,2))
...
t&&($G.dnM=!$G.dnM),$G.dnM?e>=21?$e("body").setStyles(["backgroundColor","#000","color","#fff"]):$e("body").setStyles(["backgroundColor","#fff","color","#000"]):Essence.say("You cannot use the day/night mod if it'start disabled.","warn")}function chTab(t){$e("#tab_"+$G.oldTab).rmClass("tabOn"),$e("#tab_"+$G.oldTab).addClass("tabOff"),$e("#tab_"+t).rmClass("tabOff"),$e("#tab_"+t).addClass("tabOn"),$e("#contentTab_"+$G.oldTab).setCSS("display","none"),$e("#contentTab_"+t).setCSS("display","block"),$G.oldTab=t}function moveHTMLRange(t,e){$e("#"+t).write(parseFloat($e("#"+t).val())+(e||1)),$e("#"+t+"_val").write($e("#"+t).val())}function htmlRange(t,e,i,r){if(!t)throw new Error("htmlRange needs to know the id of the element implementing the range")
...
return r+"</select>"+n+"</select>"+s+"</select>"}function initCanvas(t,e){t||(t=500),e||(e=500),null===$n("canvas#essenceCanvas",!0)?print("<canvas id='essenceCanvas' width='"+t+"' height='"+e+"'>Canvas isn't supported by this browser</canvas>",!0):($n("canvas#essenceCanvas").width=t,$n("canvas#essenceCanvas").height=e)}var UI=new Module("UI","UI stuff",["Maths"])
