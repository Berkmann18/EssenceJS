...
console.info("Rules of %s:\n%s",e[t],r.join("\n"))}}function addCSSRule(e,t,i,r){i||(i=document.styleSheets[0]),console.log("Adding %s {%s} to %s",e,t,i)
