...
return e||(e=t),"<label for='"+t+"' id='lbl_"+t+"'>&ensp;</label><br /><input type='text' id='"+t+"' value='"+e+"' onFocus='labelPwSwap(\""+t+'", "'+e+"\")' onBlur='labelPwSwap(\""+t+'", "'+e+"\")' />"}function htmlDate(t,e,i){for(var r="<select name='"+(t?t+"_":"")+" day'>",s="<select name='"+(t?t+"_":"")+" month'>",n="<select name='"+(t?t+"_":"")+" year'>",o=["January","February","March","April","May","June","July","August","September","October","November","December"],h=(new Date).getFullYear(),a=1;32>a;a++)r+="<option value="+a+">"+a+"</option>"
for(a=0;a<o.length;a++)s+="<option value="+(a+1)+">"+o[a]+"</option>"
for(a=e||h-80;(i||h-2)>a;a++)r+="<option value="+a+">"+a+"</option>"
return r+"</select>"+s+"</select>"+n+"</select>"}var UI=new Module("UI","UI stuff",["Maths"])
