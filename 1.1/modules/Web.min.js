...
this.event=null},this.toString=function(){return"server(name="+this.name+", admin="+this.admin+", type="+this.type+", version="+this.version+", maxsize="+this.maxsize+", slots=["+this.slots.toStr(!0)+"])"},this.listeners=Tablify(["processAdded","added","remove","update","fire","reset","storage"],!1),this.on=function(t,e){this.event.type===t&&e(this.event)},Essence.addServer(this),this}function CECheck(t,e,i,s,n){window.defaultStatus="Evalue the connexion and see the downloading speed",e||(e="../img/random2000x2000.jpg"),i||(i=60320),s||(s=100),n||(n=2e4)
var a=new Image
$G.t1=(new Date).getTime(),$G.t2=0,a.src=e+"?t1="+$G.t1,$G.data=a,$e("#"+t).write("Verification in progress..."),setTimeout("CETimer('"+t+"', '"+a+"', 0, "+s+", "+n+", "+i+")",s)}function CETimer(t,e,i,s,n,a){i++,isType(e,"HTMLImageElement")||(e=$G.data),$e("#"+t).write("Verification in progress..."),i*s>=n?$e("#"+t).write(evalDownload(0)):e.complete?($G.t2=(new Date).getTime(),$G.wifi.push((a/($G.t2-$G.t1)).toNDec(3)+"kbps"),$e("#"+t).write(evalDownload(a/($G.t2-$G.t1))),Essence.time("Connexion: "+(a/($G.t2-$G.t1).toNDigits(3)+" kbps")),window.defaultStatus="normal"):setTimeout("CETimer("+t+", "+e+", "+i+", "+s+", "+n+", "+a+")",s)}function evalDownload(t){var e=""
...
return e=t>0&&30>=t?"Excellent":t>30&&60>=t?"Really good":t>60&&100>=t?"Good":t>100&&200>=t?"Okay":t>200&&300>=t?"Poor":t>300&&400>=t?"Bad":"Really bad",e+" ("+t+" ms)"}function evalGigue(t){var e,i=(t||$G.wifi).map(function(t){return getNumFromStr(t)}).stddev()
return i>=0&&5>i?e="Synchronized connexion":i>=5&&10>i?e="Slightly synchronized connexion":i>=10&&(e="Asynchronized connexion"),e+" ("+i+")"}function parseURL(t,e){var i=location.href.split("?")
