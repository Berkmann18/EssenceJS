...
return e=0===t?"No connexion":t>0&&56>=t?"Low debit":t>56&&8e3>=t?"ADSL debit":t>8e3&&2e4>=t?"ADSL2 + ":t>2e4&&5e4>=t?"wire":t>5e4&&1e5>=t?"optical fibre":"Ethernet",e+" ("+t.toNDigits()+" kbps)"}function evalUpload(t){var e=""
return e=0===t?"No connexion":t>0&&56>=t?"Low debit":t>56&&1e3>=t?"ADSL + ":t>1e3&&5e3>=t?"wire":"Ethernet",e+" ("+t.toNDigits()+" kbps)"}function evalPing(t){var e=""
...
return i>=0&&5>i?e="Synchronized connexion":i>=5&&10>i?e="Slightly synchronized connexion":i>=10&&(e="Asynchronous connexion"),e+" ("+i+")"}function parseURL(t,e){var i=location.href.split("?")
