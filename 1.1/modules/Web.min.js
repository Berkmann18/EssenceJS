...
return i>=0&&i<5?e="Synchronized connexion":i>=5&&i<10?e="Slightly synchronized connexion":i>=10&&(e="Asynchronized connexion"),e+" ("+i+")"}function parseURL(t,e){var i=location.href.split("?")
