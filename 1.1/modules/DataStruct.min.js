...
var n=r.pop()
try{if(n.payload===t)return[i,s]}catch(e){return[-1,s]}n.left&&r.push(n.left),n.right&&r.push(n.right),i++,s++}},this.bfs=function(t,i,s){i||(i=0),s||(s=0)
var r=[]
...
for(i.unshift(this);i!=[];){var r=new TreeNode(i.pop())
println(s+">"+r.payload),s+="-"
for(var n in this.childs)this.childs.hasOwnProperty(n)&&i.unshift(n)}},this.toString=function(){var t="TreeNode(payload= "+this.payload+", "
...
return t?i.toString().split(","):i},this}function Set(t){return this.value=(isType(t,"arr")?t:[t])||[],this.size=function(){return this.value.length},this.add=function(t){-1===this.value.indexOf(t)&&(isType(t,"array")?this.value=this.value.concat(t):this.value.push(t))},this.remove=function(t){if(-1!==this.value.indexOf(t))if(isType(t,"array"))for(var i=0;i<t.length;i++)this.remove(t[i])
else this.value=this.value.remove(t)},this.clear=function(){this.value=[]},this.isEmpty=function(){return this.value===[]},this.contains=function(t){if(isType(t,"array")){for(var i=!0,s=0;s<t.length;s++){if(!i)return!1
...
i=i&&this.contains(t.value[s])}return i},this.toString=function(){return"Set("+this.value.toString()+")"},this.subset=function(t,i){return this.value.slice(t,i+1)},this.get=function(t){return this.value[t]},this.first=function(){return this.value[0]},this.last=function(){return this.value[this.value.lastIndex()]},this.min=function(t,i){return this.value.min(t,i)},this.max=function(t,i){return this.value.max(t,i)},this.median=function(t,i){return this.value.max(t,i)},this}function SortedSet(t){return this.value=t||[],this.add=function(t){-1===this.value.indexOf(t)&&(isType(t,"array")?this.value=this.value.concat(t):this.value.push(t)),this.value.quickSort()},this}function Stack(t,i){return this.value=isType(i,"Number")?new Array(i):[],this.limit=i||null,t&&this.value.push(t),this.peek=function(){return this.value.last()},this.ground=function(){return this.value[0]},this.push=function(t){if(this.isFull())throw new Error("Stack overflow !")
...
if(s=a.filter(function(t){return t.f===l?t:void 0})[0],a=a.filter(function(t){return t.f!=l?t:void 0}),s===e){for(r in s)if(s.hasOwnProperty(nodeSuccessor)){nodeSuccessor.f=s.f+h(nodeSuccessor,s)
var c=lookfor(nodeSuccessor,a)
if(-1!=c){if(c=c[0],s.f<a[c]||-1!=lookfor(nodeSuccessor,o)&&s.f<a[lookfor(nodeSuccessor,o)][0])continue
a=a.remove(nodeSuccessor),o=o.remove(nodeSuccessor),nodeSuccessor.parent=s,n=h(nodeSuccessor,e),a.push(nodeSuccessor)}o.push(s)}throw"Solution found !"}}}function A(t,i,s){for(var r=[],n=[t],e=[],h=[0],a=[euclidianDist(t,i)];n.length>0;){var o=n[a.indexOf(a.min())]
if(o===i)return reconPath(e,o,s)
n=n.remove(o),r.push(o)
var u=s.neighbour(o[0],o[1])
Essence.say("neighbour of "+o+":\n"+u.toStr(!0),"info")
for(var l=0;u>l;l++)if(!(r.indexOf(u[l])>-1)){var f=h[r.indexOf(o)]+1
if(-1===r.indexOf(u[l]))n.push(u[l])
else if(f>=h[l])continue}e[l]=o,h[l]=f,a[l]=h[l]+euclidianDist(u[l],i)}}function reconPath(t,i,s){for(var r=[i];i in keyList(t);)i=t[s.lookFor(i)],r.append(i)
return r}function IDAstar(){}function alphabetSort(t){if(!t.isIterable())throw new Error("alphabetSort cannot sort non iterable objects")
...
r++}}return i.trimAll("r")}function occurrenceSort(t){for(var i=rmDuplicates(t),s=[],r=[],n=0;n<i.length;n++)r[n]=t.count(i[n])
for(;i.length>0;)for(n=0;n<i.length;n++)r[n]===r.max()&&(s.push(i[n]),r=r.remove(r[n]),i=i.remove(i[n]))
return s}function binarySearch(t,i){t.quickSort()
for(var s=2,r=t[Math.floor(t.length/s)];r!=i&&s>0;){if(r===i)return!0
s*=2,r=i>r?t[Math.floor(t.length/s)]:t[3*Math.floor(t.length/s)]}return r===i}function Archive(t,i){return this.name=t||"Archive",this.data=i||"",this.dictionnary=[],this.result=[],this.updateDict=function(){for(var t,s=[],r=alphabetSort(i),n=0;n<this.data.length-1;n++)r[n]!=r[n+1]&&s.push(r[n])
...
return this.toString=function(){return"Stream(start="+this.start.toStr(!0)+", formula="+this.formula+", data="+this.data.toStr(!0)+", results="+this.results.toStr(!0)+")"},this}function Graph(t,i,s,r,n){this.labels=s||["x","y"],this.name=r||"Graph",this.dimension=i||new Array(this.labels.length).fill(50),this.equation=new Equation(t),this.data=n?range(0,n,this.dimension[0],Number(n).length()[1]):range(this.dimension[0])
