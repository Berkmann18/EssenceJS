...
var i=[t]
return i.append(t.length>1?Permutation(t.get(-1)):t),console.log("perm="+i),i}function Perm(t){return t.length<=1?t:2==t.length?t.reverse():t[0]+Perm(t.get(1))}function EventTable(t,i){return this.name=t||"Event table",this.sources=i||[getFilename(!0)],this.table=[["Source","Event","Timestamp"]],this.add=function(t){this.table.push([t.source||getFilename(!0),t.event,t.timestamp||(new Date).getTime()]),this.sources.uniquePush(t.source||getFilename(!0))},this.make=function(t,i){var s=(new Date).getTime()
i||(i=1)
