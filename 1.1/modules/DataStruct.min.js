...
n++}}return i.trimAll("r")}function occurrenceSort(t){var i=t.map(function(i){return t.count(i)}),s=rmDuplicates(t),n=new Map(i),r=[]
return s.map(function(i){n.add(t.count(i),i)}),n.forEach(function(t){r.prepend(t)},!0),r}function binarySearch(t,i){t.quickSort()
...
this.keys.add(t),void 0===this.values[t]&&(this.values[t]=[]),this.values[t].push(i||null)},this.clear=function(t){t?this.values[t]=[]:this.keys=new Set},this.has=function(t){for(var i in this.keys)if(this.keys.hasOwnProperty(i)&&this.keys[i].indexOf(t)>-1)return!0
