...
return this.getConnectedVertices().map(i)},this.size=function(){return this.getNetwork().linearise().length},this.distanceFrom=function(t){return euclidianDist(this.pos,t.pos)},this.getNearestVertex=function(){var t=this,i=this.edges.filter(function(i){return i.length===t.edges.map(function(t){return t.length}).min()})
return i.startNode.equals(this)?i.endNode:i.startNode},this}function Edge(t,i,e){this.startNode=t||null,this.endNode=i||null,this.length=e||(isNon(t)||isNon(i)?0:euclidianDist(t.pos,i.pos)),this.line=new Line(t?t.pos:[0,0],i?i.pos:[0,0]),this.toString=function(){return"Edge(startNode="+this.startNode+", endNode="+this.endNode+", length="+this.length+")"},this.draw=function(){this.line.draw()},this.getSurroundingEdges=function(){var t=this.startNode?this.startNode.getNetwork():[]
return t.append(this.endNode?this.endNode.getNetwork():[]),t.map(function(t){return t.edges}).linearise().remove(this,!0)},this.getNeighbours=function(){var t=this.startNode?this.startNode.getConnectedVertices():[]
return t.append(this.endNode?this.endNode.getConnectedVertices():[]),t.map(function(t){return t.edges}).linearise().remove(this,!0)}}function TreeNode(t,i,e){return this.left=i,this.right=e,this.payload=t||0,this.add=function(t,i){this.left=t,this.right=i},this.addLeft=function(t){for(var i=0;i<t.length;i++)0===i?this.left=t[0]:t[i-1].left=t[i]},this.addRight=function(t){for(var i in t)t.hasOwnProperty(i)&&(0===i?this.right=t[0]:t[i-1].right=t[i])},this.traverse=function(){return this.left&&this.left.traverse(),this.right&&this.right.traverse(),this},this.printInOrder=function(){this.left&&this.left.printInOrder(),Essence.addToPrinter(this.payload+"->"),this.right&&this.right.printInOrder(),Essence.addToPrinter("\r\n")},this.printPreOrder=function(){Essence.addToPrinter(this.payload+"->"),this.left&&this.left.printPreOrder(),this.right&&this.right.printPreOrder(),Essence.addToPrinter("\r\n")},this.printPostOrder=function(){this.left&&this.left.printPreOrder(),this.right&&this.right.printPreOrder(),Essence.addToPrinter(this.payload+"->"),Essence.addToPrinter("\r\n")},this.inOrder=function(t,i,e,n){t||(t=""),i||(i="&nbsp;&nbsp;"),e||(e=0),n||(n="|-"),this.left&&this.left.inOrder(t+i,i,e+1,n),println(t+n+this.payload+i+" (depth="+e+")"),this.right&&this.right.inOrder(t+i,i,e+1,n)},this.preOrder=function(t,i,e,n){t||(t=""),i||(i="&nbsp;&nbsp;"),e||(e=0),n||(n="|-"),println(t+n+this.payload+i+" (depth="+e+")"),this.left&&this.left.preOrder(t+i,i,e+1,n),this.right&&this.right.preOrder(t+i,i,e+1,n)},this.postOrder=function(t,i,e,n){t||(t=""),i||(i="&nbsp;&nbsp;"),e||(e=0),n||(n="|-"),this.left&&this.left.postOrder(t+i,i,e+1,n),this.right&&this.right.postOrder(t+i,i,e+1,n),println(t+n+this.payload+i+" (depth="+e+")")},this.getInOrder=function(t){t||(t="->")
var i=""
...
return s}function Kruskal(t){for(var i=[],e=t.edges[0].getSurroundingEdges();e.length>0;){var n=e.filter(function(t){return t.length===e.map(function(t){return t.length}).min()}).map(function(t){return t.length})[0],r=n.startNode.edges.remove(this,!0),s=n.endNode.edges.remove(this,!0),h=(r.map(function(t){return[t.startNode,t.endNode]}).linearise(),s.map(function(t){return[t.startNode,t.endNode]}).linearise()),a=rmDuplicates(r.concat(h)).filter(function(t){return!t.startNode.equals(t.endNode)&&(!t.startNode.equals(n.startNode)||!t.endNode.equals(n.startNode)||t.startNode.equals(n.endNode)||!t.endNode.equals(n.endNode))})
n.startNode!=n.endNode&&a.length>0&&i.push(n)}return i}function Dijkstra(t,i){i||(i=t.getNetwork())
for(var e=[],n={},r={},s=0;s<i.length;s++){var h=i[s]
n[h]=1/0,r[h]=void 0,e.push(h)}for(n[t]=0;e.length>0;){var a=e.filter(function(t){return e.filter(function(t){return n[t]===e.map(function(t){return n[t]}).min()}).has(t)})[0]
e.remove(a)
var o=a.getConnectedVertices()
for(s=0;s<o.length;s++)if(e.has(o[s])){var u=n[a]+a.distanceFrom(o[s])
u<n[o[s]]&&(n[o[s]]=u,r[o[s]]=a)}}return{dist:n,prev:r}}function Prim(t){for(var i=[t],e=t;!i.has(e.getNearestVertex());)e=e.getNearestVertex(),i.push(e)
return i}function TableSort(t,i,e){i||(i=0)
