...
for(i.unshift(this);i!=[];){var r=new NTreeNode(i.pop())
println(s+">"+r.payload),s+="-"
for(var n in this.childs)this.childs.hasOwnProperty(n)&&i.unshift(n)}},this.toString=function(){var t="NTreeNode(payload= "+this.payload+", "
...
s*=2,r=i>r?t[Math.floor(t.length/s)]:t[3*Math.floor(t.length/s)]}return r===i}function Archive(t,i){return this.name=t||"Archive",this.data=i||"",this.dictionary=[],this.result=[],this.updateDict=function(){for(var t,s=[],r=alphabetSort(i),n=0;n<this.data.length-1;n++)r[n]!=r[n+1]&&s.push(r[n])
...
return this.toString=function(){return"Graph(name="+this.name+", labels="+this.labels.toStr(!0)+", dimension="+this.dimension+", this.equation="+this.equation.toString()+", data="+this.data+")"},this}function Permutation(t){console.log("data="+t),console.log("->"+t.get(-1))
var i=[t]
...
this.forEach(function(r){s.replace(r,t,i)})},this}var DataStruct=new Module("DataStruct","Data structures",["DOM","Maths","Files"])
