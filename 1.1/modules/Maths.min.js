...
return rand(a,n,e)}function lenRand(r,t){return t?Math.floor(Math.random()*(r+1)):Math.floor(Math.random()*r)}function random16(){return(65280*Math.random()+255*Math.random())/65535}function randFloatSpread(r){return r*(.5-Math.random())}function genNearlySortedArr(r,t,e){var n,a=range(t,1,e).slice(0,r),o=[]
n=a.getIncrement(0)
...
return n=conv(e.join("")),n++,t?conv(n,10,2).split(""):conv(n,10,2)}function floatingPtBin(r){var t,e,n=1===r[0]?-1:1
switch(r.length){case 8:t=(1===r[1]?1:-1)*conv(r.get(2,3),2),e=r.get(4),e=e[0]*Math.pow(2,-1)+e[1]*Math.pow(2,-2)+e[2]*Math.pow(2,-3)+e[3]*Math.pow(2,-4)
break
case 16:break
case 32:break
case 64:break
default:throw new Error("Unvalid binary number")}return n*Math.pow(2,t)*e}function min2dec(r){return 50*r/30}function dec2min(r){return 30*r/50}function toS(r){if(r==parseFloat(r))return parseFloat(r)
var t=2===r.count(":")
...
return n.toNDec(4)}function StdNorm(r,t,e){return Norm((e-r)/t)}function Po(r,t){return Math.exp(-r)*Math.pow(r,t)/factorial(t).toNDec(4)}function PoCumul(t,e){for(var n=[],a=0;a<r;a++)n.push(Po(t,e))
...
return n=Math.pow(a*(1-t),.5),.5*(1+erf((e-a)/(n*Math.pow(2,.5))))}function clamp(r,t,e){return t>r?t:r>e?e:r}function revClamp(r,t,e){return r>=t&&e>=r?getClosest(r,[t,e]):r}function clampBottom(r,t){return t>r?t:r}function clampTop(r,t){return r>t?t:r}function mapLinear(r,t,e,n,a){return n+(r-t)*(a-n)/(e-t)}function deg2rad(r){return r*Math.PI/180}function rad2deg(r){return 180*r/Math.PI}function cels2fahr(r){return 33.8*r}function fahr2cels(r){return r/33.8}function primeN(r){for(var t=r.quickSort(),e=0;e<r.length;e++){r[e]%2===0&&2!=r[e]&&(t[e]="x")
...
return a}function fisherYatesShuffle(r){for(var t=r.length;t>0;)r.hasOwnProperty(t)&&swap(r,t,Math.floor(Math.random()*t--))
...
for(var o in r)r.hasOwnProperty(o)&&(t.indexOf(r[o])>-1&&isNon(e)?a.push(r[o]):t.indexOf(r[o])>-1&&e.indexOf(r[o])>-1&&a.push(r[o]))
...
return e}function readCoord(r,t){var e=r.slice(1,r.length-1).split(", ")
return t?[parseInt(e[0]),parseInt(e[1])]:e}function abcClamp(r){return 32===r?32:revClamp(clamp(r,65,122),90,97)}function modRange(r,t,e){var n=r%(e+1)
...
while(n<=conv(t))
return e}function truthTable(exp){for(var ascii=asciiTable("a-z"),vars=[],rows,res=[],i=0;i<ascii.length;i++)exp.indexOf(ascii[i])>-1&&vars.push(ascii[i])
...
return t}var Maths={name:"Maths",version:1,run:function(){},description:"Maths stuff",dependency:["Misc"],author:"Maximilian Berkmann",complete:!1,toString:function(){return"Module(name='"+this.name+"', version="+this.version+", description='"+this.description+"', author='"+this.author+"', complete="+this.complete+", run="+this.run+")"}}
!function(){Maths.complete=!0}()
var s2t=sec2time
