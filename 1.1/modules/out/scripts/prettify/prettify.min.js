...
return t(e),{a:a.join("").replace(/\n$/,""),c:i}}function n(e,t,n,r){t&&(e={a:t,d:e},n(e),r.push.apply(r,e.e))}function r(t,r){function a(e){for(var t=e.d,c=[t,"pln"],u=0,d=e.a.match(s)||[],p={},h=0,f=d.length;f>h;++h){var g,m=d[h],y=p[m],v=void 0
if("string"==typeof y)g=!1
else{var w=i[m.charAt(0)]
if(w)v=m.match(w[1]),y=w[0]
else{for(g=0;l>g;++g)if(w=r[g],v=m.match(w[1])){y=w[0]
...
v[2]&&(S=m.length-v[2].length,b=S-g.length),y=y.substring(5),n(t+w,m.substring(0,b),a,c),n(t+w+b,g,o(y,g),c),n(t+w+S,m.substring(S),a,c)}else c.push(t+w,y)}e.e=c}var s,i={}
...
break}h||((h=(h=a.className.match(/\blinenums\b(?::(\d+))?/))?h[1]&&h[1].length?+h[1]:!0:!1)&&s(a,h),u={g:i,h:a,i:h},l(u))}}d<r.length?setTimeout(t,250):e&&e()}for(var n=[document.getElementsByTagName("pre"),document.getElementsByTagName("code"),document.getElementsByTagName("xmp")],r=[],a=0;a<n.length;++a)for(var i=0,o=n[a].length;o>i;++i)r.push(n[a][i])
var n=q,c=Date
