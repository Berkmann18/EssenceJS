...
return r}function Person(t,e,r,s,n,a,i,o,c,h,u,g,l,y){return this.firstName=t||"",this.secondName=e||"",this.lastName=r||"",this.title=s||"",this.nickname=n||"",this.phoneNum=a||"none",this.country=i||"",this.city=o||"",this.sex="male"===c.toLowerCase()||"female"===c.toLowerCase()?c:"other",this.birthday=h||"01/01/2000",this.deathday=null,this.jobs=u||"unemployed",this.activities=g||"none",this.websites=l||"none",this.quote=y||"",this.toString=function(){var t="Person("
...
case"RegExp":return RegExp(e,arguments.toArray().get(2))
...
case"Item":return Item(e,arguments.toArray().get(2))
...
case"Machine":return Machine(e,arguments.toArray().get(2))
...
var e,r,s=this.PADCHAR,n=this.ALPHA,a=this.gb,i=[]
t+=""
...
break
case 2:r=a(t,e)<<16||a(t,e+1)<<8,i.push(n.charAt(r>>18)+n.charAt(r>>12&63)+n.charAt(r>>6&63)+s)}return i.join("")}}
