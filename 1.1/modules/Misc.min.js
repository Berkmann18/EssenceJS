...
this.db.set(e,s[0],s[1]+(isType(t,"Number")?2:1)),r&&this.db.set(r,s[0],s[1]),this.rules=this.db.val},this.addRule=function(t,e){this.db.add([t,e]),this.rules=this.db.val},this.removeRule=function(t){this.db.remove(this.db.find(t)),this.rules=this.db.val},this.update=function(){this.db.update(),this.db.build(),this.rules=this.db.val},this.save=function(){this.db.save(),this.rules=this.db.val},this.findRule=function(t){return this.db.find(t)},this.verify=function(rule,val){var pos=this.findRule(rule)
