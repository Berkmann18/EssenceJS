...
for(var r=[],s=t;s<=e;s++)r.push(String.fromCharCode(s))
return r}function Person(t,e,r,s,n,i,a,o,c,h,u,l,g,y){return this.firstName=t||"",this.secondName=e||"",this.lastName=r||"",this.title=s||"",this.nickname=n||"",this.phoneNum=i||"none",this.country=a||"",this.city=o||"",this.sex="male"===c.toLowerCase()||"female"===c.toLowerCase()?c:"other",this.birthday=h||"01/01/2000",this.deathday=null,this.jobs=u||"unemployed",this.activities=l||"none",this.websites=g||"none",this.quote=y||"",this.toString=function(){var t="Person("
for(var e in this)this.hasOwnProperty(e)&&"toString"!=e&&"toName"!=e&&(t+=e+"="+this[e]+", ")
return t.substring(0,t.length-2)+")"},this.genID=function(){return(this.lastName.get(0,3)+this.birthday.split("/")[1]+this.firstName.get(0,1)+this.secondName.get(0,1)+this.birthday.split("/")[2]+this.sex[0]).toUpperCase()},this.getAge=function(){return(date2num(getDate())-date2num(this.birthday)).toNDec(2)},this.isMajor=function(){return("UN"===this.country.get(0,1)||"united states"===this.country.toLowerCase())&&this.getAge()>20||("UN"!=this.country.get(0,1)||"united states"!=this.country.toLowerCase())&&this.getAge()>17},this.getFullName=function(){return this.firstName+" "+this.secondName+(""!=this.nickname?' "'+this.nickname+'" ':" ")+this.lastName},this}function Item(t,e,r,s,n){return this.name=t||"unknown",this.category=e||"unknown",this.price=r||0,this.ageMinRequired=s||.25,this.quantity=n||1,this.firstMade=(new Date).toLocaleString(),this.duplicate=function(t,e){for(var r=0;r<t;r++)e.push(new Item(this.name,this.category,this.price,this.ageMinRequired,this.quantity))},this.remove=function(t){isType(t,"Array")?t=t.remove():t.remove()},this.toString=function(){var t=""
for(var e in this)this.hasOwnProperty(e)&&"toString"!=e&&!isType(e,"Function")&&(t+=e+"="+this[e]+", ")
return t.substring(0,t.length-2)},this}function letterArray(t,e){for(var r=t.charCodeAt(0)||97,s=e.charCodeAt(0)||122,n=[],i="",a=r;a<=s;a++)for(var o=r;o<=s;o++)a!=o&&(i=String.fromCharCode(a)+String.fromCharCode(o),n.push(i))
return n}function rmConsecDuplicates(t){for(var e=[],r=0,s=0;s<t.length;s++)0!==s&&t[s].equals(t[s-1])||(e[r++]=t[s])
for(r=0,s=0;s<t.length-1;s++)t[s].equals(t[s+1])||(e[r++]=t[s])
return e}function rmDuplicates(t){if(!t.isIterable())throw new TypeError("It's not possible to remove duplicates of a non iterable object.")
for(var e=[],r=0;r<t.length;r++)e.has(t[r])||e.push(t[r])
return isType(t,"Array")?e:e.join("")}function rmUniques(t){if(!t.isIterable())throw new TypeError("It's not possible to remove uniques of a non iterable object.")
var e=rmDuplicates(t.filter(function(e){return t.count(e)>1}))
return isType(t,"Array")?e:e.join("")}function Machine(t,e,r,s){switch(this.capacity=r||1024,this.version=e||5,this.name=t||"Machine_"+this.version,this.version){case 1:this.base=2
break
case 2:this.base=3
break
case 3:this.base=8
...
case"||":return t||e
case"&&":return t&&e
case"end":return t*Math.pow(10,e)
case"end^":case"exp":return[Math.exp(t),Math.exp(e)]
...
return Essence.say(r),JSON.parse(e)},this.unparse=function(t,e){for(var r=JSON.stringify(t),s="",n=[],i=0;i<r.length;i++)n[i]=r.charCodeAt(i),s+=2===this.base?conv(r.charCodeAt(i).toNDigits(),10,this.base):conv(r.charCodeAt(i),10,this.base)
...
else for(t in sessionStorage)sessionStorage.hasOwnProperty(t)&&t.has(this.name)&&sessionStorage.removeItem(t)},this.add=function(t){this.slots[this.free++]=JSON.stringify(t)},this.print=function(){Essence.say(this.name+"'start slots: ","info")
...
case"Vertex":return Vertex(e,arguments.toArray().get(2))
...
return e}function arrayLiteral(t,e){return t.length>1?t.get(-1).toStr(!0)+" "+(e||"and")+" "+t.last():t[0]}function moduleList(t,e){var r=[["Name","Version","Description","Dependencies","Weight"]]
return e&&r[0].pop(),t&&r[0].push("Used by"),Essence.loadedModules.map(function(s){t?r.push([s.name,s.version,s.description,s.dependency.toStr(!0),s.getWeight(),s.getUsage()]):e?r.push([s.name,s.version,s.description,s.dependency.toStr(!0)]):r.push([s.name,s.version,s.description,s.dependency.toStr(!0),s.getWeight()])}),r}function Scoreboard(t,e,r,s){this.name=t||"Scoreboard",this.participants=e,this.maxScore=s||10,this.events=r,this.build=function(){this.table=[],this.table.push([""].append(this.participants))
...
e.table[e.events.length+1][r+1]=e.table.line(r+1).get(1,-1).sum().toNDec(t)}return e},this.toString=function(){return"Scoreboard(name="+this.name+", participants="+this.participants.toStr(!0)+"; maxScore="+this.maxScore+", events="+this.events.toStr(!0)+")"}}function anim(t,e,r,s,n,i){t||(t="Loading"),e||(e=0),r||(r=1e4),s||(s=800)
var a=n?["-","\\","|","/"]:["",".","..","..."],o=0,c=[],h=function(){return c.map(function(t){clearTimeout(t)}),console.clear(),console.log("Done !"),!0}
return i?h():(a.map(function(r){c.push(setTimeout(function(){console.clear(),console.log(t+" "+r)},e+o*s)),o++}),e+=2*s,e<=r||!i?void setTimeout(function(){anim(t,e,r,s,n,e>r)},2*s):h())}function AI(rules){return this.rules=rules||[[0,"",null]],this.db=new DB("AI rules",["Index","Rules","Precision"],this.rules),this.db.init(),this.updateRule=function(t,e,r){var s=this.db.find(t)
this.db.set(e,s[0],s[1]+(isType(t,"Number")?2:1)),r&&this.db.set(r,s[0],s[1]),this.rules=this.db.val},this.addRule=function(t,e){this.db.add([t,e]),this.rules=this.db.val},this.removeRule=function(t){this.db.remove(t),this.rules=this.db.val},this.update=function(){this.db.update(),this.db.build(),this.rules=this.db.val},this.save=function(){this.db.save(),this.rules=this.db.val},this.findRule=function(t){return this.db.find(t)},this.verify=function(rule,val){var pos=this.findRule(rule)
return eval(this.rules[pos[0]][pos[1]+1].replace("x",val))},this}function clearEnv(){$e("body").write(""),console.clear()}function camelCaseTo(t,e){switch(e.toLowerCase()){case"hyphen":case"-":return t.replace(/[A-Z]+/g,function(t){return"-"+t.toLowerCase()})
case"pascalcase":case"pascal":return t.capitalize()
case"underscore":case"_":return t.replace(/[A-Z]+/g,function(t){return"_"+t.toLowerCase()})
case"english":case"spaced":return t.replace(/[A-Z]+/g,function(t){return" "+t.toLowerCase()}).trim()
default:return t}}var Misc=new Module("Misc","Miscellaneous",["Files","DataStruct","Ajax"]),base64={PADCHAR:"=",ALPHA:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",getbyte64:function(t,e){if(e=base64.ALPHA.indexOf(t.charAt(e||0)),e===-1)throw"Cannot decode base64"
return e},decode:function(t){t+=""
var e,r,s,n=t.length
if(0===n)return t
if(n%4!=0)throw"Cannot decode base64"
e=0,t.charAt(n-1)===this.PADCHAR&&(e=1,t.charAt(n-2)===this.PADCHAR&&(e=2),n-=4)
var i=[]
for(r=0;r<n;r+=4)s=this.getbyte64(t,r)<<18|this.getbyte64(t,r+1)<<12|this.getbyte64(t,r+2)<<6|this.getbyte64(t,r+3),i.push(String.fromCharCode(s>>16,s>>8&255,255&s))
switch(e){case 1:s=this.getbyte64(t,r)<<18|this.getbyte64(t,r+1)<<12|this.getbyte64(t,r+2)<<6,i.push(String.fromCharCode(s>>16,s>>8&255))
break
case 2:s=this.getbyte64(t,r)<<18|this.getbyte64(t,r+1)<<12,i.push(String.fromCharCode(s>>16))}return i.join("")},getbyte:function(t,e){var r=t.charCodeAt(e||0)
...
var e,r,s=[]
t+=""
var n=t.length-t.length%3
if(0===t.length)return t
for(e=0;e<n;e+=3)r=this.getbyte(t,e)<<16||this.getbyte(t,e+1)<<8||this.getbyte(t,e+2),s.push(this.ALPHA.charAt(r>>18)),s.push(this.ALPHA.charAt(r>>12&63)),s.push(this.ALPHA.charAt(r>>6&63)),s.push(this.ALPHA.charAt(63&r))
switch(t.length-n){case 1:r=this.getbyte(t,e)<<16,s.push(this.ALPHA.charAt(r>>18)+this.ALPHA.charAt(r>>12&63)+this.PADCHAR.repeat(2))
break
...
var Calendar={element:$e("#calendar",!0),leapYear:function(t){return t%4==0},getDays:function(t,e){return[31,this.leapYear(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]},getMonthName:function(t){return["January","February","March","April","May","June","July","August","September","October","November","December"][t]},set:function(){var t=new Date,e=t.getYear(),r=t.getMonth(),s=t.getDate()
e<1e3&&(e+=1900)
var n=this.getMonthName(r),i=this.getDays(r,e),a=new Date(e,r,1),o=a.getDay()
null===this.element&&(print("<div id='calendar'></div>",!0),this.element=$e("#calendar")),this.draw(o+1,i,s,n,e)},draw:function(t,e,r,s,n){var i="<table cellspacing=4><th colspan=7>"+s+" "+n+"</th>",a=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],o=1,c=1
i+="<tr align='center' valign='center'>"
for(var h=0;h<7;h++)i+="<td>"+a[h]+"</td>"
i+="</tr>"
for(var u=1;u<=Math.ceil((t+t-1)/7);u++){i+="<tr align='right' valign='top'>"
for(var l=1;l<=7;l++)c<t?(i+="<td></td>",c++):(i+=o===r?"<td><span style='color: red'>"+o+"</span></td>":"<td>"+o+"</td>",o++)
i+="</tr>"}i+="</table>",this.element.write(i,!0)}}
