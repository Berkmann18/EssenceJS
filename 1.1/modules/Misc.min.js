...
return r}function Person(t,e,r,s,a,n,i,o,c,h,u,g,y,l){return this.firstName=t||"",this.secondName=e||"",this.lastName=r||"",this.title=s||"",this.nickname=a||"",this.phoneNum=n||"none",this.country=i||"",this.city=o||"",this.sex="male"===c.toLowerCase()||"female"===c.toLowerCase()?c:"other",this.birthday=h||"01/01/2000",this.deathday=null,this.jobs=u||"unemployed",this.activities=g||"none",this.websites=y||"none",this.quote=l||"",this.toString=function(){var t="Person("
for(var e in this)this.hasOwnProperty(e)&&"toString"!=e&&"toName"!=e&&(t+=e+"="+this[e]+", ")
return t.substring(0,t.length-2)+")"},this.genID=function(){return(this.lastName.get(0,3)+this.birthday.split("/")[1]+this.firstName.get(0,1)+this.secondName.get(0,1)+this.birthday.split("/")[2]+this.sex[0]).toUpperCase()},this.getAge=function(){return(date2num(getDate())-date2num(this.birthday)).toNDec(2)},this.isMajor=function(){return("UN"===this.country.get(0,1)||"united states"===this.country.toLowerCase())&&this.getAge()>20||("UN"!=this.country.get(0,1)||"united states"!=this.country.toLowerCase())&&this.getAge()>17},this.getFullName=function(){return this.firstName+" "+this.secondName+(""!=this.nickname?' "'+this.nickname+'" ':" ")+this.lastName},this}function Item(t,e,r,s,a){return this.name=t||"unknown",this.category=e||"unknown",this.price=r||0,this.ageMinRequired=s||.25,this.quantity=a||1,this.firstMade=(new Date).toLocaleString(),this.duplicate=function(t,e){for(var r=0;t>r;r++)e.push(new Item(this.name,this.category,this.price,this.ageMinRequired,this.quantity))},this.remove=function(t){t.remove(this)},this.toString=function(){var t=""
for(var e in this)this.hasOwnProperty(e)&&"toString"!=e&&!isType(e,"function")&&(t+=e+"="+this[e]+", ")
return t.substring(0,t.length-2)},this}function letterArray(t,e){for(var r=t.charCodeAt(0)||97,s=e.charCodeAt(0)||122,a=[],n="",i=r;s>=i;i++)for(var o=r;s>=o;o++)i!=o&&(n=String.fromCharCode(i)+String.fromCharCode(o),a.push(n))
return a}function rmConsecDuplicates(t){for(var e=[],r=0,s=0;s<t.length;s++)0!==s&&t[s]==t[s-1]||(e[r++]=t[s])
...
return Essence.say(r),JSON.parse(e)},this.unparse=function(t,e){for(var r=JSON.stringify(t),s="",a=[],n=0;n<r.length;n++)a[n]=r.charCodeAt(n),s+=2===this.base?conv(r.charCodeAt(n).toNDigits(8),10,this.base):conv(r.charCodeAt(n),10,this.base)
...
return r}function Tablify(t,e){return Objectify(t,new Array(t.length).fill(e||[]).map(function(){return e||[]}))}function name2type(t,e){switch(t){case"Number":return Number(e)
...
return e}function arrayLiteral(t,e){return t.length>1?t.get(-1).toStr(!0)+" "+(e||"and")+" "+t.last():t[0]}var Misc=new Module("Misc","Miscellaneous",["Files"]),base64={PADCHAR:"=",ALPHA:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 + /",getbyte64:function(t,e){if(e=base64.ALPHA.indexOf(t.charAt(e||0)),-1===e)throw"Cannot decode base64"
return e},decode:function(t){t+=""
var e,r,s,a=this.getbyte64,n=t.length
if(0===n)return t
if(n%4!=0)throw"Cannot decode base64"
e=0,t.charAt(n-1)===base64.PADCHAR&&(e=1,t.charAt(n-2)===base64.PADCHAR&&(e=2),n-=4)
var i=[]
for(r=0;n>r;r+=4)s=a(t,r)<<18|a(t,r+1)<<12|a(t,r+2)<<6|a(t,r+3),i.push(String.fromCharCode(s>>16,s>>8&255,255&s))
switch(e){case 1:s=a(t,r)<<18|a(t,r+1)<<12|a(t,r+2)<<6,i.push(String.fromCharCode(s>>16,s>>8&255))
break
case 2:s=a(t,r)<<18|a(t,r+1)<<12,i.push(String.fromCharCode(s>>16))}return i.join("")},getbyte:function(t,e){var r=t.charCodeAt(e||0)
