...
return r}function Person(t,e,r,s,a,n,i,o,c,h,u,l,g,y){return this.firstName=t||"",this.secondName=e||"",this.lastName=r||"",this.title=s||"",this.nickname=a||"",this.phoneNum=n||"none",this.country=i||"",this.city=o||"",this.sex="male"===c.toLowerCase()||"female"===c.toLowerCase()?c:"other",this.birthday=h||"01/01/2000",this.deathday=null,this.jobs=u||"unemployed",this.activities=l||"none",this.websites=g||"none",this.quote=y||"",this.toString=function(){var t="Person("
...
e.table[e.events.length+1][r+1]=e.table.line(r+1).get(1,-1).sum().toNDec(t)}return e},this.toString=function(){return"Scoreboard(name="+this.name+", participants="+this.participants.toStr(!0)+"; maxScore="+this.maxScore+", events="+this.events.toStr(!0)+")"}}var Misc=new Module("Misc","Miscellaneous",["Files"]),base64={PADCHAR:"=",ALPHA:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 + /",getbyte64:function(t,e){if(e=base64.ALPHA.indexOf(t.charAt(e||0)),-1===e)throw"Cannot decode base64"
