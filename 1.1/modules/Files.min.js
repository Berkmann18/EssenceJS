...
for(var n,r=t.split("/"),i=e.split("/"),o=0,s=0;e.has(r[o]);)o++
for(n=r.get(o).join("/");n.has(i[s]);)console.log("Gone through "+i[s]),s++
...
var n="",r=e?new CORS(t,"GET",!1,function(t){return n=t.responseText,t.responseText},function(){return"Nothing"}):new XHR(t,"GET",!1,function(t){return n=t.responseText,t.responseText},function(){return"Nothing"})
return r.init(),n}function evalFile(t){return new Function("return "+getFileContent(t))()}function getKeywords(t,e){var n=(isType(t,"Array")?t.join(" "):t).replace(/(\.|!|\?|;|:|"|,|\t|\n|\f|\r|\v|\{|})+/gm," ").split(" ").remove(""),r=occurrenceSort(n).filter(function(t){return e&&["=","+","-","*","/","\\","%","#","'","@","^","$","£","µ","~","&","[","]","(",")","|","`"].has(t)?!1:n.count(t)>3})
return r.map(function(t){return t+": "+n.count(t)+" ("+markConv(n.count(t),n.length)+"%)"})}function Spider(t){return this.dir=t||[],this.keywords=[],this.get=function(t,e){for(var n=0;n<this.dir.length;n++)this.keywords[n]=getKeywords(getFC(this.dir[n],e),!t)
...
return getKeywords(n,!t)},this.toString=function(){return"Spider(dir="+this.dir+", keywords= "+this.keywords.toStr(!0)+")"},this}var Files=new Module("Files","File management and control",["Ajax"])
