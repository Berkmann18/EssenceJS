...
for(var n=t.split("/"),i="",r=e.split("/"),o=0,a=0;e.indexOf(n[o])>-1;)o++
for(i=n.get(o).join("/");i.indexOf(r[a])>-1;)console.log("Gone through "+r[a]),a++
if(a>0)for(o=0;a>o;o++)i="../"+i
return i}function getExtPath(t){var e=location.href,n=e.sameFirst(t),i=getCurrentPath(t,n),r="../".repeat(i.count("/"))
return r+getCurrentPath(t,n)}function filenameList(t){for(var e=[],n=0;n<t.length;n++)e.push(stripPath(t[n]))
...
return e.open("GET",t,!1),e.onreadystatechange=function(){return 4!==e.readyState||200!==e.status&&0!=e.status?void 0:($G.fct=e.responseText,e.responseText)},e.send(null),$G.fct}function evalFile(t){return new Function("return "+getFileContent(t))()}function getKeywords(t,e){var n,i,r=t.replace(/(\.|!|\?|;|:|"|,|\t|\n|\f|\r|\v|\{|})+/gm," ").split(" ").remove("")
return n=occurrenceSort(r).filter(function(t){return e&&["=","+","-","*","/","\\","%","#","'","@","^","$","£","µ","~","&","[","]","(",")","|","`"].indexOf(t)>-1?!1:r.count(t)>2}),i=n.map(function(t){return r.count(t)}),n.map(function(t){return t+": "+r.count(t)+" ("+markConv(r.count(t),r.length)+"%)"})}function Spider(t){return this.dir=t||[],this.idx="",this.keywords=[],this.getKeywords=function(t){for(this.idx=0;this.idx<this.dir.length;this.idx++)this.keywords[this.idx]=getKeywords(getFileContent(this.dir[this.idx]),!t)
return this.keywords},this.getGlobalKeywords=function(t){var e=this.dir.map(function(t){return getFileContent(t)}).toStr()
return getKeywords(e,!t)},this.toString=function(){return"Spider(dir="+this.dir+", idx="+this.idx+", keywords= "+this.keywords.toStr(!0)+")"},this}var Files={name:"Files",version:1,run:function(){},description:"File management and control",dependency:[],author:"Maximilian Berkmann",complete:!1,toString:function(){return"Module(name='"+this.name+"', version="+this.version+", description='"+this.description+"', author='"+this.author+"', complete="+this.complete+", run="+this.run+")"}}
