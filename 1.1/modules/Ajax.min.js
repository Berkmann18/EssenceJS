function GET(e){return e===new RegExp("[?&]"+encodeURIComponent(e)+"=([^&]*)").exec(location.search)?decodeURIComponent(e[1]):void 0}function POST(e,t){var s=document.createElement("form")
