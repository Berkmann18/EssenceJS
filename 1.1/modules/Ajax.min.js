...
n.setAttribute("type","hidden"),n.setAttribute("name",r),n.setAttribute("value",t[r]),s.appendChild(n)}document.body.appendChild(s),s.submit()}function PUT(e,t){var s=new XHR(t,"PUT",!0,$f,$f,$f,e)
s.init()}function DELETE(e,t){var s=new XHR(t,"DELETE",!0,$f,$f,$f,e)
s.init()}function load(e,t){var s=new XHR(e,"GET",!0,t)
...
var u=this
return this.req.onreadystatechange=function(){u.state=getXHRMsg(u.req.readyState),u.handleResponse(),u.status!=u.req.status&&(u.status=u.req.status),4!==u.req.readyState||200!==u.req.status&&204!==u.req.status?3===u.req.readyState?u.onLoad(this):u.req.status>=400&&u.req.status<=505&&u.onFailure(this):u.onSuccess(this)},this.onChange=this.req.onreadystatechange,this.onSuccess=r||function(){u.handleResponse(),console.log("%c[XHR] %start%c:\n%start","color: #0f0",u.status+" "+getHTTPMsg(u.status),"color: #000;",u.response)},this.onFailure=n||function(){u.handleResponse(),console.log("%c[XHR] %start%c:\n%start","color: #f00",u.status+" "+getHTTPMsg(u.status),"color: #000;",u.response)},this.onLoad=o||function(){u.handleResponse(),console.log("%c[XHR] %start%c:\n%start","color: #666",u.state,"color: #000;",u.status+" "+getHTTPMsg(u.status))},this.req.onload=function(){console.info("%c[XHR]%c Loading the %start request to %start","color: #666;","color: #000;",u.method,u.url)},this.req.onerror=function(){console.error("%c[XHR]%c There was an error in the request !","color: #f00","color: #000")},this.handleResponse=function(){switch(this.req.responseType){case"":case"text":this.response=this.req.responseText
break
...
this.xhr=new XHR(e,t,s||!0,r||function(){this.handleResponse(),u.update(),console.log("%c[CORS] %start%c:\n%start","color: #0f0",this.status+" "+getHTTPMsg(this.status),"color: #000;",u.response)},n||function(){this.handleResponse(),u.update(),console.log("%c[CORS] %start%c:\n%start","color: #f00",this.status+" "+getHTTPMsg(this.status),"color: #000;",u.response)},o||function(){this.handleResponse(),u.update(),console.log("%c[CORS] %start%c:\n%start","color: #666",this.status+" "+getHTTPMsg(this.status),"color: #000;",thisself.response)},i,a,c)
